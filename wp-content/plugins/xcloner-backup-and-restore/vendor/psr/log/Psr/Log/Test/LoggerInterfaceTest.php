...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('XCloner\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('XCloner\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('XCloner\Psr\Log\Test\DummyTest', array('__toString'));
        }
