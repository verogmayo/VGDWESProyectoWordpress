...
use XCloner\PhpParser\Comment\Doc as DocComment;
use XCloner\PhpParser\Node;
use XCloner\PhpParser\Node\Expr;
use XCloner\PhpParser\Node\Name;
use XCloner\PhpParser\Node\Stmt;
use XCloner\PhpParser\Node\Stmt\Class_;
use XCloner\PhpParser\PrettyPrinter\Standard;
use XCloner\PhpParser\PrettyPrinterAbstract;
...
\class_alias('XCloner\Context', 'Context', \false);
class SimpleType
{
    /** @var string */
    public $name;
...
\class_alias('XCloner\SimpleType', 'SimpleType', \false);
class Type
{
...
\class_alias('XCloner\Type', 'Type', \false);
class ArginfoType
{
...
\class_alias('XCloner\ArginfoType', 'ArginfoType', \false);
class ArgInfo
{
    const SEND_BY_VAL = 0;
    const SEND_BY_REF = 1;
...
\class_alias('XCloner\ArgInfo', 'ArgInfo', \false);
...
\class_alias('XCloner\FunctionOrMethodName', 'FunctionOrMethodName', \false);
...
\class_alias('XCloner\FunctionName', 'FunctionName', \false);
...
\class_alias('XCloner\MethodName', 'MethodName', \false);
class ReturnInfo
{
    /** @var bool */
    public $byRef;
...
\class_alias('XCloner\ReturnInfo', 'ReturnInfo', \false);
class FuncInfo
{
...
\class_alias('XCloner\FuncInfo', 'FuncInfo', \false);
class ClassInfo
{
    /** @var Name */
    public $name;
...
\class_alias('XCloner\ClassInfo', 'ClassInfo', \false);
class FileInfo
{
    /** @var FuncInfo[] */
    public $funcInfos = [];
...
\class_alias('XCloner\FileInfo', 'FileInfo', \false);
class DocCommentTag
{
    /** @var string */
    public $name;
...
\class_alias('XCloner\DocCommentTag', 'DocCommentTag', \false);
