...
namespace XCloner\Aws\Handler\GuzzleV6;
...
use XCloner\GuzzleHttp\TransferStats;
...
class GuzzleHandler
{
    ...
    {
        $request = $request->withHeader('User-Agent', $request->getHeaderLine('User-Agent') . ' ' . \XCloner\GuzzleHttp\default_user_agent());
