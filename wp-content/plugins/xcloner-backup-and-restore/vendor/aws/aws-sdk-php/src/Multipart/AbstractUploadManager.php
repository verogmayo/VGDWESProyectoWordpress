...
namespace XCloner\Aws\Multipart;

if (!defined('ABSPATH') && \PHP_SAPI !== 'cli') {
    die;
}
use XCloner\Aws\AwsClientInterface as Client;
use XCloner\Aws\CommandInterface;
use XCloner\Aws\CommandPool;
...
abstract class AbstractUploadManager implements Promise\PromisorInterface
{
    ...
    private static $defaultConfig = ['part_size' => null, 'state' => null, 'concurrency' => self::DEFAULT_CONCURRENCY, 'prepare_data_source' => null, 'before_initiate' => null, 'before_upload' => null, 'before_complete' => null, 'exception_class' => 'XCloner\Aws\Exception\MultipartUploadException'];
