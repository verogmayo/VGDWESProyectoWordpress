...
use XCloner\GuzzleHttp\Psr7\CachingStream;
...
class StreamWrapper
{
    ...
    public function dir_opendir($path, $options)
    {
        ...
        $this->objectIterator = \XCloner\Aws\flatmap($this->getClient()->getPaginator('ListObjects', $op), function (Result $result) use ($filterFn) {
