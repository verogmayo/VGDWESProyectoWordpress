...
use XCloner\Aws\Api\Serializer\QuerySerializer;
use XCloner\Aws\Api\Serializer\Ec2ParamBuilder;
use XCloner\Aws\Api\Parser\QueryParser;
/**
...
class Service extends AbstractModel
{
    ...
    {
        static $mapping = ['json' => 'XCloner\Aws\Api\Serializer\JsonRpcSerializer', 'query' => 'XCloner\Aws\Api\Serializer\QuerySerializer', 'rest-json' => 'XCloner\Aws\Api\Serializer\RestJsonSerializer', 'rest-xml' => 'XCloner\Aws\Api\Serializer\RestXmlSerializer'];
    ...
    {
        static $mapping = ['json' => 'XCloner\Aws\Api\ErrorParser\JsonRpcErrorParser', 'query' => 'XCloner\Aws\Api\ErrorParser\XmlErrorParser', 'rest-json' => 'XCloner\Aws\Api\ErrorParser\RestJsonErrorParser', 'rest-xml' => 'XCloner\Aws\Api\ErrorParser\XmlErrorParser', 'ec2' => 'XCloner\Aws\Api\ErrorParser\XmlErrorParser'];
    ...
    {
        static $mapping = ['json' => 'XCloner\Aws\Api\Parser\JsonRpcParser', 'query' => 'XCloner\Aws\Api\Parser\QueryParser', 'rest-json' => 'XCloner\Aws\Api\Parser\RestJsonParser', 'rest-xml' => 'XCloner\Aws\Api\Parser\RestXmlParser'];
        $proto = $api->getProtocol();
        if (isset($mapping[$proto])) {
