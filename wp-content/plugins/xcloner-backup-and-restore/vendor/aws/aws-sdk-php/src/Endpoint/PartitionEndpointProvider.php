...
class PartitionEndpointProvider
{
    ...
    {
        $data = \XCloner\Aws\load_compiled_json(__DIR__ . '/../data/endpoints.json');
        $prefixData = \XCloner\Aws\load_compiled_json(__DIR__ . '/../data/endpoints_prefix_history.json');
