...
namespace XCloner\Srmklive\Dropbox\Test;
...
use XCloner\Prophecy\Argument;
use XCloner\Srmklive\Dropbox\Adapter\DropboxAdapter;
use XCloner\Srmklive\Dropbox\Client\DropboxClient as Client;
...
class AdapterTest extends TestCase
{
    ...
    {
        $this->client->upload(Argument::any(), Argument::any(), Argument::any())->willReturn(['server_modified' => '2015-05-12T15:50:38Z', 'path_display' => '/prefix/something', '.tag' => 'file']);
    ...
    {
        $this->client = $this->prophesize(Client::class);
        $this->client->getMetaData('/one')->willReturn(['.tag' => 'file', 'server_modified' => '2015-05-12T15:50:38Z', 'path_display' => '/one']);
    ...
    {
        return [['getMetadata'], ['getTimestamp'], ['getSize'], ['has']];
    }
    /** @test */
    ...
    public function it_can_create_a_directory()
    {
        ...
        $this->client->createFolder('/prefix/pass/please')->willReturn(['.tag' => 'folder', 'path_display' => '/prefix/pass/please']);
    ...
    {
        $this->client->listFolder(Argument::type('string'), Argument::any())->willReturn(['entries' => [['.tag' => 'folder', 'path_display' => 'dirname'], ['.tag' => 'file', 'path_display' => 'dirname/file']]]);
        $result = $this->dropboxAdapter->listContents('', \true);
