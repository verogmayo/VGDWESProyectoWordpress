...
class LabelFieldModification extends \XCloner\Google\Collection
{
...
class_alias(LabelFieldModification::class, 'XCloner\Google_Service_Drive_LabelFieldModification');
