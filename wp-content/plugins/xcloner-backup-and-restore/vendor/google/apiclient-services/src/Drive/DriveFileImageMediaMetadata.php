...
class DriveFileImageMediaMetadata extends \XCloner\Google\Model
{
    /**
     * @var float
     */
...
class_alias(DriveFileImageMediaMetadata::class, 'XCloner\Google_Service_Drive_DriveFileImageMediaMetadata');
