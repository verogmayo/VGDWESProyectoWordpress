...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('XCloner\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['XCloner\Google\Client' => 'Google_Client', 'XCloner\Google\Service' => 'Google_Service', 'XCloner\Google\Service\Resource' => 'Google_Service_Resource', 'XCloner\Google\Model' => 'Google_Model', 'XCloner\Google\Collection' => 'Google_Collection'];
