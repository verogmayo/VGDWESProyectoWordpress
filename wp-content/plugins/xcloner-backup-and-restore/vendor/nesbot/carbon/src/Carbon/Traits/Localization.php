...
use XCloner\Carbon\Exceptions\InvalidTypeException;
use XCloner\Carbon\Exceptions\NotLocaleAwareException;
use XCloner\Carbon\Language;
use XCloner\Carbon\Translator;
use XCloner\Carbon\TranslatorStrongTypeInterface;
use Closure;
use XCloner\Symfony\Component\Translation\TranslatorBagInterface;
use XCloner\Symfony\Component\Translation\TranslatorInterface;
use XCloner\Symfony\Contracts\Translation\LocaleAwareInterface;
use XCloner\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;
if (interface_exists('XCloner\Symfony\Contracts\Translation\TranslatorInterface') && !interface_exists('XCloner\Symfony\Component\Translation\TranslatorInterface')) {
    class_alias('XCloner\Symfony\Contracts\Translation\TranslatorInterface', 'XCloner\Symfony\Component\Translation\TranslatorInterface');
}
/**
 * Trait Localization.
 *
