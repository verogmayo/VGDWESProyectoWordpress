 ...
 */
namespace XCloner\Carbon\Laravel;
...
use XCloner\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use XCloner\Illuminate\Events\Dispatcher;
use XCloner\Illuminate\Events\EventDispatcher;
use XCloner\Illuminate\Support\Carbon as IlluminateCarbon;
use XCloner\Illuminate\Support\Facades\Date;
use Throwable;
class ServiceProvider extends \XCloner\Illuminate\Support\ServiceProvider
{
    /** @var callable|null */
    ...
    public function boot()
    {
        ...
        if ($this->isEventDispatcher($events)) {
            $events->listen(class_exists('XCloner\Illuminate\Foundation\Events\LocaleUpdated') ? 'Illuminate\Foundation\Events\LocaleUpdated' : 'locale.changed', function () use ($service) {
    ...
    {
        return \function_exists('XCloner\app') ? \XCloner\app(...$args) : null;
    }
