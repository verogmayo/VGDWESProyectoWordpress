...
namespace XCloner\spec\League\Flysystem\Cached;

if (!defined('ABSPATH') && \PHP_SAPI !== 'cli') {
    die;
}
use XCloner\League\Flysystem\AdapterInterface;
use XCloner\League\Flysystem\Cached\CacheInterface;
use XCloner\League\Flysystem\Config;
use XCloner\PhpSpec\ObjectBehavior;
class CachedAdapterSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('XCloner\League\Flysystem\Cached\CachedAdapter');
        $this->shouldHaveType('XCloner\League\Flysystem\AdapterInterface');
    }
