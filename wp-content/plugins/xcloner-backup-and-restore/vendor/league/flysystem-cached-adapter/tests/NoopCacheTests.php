...
use XCloner\League\Flysystem\Cached\Storage\Noop;
...
class NoopCacheTests extends TestCase
{
    public function testNoop()
    {
        ...
        $this->assertEquals([['path' => 'some/file.txt']], $cache->storeContents('unknwon', [['path' => 'some/file.txt']], \false));
    }
}
\class_alias('XCloner\NoopCacheTests', 'NoopCacheTests', \false);
