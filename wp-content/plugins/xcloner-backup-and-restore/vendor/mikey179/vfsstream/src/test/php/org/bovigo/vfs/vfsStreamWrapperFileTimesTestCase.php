 ...
 * @since  0.9.0
 */
class vfsStreamWrapperFileTimesTestCase extends \XCloner\BC_PHPUnit_Framework_TestCase
{
    /**
     * URL of foo.txt file
     *
    ...
    {
        $dir = vfsStream::newDirectory('bar')->at(vfsStreamWrapper::getRoot())->lastModified(100)->lastAccessed(100)->lastAttributeModified(100);
