...
class CalendarHome implements DAV\IExtendedCollection, DAVACL\IACL
{
    ...
    {
        return [['privilege' => '{DAV:}read', 'principal' => $this->principalInfo['uri'], 'protected' => \true], ['privilege' => '{DAV:}write', 'principal' => $this->principalInfo['uri'], 'protected' => \true], ['privilege' => '{DAV:}read', 'principal' => $this->principalInfo['uri'] . '/calendar-proxy-write', 'protected' => \true], ['privilege' => '{DAV:}write', 'principal' => $this->principalInfo['uri'] . '/calendar-proxy-write', 'protected' => \true], ['privilege' => '{DAV:}read', 'principal' => $this->principalInfo['uri'] . '/calendar-proxy-read', 'protected' => \true]];
    }
    /**
