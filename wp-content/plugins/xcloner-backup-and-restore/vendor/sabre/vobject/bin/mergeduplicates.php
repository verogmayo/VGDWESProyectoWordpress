...
// differences.
$ignoredProperties = ['PRODID', 'VERSION', 'REV', 'UID', 'X-ABLABEL'];
$collectedNames = [];
$stats = ['Total vcards' => 0, 'No FN property' => 0, 'Ignored duplicates' => 0, 'Merged values' => 0, 'Error' => 0, 'Unique cards' => 0, 'Total written' => 0];
function writeStats()
{
    global $stats;
