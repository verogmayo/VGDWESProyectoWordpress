...
class FunctionsTest extends \XCloner\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        return [['a', ['a']], ['a,b', ['a', 'b']], ['a, b', ['a', 'b']], [['a, b'], ['a', 'b']], [['a, b', 'c', 'd,e'], ['a', 'b', 'c', 'd', 'e']]];
    }
    /**
    ...
    public function preferData()
    {
        return [
            ...
            ['foo=""; bar', ['foo' => \true]],
            ['FOO', ['foo' => \true]],
            ['respond-async', ['respond-async' => \true]],
            [['respond-async, wait=100', 'handling=lenient'], ['respond-async' => \true, 'wait' => 100, 'handling' => 'lenient']],
            [['respond-async, wait=100, handling=lenient'], ['respond-async' => \true, 'wait' => 100, 'handling' => 'lenient']],
            // Old values
            ['return-asynch, return-representation', ['respond-async' => \true, 'return' => 'representation']],
    ...
    {
        $times = ['Wed, 13 Oct 2010 10:26:00 GMT', 'Wednesday, 13-Oct-10 10:26:00 GMT', 'Wed Oct 13 10:26:00 2010'];
        $expected = 1286965560;
    ...
    public function testToHTTPDate()
    {
        ...
        $this->assertEquals('Sat, 10 Dec 2011 10:00:00 GMT', toDate($dt));
    }
}
