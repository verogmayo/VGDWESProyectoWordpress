...
class MessageDecoratorTest extends \XCloner\PHPUnit\Framework\TestCase
{
    protected $inner;
    protected $outer;
    ...
    public function testHeader()
    {
        ...
        $this->assertEquals(['c', 'd'], $this->inner->getHeaderAsArray('A'));
        $this->assertEquals(['c', 'd'], $this->outer->getHeaderAsArray('A'));
