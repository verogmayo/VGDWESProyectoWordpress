...
class GraphCollectionRequest extends GraphRequest
{
    ...
    {
        parent::__construct($requestType, $endpoint, $accessToken, $baseUrl, $apiVersion, $proxyPort, $proxyVerifySSL);
        $this->end = \false;
    }
    /**
    ...
    {
        $query = '$count=true';
        $request = new GraphRequest($this->requestType, $this->endpoint . $this->getConcatenator() . $query, $this->accessToken, $this->baseUrl, $this->apiVersion, $this->proxyPort);
