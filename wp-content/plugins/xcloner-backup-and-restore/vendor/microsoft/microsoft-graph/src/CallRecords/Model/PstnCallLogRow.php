...
* @link      https://graph.microsoft.com
*/
class PstnCallLogRow extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getCallDurationSource()
    {
        if (array_key_exists("callDurationSource", $this->_propDict)) {
            if (is_a($this->_propDict["callDurationSource"], "XCloner\\Microsoft\\Graph\\CallRecords\\Model\\PstnCallDurationSource") || is_null($this->_propDict["callDurationSource"])) {
    ...
    public function getCharge()
    {
        if (array_key_exists("charge", $this->_propDict)) {
            if (is_a($this->_propDict["charge"], "XCloner\\Microsoft\\Graph\\Model\\Decimal") || is_null($this->_propDict["charge"])) {
                return $this->_propDict["charge"];
            } else {
                $this->_propDict["charge"] = new \XCloner\Microsoft\Graph\Model\Decimal($this->_propDict["charge"]);
                return $this->_propDict["charge"];
            }
        }
        return null;
    ...
    public function getConnectionCharge()
    {
        if (array_key_exists("connectionCharge", $this->_propDict)) {
            if (is_a($this->_propDict["connectionCharge"], "XCloner\\Microsoft\\Graph\\Model\\Decimal") || is_null($this->_propDict["connectionCharge"])) {
                return $this->_propDict["connectionCharge"];
            } else {
                $this->_propDict["connectionCharge"] = new \XCloner\Microsoft\Graph\Model\Decimal($this->_propDict["connectionCharge"]);
                return $this->_propDict["connectionCharge"];
            }
        }
        return null;
