...
class ParticipantEndpoint extends Endpoint
{
    ...
    public function getFeedback()
    {
        if (array_key_exists("feedback", $this->_propDict)) {
            if (is_a($this->_propDict["feedback"], "XCloner\\Microsoft\\Graph\\CallRecords\\Model\\UserFeedback") || is_null($this->_propDict["feedback"])) {
    ...
    public function getIdentity()
    {
        if (array_key_exists("identity", $this->_propDict)) {
            if (is_a($this->_propDict["identity"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["identity"])) {
                ...
                $this->_propDict["identity"] = new \XCloner\Microsoft\Graph\Model\IdentitySet($this->_propDict["identity"]);
                return $this->_propDict["identity"];
            }
        }
        return null;
