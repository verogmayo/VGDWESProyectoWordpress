...
* @link      https://graph.microsoft.com
*/
class MediaStream extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the audioCodec
    ...
    public function getAudioCodec()
    {
        if (array_key_exists("audioCodec", $this->_propDict)) {
            if (is_a($this->_propDict["audioCodec"], "XCloner\\Microsoft\\Graph\\CallRecords\\Model\\AudioCodec") || is_null($this->_propDict["audioCodec"])) {
    ...
    public function getStreamDirection()
    {
        if (array_key_exists("streamDirection", $this->_propDict)) {
            if (is_a($this->_propDict["streamDirection"], "XCloner\\Microsoft\\Graph\\CallRecords\\Model\\MediaStreamDirection") || is_null($this->_propDict["streamDirection"])) {
    ...
    public function getVideoCodec()
    {
        if (array_key_exists("videoCodec", $this->_propDict)) {
            if (is_a($this->_propDict["videoCodec"], "XCloner\\Microsoft\\Graph\\CallRecords\\Model\\VideoCodec") || is_null($this->_propDict["videoCodec"])) {
