...
class EdiscoveryReviewTag extends Tag
{
    ...
    public function getChildSelectability()
    {
        if (array_key_exists("childSelectability", $this->_propDict)) {
            if (is_a($this->_propDict["childSelectability"], "XCloner\\Microsoft\\Graph\\SecurityNamespace\\Model\\ChildSelectability") || is_null($this->_propDict["childSelectability"])) {
    ...
    public function getParent()
    {
        if (array_key_exists("parent", $this->_propDict)) {
            if (is_a($this->_propDict["parent"], "XCloner\\Microsoft\\Graph\\SecurityNamespace\\Model\\EdiscoveryReviewTag") || is_null($this->_propDict["parent"])) {
