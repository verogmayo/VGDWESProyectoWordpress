...
* @link      https://graph.microsoft.com
*/
class Search extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getLastModifiedBy()
    {
        if (array_key_exists("lastModifiedBy", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedBy"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["lastModifiedBy"])) {
                ...
                $this->_propDict["lastModifiedBy"] = new \XCloner\Microsoft\Graph\Model\IdentitySet($this->_propDict["lastModifiedBy"]);
                return $this->_propDict["lastModifiedBy"];
            }
        }
        return null;
