...
* @link      https://graph.microsoft.com
*/
class CaseOperation extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the action
    ...
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "XCloner\\Microsoft\\Graph\\SecurityNamespace\\Model\\CaseAction") || is_null($this->_propDict["action"])) {
    ...
    public function getCreatedBy()
    {
        if (array_key_exists("createdBy", $this->_propDict)) {
            if (is_a($this->_propDict["createdBy"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["createdBy"])) {
                ...
                $this->_propDict["createdBy"] = new \XCloner\Microsoft\Graph\Model\IdentitySet($this->_propDict["createdBy"]);
                return $this->_propDict["createdBy"];
            }
        }
        return null;
    ...
    public function getResultInfo()
    {
        if (array_key_exists("resultInfo", $this->_propDict)) {
            if (is_a($this->_propDict["resultInfo"], "XCloner\\Microsoft\\Graph\\Model\\ResultInfo") || is_null($this->_propDict["resultInfo"])) {
                ...
                $this->_propDict["resultInfo"] = new \XCloner\Microsoft\Graph\Model\ResultInfo($this->_propDict["resultInfo"]);
                return $this->_propDict["resultInfo"];
            }
        }
        return null;
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\SecurityNamespace\\Model\\CaseOperationStatus") || is_null($this->_propDict["status"])) {
