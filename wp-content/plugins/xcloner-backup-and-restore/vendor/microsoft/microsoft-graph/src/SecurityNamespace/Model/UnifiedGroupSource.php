...
class UnifiedGroupSource extends DataSource
{
    ...
    public function getIncludedSources()
    {
        if (array_key_exists("includedSources", $this->_propDict)) {
            if (is_a($this->_propDict["includedSources"], "XCloner\\Microsoft\\Graph\\SecurityNamespace\\Model\\SourceType") || is_null($this->_propDict["includedSources"])) {
    ...
    public function getGroup()
    {
        if (array_key_exists("group", $this->_propDict)) {
            if (is_a($this->_propDict["group"], "XCloner\\Microsoft\\Graph\\Model\\Group") || is_null($this->_propDict["group"])) {
                ...
                $this->_propDict["group"] = new \XCloner\Microsoft\Graph\Model\Group($this->_propDict["group"]);
                return $this->_propDict["group"];
            }
        }
        return null;
