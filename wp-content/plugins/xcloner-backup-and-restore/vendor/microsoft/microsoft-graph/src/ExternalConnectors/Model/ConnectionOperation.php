...
* @link      https://graph.microsoft.com
*/
class ConnectionOperation extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the error
    ...
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "XCloner\\Microsoft\\Graph\\Model\\PublicError") || is_null($this->_propDict["error"])) {
                ...
                $this->_propDict["error"] = new \XCloner\Microsoft\Graph\Model\PublicError($this->_propDict["error"]);
                return $this->_propDict["error"];
            }
        }
        return null;
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\ExternalConnectors\\Model\\ConnectionOperationStatus") || is_null($this->_propDict["status"])) {
