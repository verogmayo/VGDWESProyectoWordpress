...
* @link      https://graph.microsoft.com
*/
class Identity extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the type
    ...
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "XCloner\\Microsoft\\Graph\\ExternalConnectors\\Model\\IdentityType") || is_null($this->_propDict["type"])) {
