...
* @link      https://graph.microsoft.com
*/
class Property extends \XCloner\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the aliases
    ...
    public function getLabels()
    {
        if (array_key_exists("labels", $this->_propDict)) {
            if (is_a($this->_propDict["labels"], "XCloner\\Microsoft\\Graph\\ExternalConnectors\\Model\\Label") || is_null($this->_propDict["labels"])) {
    ...
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "XCloner\\Microsoft\\Graph\\ExternalConnectors\\Model\\PropertyType") || is_null($this->_propDict["type"])) {
