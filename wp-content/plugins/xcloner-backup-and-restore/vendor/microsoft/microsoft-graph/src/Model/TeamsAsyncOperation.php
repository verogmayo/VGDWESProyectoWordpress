...
class TeamsAsyncOperation extends Entity
{
    ...
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "XCloner\\Microsoft\\Graph\\Model\\OperationError") || is_null($this->_propDict["error"])) {
    ...
    public function getOperationType()
    {
        if (array_key_exists("operationType", $this->_propDict)) {
            if (is_a($this->_propDict["operationType"], "XCloner\\Microsoft\\Graph\\Model\\TeamsAsyncOperationType") || is_null($this->_propDict["operationType"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\TeamsAsyncOperationStatus") || is_null($this->_propDict["status"])) {
