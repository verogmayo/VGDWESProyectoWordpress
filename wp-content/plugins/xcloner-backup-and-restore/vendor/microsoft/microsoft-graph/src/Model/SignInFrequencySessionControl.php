...
class SignInFrequencySessionControl extends ConditionalAccessSessionControl
{
    ...
    public function getAuthenticationType()
    {
        if (array_key_exists("authenticationType", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationType"], "XCloner\\Microsoft\\Graph\\Model\\SignInFrequencyAuthenticationType") || is_null($this->_propDict["authenticationType"])) {
    ...
    public function getFrequencyInterval()
    {
        if (array_key_exists("frequencyInterval", $this->_propDict)) {
            if (is_a($this->_propDict["frequencyInterval"], "XCloner\\Microsoft\\Graph\\Model\\SignInFrequencyInterval") || is_null($this->_propDict["frequencyInterval"])) {
    ...
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "XCloner\\Microsoft\\Graph\\Model\\SigninFrequencyType") || is_null($this->_propDict["type"])) {
