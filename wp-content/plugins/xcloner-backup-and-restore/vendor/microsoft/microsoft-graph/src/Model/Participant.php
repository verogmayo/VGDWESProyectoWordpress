...
class Participant extends Entity
{
    ...
    public function getInfo()
    {
        if (array_key_exists("info", $this->_propDict)) {
            if (is_a($this->_propDict["info"], "XCloner\\Microsoft\\Graph\\Model\\ParticipantInfo") || is_null($this->_propDict["info"])) {
    ...
    public function getRecordingInfo()
    {
        if (array_key_exists("recordingInfo", $this->_propDict)) {
            if (is_a($this->_propDict["recordingInfo"], "XCloner\\Microsoft\\Graph\\Model\\RecordingInfo") || is_null($this->_propDict["recordingInfo"])) {
