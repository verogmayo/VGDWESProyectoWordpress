...
class ChangeNotification extends Entity
{
    ...
    public function getEncryptedContent()
    {
        if (array_key_exists("encryptedContent", $this->_propDict)) {
            if (is_a($this->_propDict["encryptedContent"], "XCloner\\Microsoft\\Graph\\Model\\ChangeNotificationEncryptedContent") || is_null($this->_propDict["encryptedContent"])) {
    ...
    public function getLifecycleEvent()
    {
        if (array_key_exists("lifecycleEvent", $this->_propDict)) {
            if (is_a($this->_propDict["lifecycleEvent"], "XCloner\\Microsoft\\Graph\\Model\\LifecycleEventType") || is_null($this->_propDict["lifecycleEvent"])) {
    ...
    public function getResourceData()
    {
        if (array_key_exists("resourceData", $this->_propDict)) {
            if (is_a($this->_propDict["resourceData"], "XCloner\\Microsoft\\Graph\\Model\\ResourceData") || is_null($this->_propDict["resourceData"])) {
