...
class Shift extends ChangeTrackedEntity
{
    ...
    public function getDraftShift()
    {
        if (array_key_exists("draftShift", $this->_propDict)) {
            if (is_a($this->_propDict["draftShift"], "XCloner\\Microsoft\\Graph\\Model\\ShiftItem") || is_null($this->_propDict["draftShift"])) {
    ...
    public function getSharedShift()
    {
        if (array_key_exists("sharedShift", $this->_propDict)) {
            if (is_a($this->_propDict["sharedShift"], "XCloner\\Microsoft\\Graph\\Model\\ShiftItem") || is_null($this->_propDict["sharedShift"])) {
