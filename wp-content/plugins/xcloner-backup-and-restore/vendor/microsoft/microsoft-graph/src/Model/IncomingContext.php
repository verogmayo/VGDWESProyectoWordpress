...
class IncomingContext extends Entity
{
    ...
    public function getOnBehalfOf()
    {
        if (array_key_exists("onBehalfOf", $this->_propDict)) {
            if (is_a($this->_propDict["onBehalfOf"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["onBehalfOf"])) {
    ...
    public function getTransferor()
    {
        if (array_key_exists("transferor", $this->_propDict)) {
            if (is_a($this->_propDict["transferor"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["transferor"])) {
