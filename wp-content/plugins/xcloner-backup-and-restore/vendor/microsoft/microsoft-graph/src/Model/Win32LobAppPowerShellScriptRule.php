...
class Win32LobAppPowerShellScriptRule extends Win32LobAppRule
{
    ...
    public function getOperationType()
    {
        if (array_key_exists("operationType", $this->_propDict)) {
            if (is_a($this->_propDict["operationType"], "XCloner\\Microsoft\\Graph\\Model\\Win32LobAppPowerShellScriptRuleOperationType") || is_null($this->_propDict["operationType"])) {
    ...
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "XCloner\\Microsoft\\Graph\\Model\\Win32LobAppRuleOperator") || is_null($this->_propDict["operator"])) {
    ...
    public function getRunAsAccount()
    {
        if (array_key_exists("runAsAccount", $this->_propDict)) {
            if (is_a($this->_propDict["runAsAccount"], "XCloner\\Microsoft\\Graph\\Model\\RunAsAccountType") || is_null($this->_propDict["runAsAccount"])) {
