...
class SharingDetail extends Entity
{
    ...
    public function getSharedBy()
    {
        if (array_key_exists("sharedBy", $this->_propDict)) {
            if (is_a($this->_propDict["sharedBy"], "XCloner\\Microsoft\\Graph\\Model\\InsightIdentity") || is_null($this->_propDict["sharedBy"])) {
    ...
    public function getSharingReference()
    {
        if (array_key_exists("sharingReference", $this->_propDict)) {
            if (is_a($this->_propDict["sharingReference"], "XCloner\\Microsoft\\Graph\\Model\\ResourceReference") || is_null($this->_propDict["sharingReference"])) {
