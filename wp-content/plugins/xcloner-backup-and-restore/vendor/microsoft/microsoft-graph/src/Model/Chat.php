...
class Chat extends Entity
{
    ...
    public function getChatType()
    {
        if (array_key_exists("chatType", $this->_propDict)) {
            if (is_a($this->_propDict["chatType"], "XCloner\\Microsoft\\Graph\\Model\\ChatType") || is_null($this->_propDict["chatType"])) {
    ...
    public function getOnlineMeetingInfo()
    {
        if (array_key_exists("onlineMeetingInfo", $this->_propDict)) {
            if (is_a($this->_propDict["onlineMeetingInfo"], "XCloner\\Microsoft\\Graph\\Model\\TeamworkOnlineMeetingInfo") || is_null($this->_propDict["onlineMeetingInfo"])) {
