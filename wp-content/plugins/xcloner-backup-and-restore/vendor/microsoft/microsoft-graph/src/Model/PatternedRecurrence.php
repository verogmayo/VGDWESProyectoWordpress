...
class PatternedRecurrence extends Entity
{
    ...
    public function getPattern()
    {
        if (array_key_exists("pattern", $this->_propDict)) {
            if (is_a($this->_propDict["pattern"], "XCloner\\Microsoft\\Graph\\Model\\RecurrencePattern") || is_null($this->_propDict["pattern"])) {
    ...
    public function getRange()
    {
        if (array_key_exists("range", $this->_propDict)) {
            if (is_a($this->_propDict["range"], "XCloner\\Microsoft\\Graph\\Model\\RecurrenceRange") || is_null($this->_propDict["range"])) {
