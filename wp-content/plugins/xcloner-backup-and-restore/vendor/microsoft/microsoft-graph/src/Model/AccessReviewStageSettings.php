...
class AccessReviewStageSettings extends Entity
{
    ...
    public function getFallbackReviewers()
    {
        if (array_key_exists("fallbackReviewers", $this->_propDict)) {
            if (is_a($this->_propDict["fallbackReviewers"], "XCloner\\Microsoft\\Graph\\Model\\AccessReviewReviewerScope") || is_null($this->_propDict["fallbackReviewers"])) {
    ...
    public function getReviewers()
    {
        if (array_key_exists("reviewers", $this->_propDict)) {
            if (is_a($this->_propDict["reviewers"], "XCloner\\Microsoft\\Graph\\Model\\AccessReviewReviewerScope") || is_null($this->_propDict["reviewers"])) {
