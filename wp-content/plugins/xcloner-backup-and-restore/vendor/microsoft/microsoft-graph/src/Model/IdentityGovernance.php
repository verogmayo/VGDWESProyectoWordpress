...
class IdentityGovernance implements \JsonSerializable
{
    ...
    public function getAccessReviews()
    {
        if (array_key_exists("accessReviews", $this->_propDict)) {
            if (is_a($this->_propDict["accessReviews"], "XCloner\\Microsoft\\Graph\\Model\\AccessReviewSet") || is_null($this->_propDict["accessReviews"])) {
    ...
    public function getAppConsent()
    {
        if (array_key_exists("appConsent", $this->_propDict)) {
            if (is_a($this->_propDict["appConsent"], "XCloner\\Microsoft\\Graph\\Model\\AppConsentApprovalRoute") || is_null($this->_propDict["appConsent"])) {
    ...
    public function getTermsOfUse()
    {
        if (array_key_exists("termsOfUse", $this->_propDict)) {
            if (is_a($this->_propDict["termsOfUse"], "XCloner\\Microsoft\\Graph\\Model\\TermsOfUseContainer") || is_null($this->_propDict["termsOfUse"])) {
    ...
    public function getEntitlementManagement()
    {
        if (array_key_exists("entitlementManagement", $this->_propDict)) {
            if (is_a($this->_propDict["entitlementManagement"], "XCloner\\Microsoft\\Graph\\Model\\EntitlementManagement") || is_null($this->_propDict["entitlementManagement"])) {
