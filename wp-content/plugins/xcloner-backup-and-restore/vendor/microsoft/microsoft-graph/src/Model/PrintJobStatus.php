...
class PrintJobStatus extends Entity
{
    ...
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict)) {
            if (is_a($this->_propDict["details"], "XCloner\\Microsoft\\Graph\\Model\\PrintJobStateDetail") || is_null($this->_propDict["details"])) {
    ...
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "XCloner\\Microsoft\\Graph\\Model\\PrintJobProcessingState") || is_null($this->_propDict["state"])) {
