...
class BaseItem extends Entity
{
    ...
    public function getCreatedByUser()
    {
        if (array_key_exists("createdByUser", $this->_propDict)) {
            if (is_a($this->_propDict["createdByUser"], "XCloner\\Microsoft\\Graph\\Model\\User") || is_null($this->_propDict["createdByUser"])) {
    ...
    public function getLastModifiedByUser()
    {
        if (array_key_exists("lastModifiedByUser", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedByUser"], "XCloner\\Microsoft\\Graph\\Model\\User") || is_null($this->_propDict["lastModifiedByUser"])) {
