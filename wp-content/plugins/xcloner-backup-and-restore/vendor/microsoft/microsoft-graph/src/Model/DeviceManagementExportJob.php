...
class DeviceManagementExportJob extends Entity
{
    ...
    public function getFormat()
    {
        if (array_key_exists("format", $this->_propDict)) {
            if (is_a($this->_propDict["format"], "XCloner\\Microsoft\\Graph\\Model\\DeviceManagementReportFileFormat") || is_null($this->_propDict["format"])) {
    ...
    public function getLocalizationType()
    {
        if (array_key_exists("localizationType", $this->_propDict)) {
            if (is_a($this->_propDict["localizationType"], "XCloner\\Microsoft\\Graph\\Model\\DeviceManagementExportJobLocalizationType") || is_null($this->_propDict["localizationType"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\DeviceManagementReportStatus") || is_null($this->_propDict["status"])) {
