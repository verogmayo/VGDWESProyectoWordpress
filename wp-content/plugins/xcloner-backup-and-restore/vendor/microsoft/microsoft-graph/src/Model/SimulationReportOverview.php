...
class SimulationReportOverview extends Entity
{
    ...
    public function getRecommendedActions()
    {
        if (array_key_exists("recommendedActions", $this->_propDict)) {
            if (is_a($this->_propDict["recommendedActions"], "XCloner\\Microsoft\\Graph\\Model\\RecommendedAction") || is_null($this->_propDict["recommendedActions"])) {
    ...
    public function getSimulationEventsContent()
    {
        if (array_key_exists("simulationEventsContent", $this->_propDict)) {
            if (is_a($this->_propDict["simulationEventsContent"], "XCloner\\Microsoft\\Graph\\Model\\SimulationEventsContent") || is_null($this->_propDict["simulationEventsContent"])) {
    ...
    public function getTrainingEventsContent()
    {
        if (array_key_exists("trainingEventsContent", $this->_propDict)) {
            if (is_a($this->_propDict["trainingEventsContent"], "XCloner\\Microsoft\\Graph\\Model\\TrainingEventsContent") || is_null($this->_propDict["trainingEventsContent"])) {
