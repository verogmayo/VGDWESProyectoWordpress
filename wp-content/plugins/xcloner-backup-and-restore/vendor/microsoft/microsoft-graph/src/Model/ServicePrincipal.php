...
class ServicePrincipal extends DirectoryObject
{
    ...
    public function getSamlSingleSignOnSettings()
    {
        if (array_key_exists("samlSingleSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["samlSingleSignOnSettings"], "XCloner\\Microsoft\\Graph\\Model\\SamlSingleSignOnSettings") || is_null($this->_propDict["samlSingleSignOnSettings"])) {
