...
class RoleManagement implements \JsonSerializable
{
    ...
    public function getDirectory()
    {
        if (array_key_exists("directory", $this->_propDict)) {
            if (is_a($this->_propDict["directory"], "XCloner\\Microsoft\\Graph\\Model\\RbacApplication") || is_null($this->_propDict["directory"])) {
    ...
    public function getEntitlementManagement()
    {
        if (array_key_exists("entitlementManagement", $this->_propDict)) {
            if (is_a($this->_propDict["entitlementManagement"], "XCloner\\Microsoft\\Graph\\Model\\RbacApplication") || is_null($this->_propDict["entitlementManagement"])) {
