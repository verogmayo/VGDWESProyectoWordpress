...
class RiskDetection extends Entity
{
    ...
    public function getActivity()
    {
        if (array_key_exists("activity", $this->_propDict)) {
            if (is_a($this->_propDict["activity"], "XCloner\\Microsoft\\Graph\\Model\\ActivityType") || is_null($this->_propDict["activity"])) {
    ...
    public function getDetectionTimingType()
    {
        if (array_key_exists("detectionTimingType", $this->_propDict)) {
            if (is_a($this->_propDict["detectionTimingType"], "XCloner\\Microsoft\\Graph\\Model\\RiskDetectionTimingType") || is_null($this->_propDict["detectionTimingType"])) {
    ...
    public function getRiskLevel()
    {
        if (array_key_exists("riskLevel", $this->_propDict)) {
            if (is_a($this->_propDict["riskLevel"], "XCloner\\Microsoft\\Graph\\Model\\RiskLevel") || is_null($this->_propDict["riskLevel"])) {
    ...
    public function getTokenIssuerType()
    {
        if (array_key_exists("tokenIssuerType", $this->_propDict)) {
            if (is_a($this->_propDict["tokenIssuerType"], "XCloner\\Microsoft\\Graph\\Model\\TokenIssuerType") || is_null($this->_propDict["tokenIssuerType"])) {
