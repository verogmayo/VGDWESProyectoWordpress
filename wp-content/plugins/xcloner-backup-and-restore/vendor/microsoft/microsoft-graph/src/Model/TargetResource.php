...
class TargetResource extends Entity
{
    ...
    public function getGroupType()
    {
        if (array_key_exists("groupType", $this->_propDict)) {
            if (is_a($this->_propDict["groupType"], "XCloner\\Microsoft\\Graph\\Model\\GroupType") || is_null($this->_propDict["groupType"])) {
    ...
    public function getModifiedProperties()
    {
        if (array_key_exists("modifiedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["modifiedProperties"], "XCloner\\Microsoft\\Graph\\Model\\ModifiedProperty") || is_null($this->_propDict["modifiedProperties"])) {
