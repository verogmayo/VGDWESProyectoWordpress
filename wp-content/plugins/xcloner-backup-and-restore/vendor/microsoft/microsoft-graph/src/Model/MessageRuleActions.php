...
class MessageRuleActions extends Entity
{
    ...
    public function getForwardAsAttachmentTo()
    {
        if (array_key_exists("forwardAsAttachmentTo", $this->_propDict)) {
            if (is_a($this->_propDict["forwardAsAttachmentTo"], "XCloner\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["forwardAsAttachmentTo"])) {
    ...
    public function getForwardTo()
    {
        if (array_key_exists("forwardTo", $this->_propDict)) {
            if (is_a($this->_propDict["forwardTo"], "XCloner\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["forwardTo"])) {
    ...
    public function getMarkImportance()
    {
        if (array_key_exists("markImportance", $this->_propDict)) {
            if (is_a($this->_propDict["markImportance"], "XCloner\\Microsoft\\Graph\\Model\\Importance") || is_null($this->_propDict["markImportance"])) {
    ...
    public function getRedirectTo()
    {
        if (array_key_exists("redirectTo", $this->_propDict)) {
            if (is_a($this->_propDict["redirectTo"], "XCloner\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["redirectTo"])) {
