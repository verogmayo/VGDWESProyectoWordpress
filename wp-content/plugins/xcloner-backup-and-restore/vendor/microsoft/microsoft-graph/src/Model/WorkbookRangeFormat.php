...
class WorkbookRangeFormat extends Entity
{
    ...
    public function getFill()
    {
        if (array_key_exists("fill", $this->_propDict)) {
            if (is_a($this->_propDict["fill"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookRangeFill") || is_null($this->_propDict["fill"])) {
    ...
    public function getFont()
    {
        if (array_key_exists("font", $this->_propDict)) {
            if (is_a($this->_propDict["font"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookRangeFont") || is_null($this->_propDict["font"])) {
    ...
    public function getProtection()
    {
        if (array_key_exists("protection", $this->_propDict)) {
            if (is_a($this->_propDict["protection"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookFormatProtection") || is_null($this->_propDict["protection"])) {
