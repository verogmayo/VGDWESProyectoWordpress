...
class PrinterBase extends Entity
{
    ...
    public function getCapabilities()
    {
        if (array_key_exists("capabilities", $this->_propDict)) {
            if (is_a($this->_propDict["capabilities"], "XCloner\\Microsoft\\Graph\\Model\\PrinterCapabilities") || is_null($this->_propDict["capabilities"])) {
    ...
    public function getDefaults()
    {
        if (array_key_exists("defaults", $this->_propDict)) {
            if (is_a($this->_propDict["defaults"], "XCloner\\Microsoft\\Graph\\Model\\PrinterDefaults") || is_null($this->_propDict["defaults"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\PrinterStatus") || is_null($this->_propDict["status"])) {
