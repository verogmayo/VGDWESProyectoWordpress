...
class UserSimulationDetails extends Entity
{
    ...
    public function getSimulationEvents()
    {
        if (array_key_exists("simulationEvents", $this->_propDict)) {
            if (is_a($this->_propDict["simulationEvents"], "XCloner\\Microsoft\\Graph\\Model\\UserSimulationEventInfo") || is_null($this->_propDict["simulationEvents"])) {
    ...
    public function getSimulationUser()
    {
        if (array_key_exists("simulationUser", $this->_propDict)) {
            if (is_a($this->_propDict["simulationUser"], "XCloner\\Microsoft\\Graph\\Model\\AttackSimulationUser") || is_null($this->_propDict["simulationUser"])) {
    ...
    public function getTrainingEvents()
    {
        if (array_key_exists("trainingEvents", $this->_propDict)) {
            if (is_a($this->_propDict["trainingEvents"], "XCloner\\Microsoft\\Graph\\Model\\UserTrainingEventInfo") || is_null($this->_propDict["trainingEvents"])) {
