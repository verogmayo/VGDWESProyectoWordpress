...
class CallRoute extends Entity
{
    ...
    public function getFinal()
    {
        if (array_key_exists("final", $this->_propDict)) {
            if (is_a($this->_propDict["final"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["final"])) {
    ...
    public function getOriginal()
    {
        if (array_key_exists("original", $this->_propDict)) {
            if (is_a($this->_propDict["original"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["original"])) {
    ...
    public function getRoutingType()
    {
        if (array_key_exists("routingType", $this->_propDict)) {
            if (is_a($this->_propDict["routingType"], "XCloner\\Microsoft\\Graph\\Model\\RoutingType") || is_null($this->_propDict["routingType"])) {
