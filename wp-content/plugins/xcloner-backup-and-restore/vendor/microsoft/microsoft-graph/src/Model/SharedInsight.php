...
class SharedInsight extends Entity
{
    ...
    public function getLastShared()
    {
        if (array_key_exists("lastShared", $this->_propDict)) {
            if (is_a($this->_propDict["lastShared"], "XCloner\\Microsoft\\Graph\\Model\\SharingDetail") || is_null($this->_propDict["lastShared"])) {
    ...
    public function getLastSharedMethod()
    {
        if (array_key_exists("lastSharedMethod", $this->_propDict)) {
            if (is_a($this->_propDict["lastSharedMethod"], "XCloner\\Microsoft\\Graph\\Model\\Entity") || is_null($this->_propDict["lastSharedMethod"])) {
