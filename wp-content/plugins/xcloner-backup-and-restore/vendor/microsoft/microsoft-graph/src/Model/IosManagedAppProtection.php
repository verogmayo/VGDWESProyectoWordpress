...
class IosManagedAppProtection extends TargetedManagedAppProtection
{
    ...
    public function getAppDataEncryptionType()
    {
        if (array_key_exists("appDataEncryptionType", $this->_propDict)) {
            if (is_a($this->_propDict["appDataEncryptionType"], "XCloner\\Microsoft\\Graph\\Model\\ManagedAppDataEncryptionType") || is_null($this->_propDict["appDataEncryptionType"])) {
    ...
    public function getDeploymentSummary()
    {
        if (array_key_exists("deploymentSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentSummary"], "XCloner\\Microsoft\\Graph\\Model\\ManagedAppPolicyDeploymentSummary") || is_null($this->_propDict["deploymentSummary"])) {
