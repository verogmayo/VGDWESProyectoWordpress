...
class Group extends DirectoryObject
{
    ...
    public function getLicenseProcessingState()
    {
        if (array_key_exists("licenseProcessingState", $this->_propDict)) {
            if (is_a($this->_propDict["licenseProcessingState"], "XCloner\\Microsoft\\Graph\\Model\\LicenseProcessingState") || is_null($this->_propDict["licenseProcessingState"])) {
    ...
    public function getPlanner()
    {
        if (array_key_exists("planner", $this->_propDict)) {
            if (is_a($this->_propDict["planner"], "XCloner\\Microsoft\\Graph\\Model\\PlannerGroup") || is_null($this->_propDict["planner"])) {
