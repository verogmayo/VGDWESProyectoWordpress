...
class ConditionalAccessConditionSet extends Entity
{
    ...
    public function getApplications()
    {
        if (array_key_exists("applications", $this->_propDict)) {
            if (is_a($this->_propDict["applications"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessApplications") || is_null($this->_propDict["applications"])) {
    ...
    public function getClientApplications()
    {
        if (array_key_exists("clientApplications", $this->_propDict)) {
            if (is_a($this->_propDict["clientApplications"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessClientApplications") || is_null($this->_propDict["clientApplications"])) {
    ...
    public function getClientAppTypes()
    {
        if (array_key_exists("clientAppTypes", $this->_propDict)) {
            if (is_a($this->_propDict["clientAppTypes"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessClientApp") || is_null($this->_propDict["clientAppTypes"])) {
    ...
    public function getDevices()
    {
        if (array_key_exists("devices", $this->_propDict)) {
            if (is_a($this->_propDict["devices"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessDevices") || is_null($this->_propDict["devices"])) {
    ...
    public function getLocations()
    {
        if (array_key_exists("locations", $this->_propDict)) {
            if (is_a($this->_propDict["locations"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessLocations") || is_null($this->_propDict["locations"])) {
    ...
    public function getPlatforms()
    {
        if (array_key_exists("platforms", $this->_propDict)) {
            if (is_a($this->_propDict["platforms"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessPlatforms") || is_null($this->_propDict["platforms"])) {
    ...
    public function getServicePrincipalRiskLevels()
    {
        if (array_key_exists("servicePrincipalRiskLevels", $this->_propDict)) {
            if (is_a($this->_propDict["servicePrincipalRiskLevels"], "XCloner\\Microsoft\\Graph\\Model\\RiskLevel") || is_null($this->_propDict["servicePrincipalRiskLevels"])) {
    ...
    public function getSignInRiskLevels()
    {
        if (array_key_exists("signInRiskLevels", $this->_propDict)) {
            if (is_a($this->_propDict["signInRiskLevels"], "XCloner\\Microsoft\\Graph\\Model\\RiskLevel") || is_null($this->_propDict["signInRiskLevels"])) {
    ...
    public function getUserRiskLevels()
    {
        if (array_key_exists("userRiskLevels", $this->_propDict)) {
            if (is_a($this->_propDict["userRiskLevels"], "XCloner\\Microsoft\\Graph\\Model\\RiskLevel") || is_null($this->_propDict["userRiskLevels"])) {
    ...
    public function getUsers()
    {
        if (array_key_exists("users", $this->_propDict)) {
            if (is_a($this->_propDict["users"], "XCloner\\Microsoft\\Graph\\Model\\ConditionalAccessUsers") || is_null($this->_propDict["users"])) {
