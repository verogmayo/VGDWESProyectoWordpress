...
class AuditActivityInitiator extends Entity
{
    ...
    public function getApp()
    {
        if (array_key_exists("app", $this->_propDict)) {
            if (is_a($this->_propDict["app"], "XCloner\\Microsoft\\Graph\\Model\\AppIdentity") || is_null($this->_propDict["app"])) {
    ...
    public function getUser()
    {
        if (array_key_exists("user", $this->_propDict)) {
            if (is_a($this->_propDict["user"], "XCloner\\Microsoft\\Graph\\Model\\UserIdentity") || is_null($this->_propDict["user"])) {
