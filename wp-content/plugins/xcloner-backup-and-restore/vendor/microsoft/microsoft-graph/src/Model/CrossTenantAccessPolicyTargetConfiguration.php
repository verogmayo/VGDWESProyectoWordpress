...
class CrossTenantAccessPolicyTargetConfiguration extends Entity
{
    ...
    public function getAccessType()
    {
        if (array_key_exists("accessType", $this->_propDict)) {
            if (is_a($this->_propDict["accessType"], "XCloner\\Microsoft\\Graph\\Model\\CrossTenantAccessPolicyTargetConfigurationAccessType") || is_null($this->_propDict["accessType"])) {
    ...
    public function getTargets()
    {
        if (array_key_exists("targets", $this->_propDict)) {
            if (is_a($this->_propDict["targets"], "XCloner\\Microsoft\\Graph\\Model\\CrossTenantAccessPolicyTarget") || is_null($this->_propDict["targets"])) {
