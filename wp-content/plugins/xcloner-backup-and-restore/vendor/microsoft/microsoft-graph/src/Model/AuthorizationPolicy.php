...
class AuthorizationPolicy extends PolicyBase
{
    ...
    public function getAllowInvitesFrom()
    {
        if (array_key_exists("allowInvitesFrom", $this->_propDict)) {
            if (is_a($this->_propDict["allowInvitesFrom"], "XCloner\\Microsoft\\Graph\\Model\\AllowInvitesFrom") || is_null($this->_propDict["allowInvitesFrom"])) {
    ...
    public function getDefaultUserRolePermissions()
    {
        if (array_key_exists("defaultUserRolePermissions", $this->_propDict)) {
            if (is_a($this->_propDict["defaultUserRolePermissions"], "XCloner\\Microsoft\\Graph\\Model\\DefaultUserRolePermissions") || is_null($this->_propDict["defaultUserRolePermissions"])) {
