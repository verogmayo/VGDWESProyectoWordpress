...
class PlannerPlanDetails extends Entity
{
    ...
    public function getCategoryDescriptions()
    {
        if (array_key_exists("categoryDescriptions", $this->_propDict)) {
            if (is_a($this->_propDict["categoryDescriptions"], "XCloner\\Microsoft\\Graph\\Model\\PlannerCategoryDescriptions") || is_null($this->_propDict["categoryDescriptions"])) {
    ...
    public function getSharedWith()
    {
        if (array_key_exists("sharedWith", $this->_propDict)) {
            if (is_a($this->_propDict["sharedWith"], "XCloner\\Microsoft\\Graph\\Model\\PlannerUserIds") || is_null($this->_propDict["sharedWith"])) {
