...
class EditionUpgradeConfiguration extends DeviceConfiguration
{
    ...
    public function getLicenseType()
    {
        if (array_key_exists("licenseType", $this->_propDict)) {
            if (is_a($this->_propDict["licenseType"], "XCloner\\Microsoft\\Graph\\Model\\EditionUpgradeLicenseType") || is_null($this->_propDict["licenseType"])) {
    ...
    public function getTargetEdition()
    {
        if (array_key_exists("targetEdition", $this->_propDict)) {
            if (is_a($this->_propDict["targetEdition"], "XCloner\\Microsoft\\Graph\\Model\\Windows10EditionType") || is_null($this->_propDict["targetEdition"])) {
