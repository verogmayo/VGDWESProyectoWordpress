...
class EducationFeedback extends Entity
{
    ...
    public function getFeedbackBy()
    {
        if (array_key_exists("feedbackBy", $this->_propDict)) {
            if (is_a($this->_propDict["feedbackBy"], "XCloner\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["feedbackBy"])) {
    ...
    public function getText()
    {
        if (array_key_exists("text", $this->_propDict)) {
            if (is_a($this->_propDict["text"], "XCloner\\Microsoft\\Graph\\Model\\EducationItemBody") || is_null($this->_propDict["text"])) {
