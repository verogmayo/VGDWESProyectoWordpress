...
class EventMessage extends Message
{
    ...
    public function getEndDateTime()
    {
        if (array_key_exists("endDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["endDateTime"], "XCloner\\Microsoft\\Graph\\Model\\DateTimeTimeZone") || is_null($this->_propDict["endDateTime"])) {
    ...
    public function getMeetingMessageType()
    {
        if (array_key_exists("meetingMessageType", $this->_propDict)) {
            if (is_a($this->_propDict["meetingMessageType"], "XCloner\\Microsoft\\Graph\\Model\\MeetingMessageType") || is_null($this->_propDict["meetingMessageType"])) {
    ...
    public function getEvent()
    {
        if (array_key_exists("event", $this->_propDict)) {
            if (is_a($this->_propDict["event"], "XCloner\\Microsoft\\Graph\\Model\\Event") || is_null($this->_propDict["event"])) {
