...
class SharedDriveItem extends BaseItem
{
    ...
    public function getPermission()
    {
        if (array_key_exists("permission", $this->_propDict)) {
            if (is_a($this->_propDict["permission"], "XCloner\\Microsoft\\Graph\\Model\\Permission") || is_null($this->_propDict["permission"])) {
    ...
    public function getSite()
    {
        if (array_key_exists("site", $this->_propDict)) {
            if (is_a($this->_propDict["site"], "XCloner\\Microsoft\\Graph\\Model\\Site") || is_null($this->_propDict["site"])) {
