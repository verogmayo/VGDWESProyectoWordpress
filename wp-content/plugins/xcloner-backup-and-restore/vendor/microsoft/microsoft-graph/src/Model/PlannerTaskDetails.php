...
class PlannerTaskDetails extends Entity
{
    ...
    public function getChecklist()
    {
        if (array_key_exists("checklist", $this->_propDict)) {
            if (is_a($this->_propDict["checklist"], "XCloner\\Microsoft\\Graph\\Model\\PlannerChecklistItems") || is_null($this->_propDict["checklist"])) {
    ...
    public function getReferences()
    {
        if (array_key_exists("references", $this->_propDict)) {
            if (is_a($this->_propDict["references"], "XCloner\\Microsoft\\Graph\\Model\\PlannerExternalReferences") || is_null($this->_propDict["references"])) {
