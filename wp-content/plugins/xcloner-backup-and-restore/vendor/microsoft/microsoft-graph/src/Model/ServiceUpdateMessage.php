...
class ServiceUpdateMessage extends ServiceAnnouncementBase
{
    ...
    public function getCategory()
    {
        if (array_key_exists("category", $this->_propDict)) {
            if (is_a($this->_propDict["category"], "XCloner\\Microsoft\\Graph\\Model\\ServiceUpdateCategory") || is_null($this->_propDict["category"])) {
    ...
    public function getSeverity()
    {
        if (array_key_exists("severity", $this->_propDict)) {
            if (is_a($this->_propDict["severity"], "XCloner\\Microsoft\\Graph\\Model\\ServiceUpdateSeverity") || is_null($this->_propDict["severity"])) {
    ...
    public function getViewPoint()
    {
        if (array_key_exists("viewPoint", $this->_propDict)) {
            if (is_a($this->_propDict["viewPoint"], "XCloner\\Microsoft\\Graph\\Model\\ServiceUpdateMessageViewpoint") || is_null($this->_propDict["viewPoint"])) {
