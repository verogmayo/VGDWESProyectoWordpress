...
class Message extends OutlookItem
{
    ...
    public function getFlag()
    {
        if (array_key_exists("flag", $this->_propDict)) {
            if (is_a($this->_propDict["flag"], "XCloner\\Microsoft\\Graph\\Model\\FollowupFlag") || is_null($this->_propDict["flag"])) {
    ...
    public function getFrom()
    {
        if (array_key_exists("from", $this->_propDict)) {
            if (is_a($this->_propDict["from"], "XCloner\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["from"])) {
    ...
    public function getInferenceClassification()
    {
        if (array_key_exists("inferenceClassification", $this->_propDict)) {
            if (is_a($this->_propDict["inferenceClassification"], "XCloner\\Microsoft\\Graph\\Model\\InferenceClassificationType") || is_null($this->_propDict["inferenceClassification"])) {
    ...
    public function getSender()
    {
        if (array_key_exists("sender", $this->_propDict)) {
            if (is_a($this->_propDict["sender"], "XCloner\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["sender"])) {
    ...
    public function getUniqueBody()
    {
        if (array_key_exists("uniqueBody", $this->_propDict)) {
            if (is_a($this->_propDict["uniqueBody"], "XCloner\\Microsoft\\Graph\\Model\\ItemBody") || is_null($this->_propDict["uniqueBody"])) {
