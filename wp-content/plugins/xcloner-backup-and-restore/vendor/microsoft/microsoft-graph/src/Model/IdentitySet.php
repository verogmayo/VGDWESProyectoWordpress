...
class IdentitySet extends Entity
{
    ...
    public function getDevice()
    {
        if (array_key_exists("device", $this->_propDict)) {
            if (is_a($this->_propDict["device"], "XCloner\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["device"])) {
    ...
    public function getUser()
    {
        if (array_key_exists("user", $this->_propDict)) {
            if (is_a($this->_propDict["user"], "XCloner\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["user"])) {
