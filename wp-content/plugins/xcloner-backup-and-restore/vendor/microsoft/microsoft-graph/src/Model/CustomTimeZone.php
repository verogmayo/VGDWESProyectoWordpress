...
class CustomTimeZone extends TimeZoneBase
{
    ...
    public function getDaylightOffset()
    {
        if (array_key_exists("daylightOffset", $this->_propDict)) {
            if (is_a($this->_propDict["daylightOffset"], "XCloner\\Microsoft\\Graph\\Model\\DaylightTimeZoneOffset") || is_null($this->_propDict["daylightOffset"])) {
    ...
    public function getStandardOffset()
    {
        if (array_key_exists("standardOffset", $this->_propDict)) {
            if (is_a($this->_propDict["standardOffset"], "XCloner\\Microsoft\\Graph\\Model\\StandardTimeZoneOffset") || is_null($this->_propDict["standardOffset"])) {
