...
class RegistrationEnforcement extends Entity
{
    ...
    public function getAuthenticationMethodsRegistrationCampaign()
    {
        if (array_key_exists("authenticationMethodsRegistrationCampaign", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethodsRegistrationCampaign"], "XCloner\\Microsoft\\Graph\\Model\\AuthenticationMethodsRegistrationCampaign") || is_null($this->_propDict["authenticationMethodsRegistrationCampaign"])) {
