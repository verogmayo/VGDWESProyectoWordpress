...
class WindowsUniversalAppX extends MobileLobApp
{
    ...
    public function getApplicableArchitectures()
    {
        if (array_key_exists("applicableArchitectures", $this->_propDict)) {
            if (is_a($this->_propDict["applicableArchitectures"], "XCloner\\Microsoft\\Graph\\Model\\WindowsArchitecture") || is_null($this->_propDict["applicableArchitectures"])) {
    ...
    public function getApplicableDeviceTypes()
    {
        if (array_key_exists("applicableDeviceTypes", $this->_propDict)) {
            if (is_a($this->_propDict["applicableDeviceTypes"], "XCloner\\Microsoft\\Graph\\Model\\WindowsDeviceType") || is_null($this->_propDict["applicableDeviceTypes"])) {
    ...
    public function getMinimumSupportedOperatingSystem()
    {
        if (array_key_exists("minimumSupportedOperatingSystem", $this->_propDict)) {
            if (is_a($this->_propDict["minimumSupportedOperatingSystem"], "XCloner\\Microsoft\\Graph\\Model\\WindowsMinimumOperatingSystem") || is_null($this->_propDict["minimumSupportedOperatingSystem"])) {
