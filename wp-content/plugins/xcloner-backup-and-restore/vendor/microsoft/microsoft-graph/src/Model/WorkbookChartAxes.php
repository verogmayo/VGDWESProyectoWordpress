...
class WorkbookChartAxes extends Entity
{
    ...
    public function getCategoryAxis()
    {
        if (array_key_exists("categoryAxis", $this->_propDict)) {
            if (is_a($this->_propDict["categoryAxis"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookChartAxis") || is_null($this->_propDict["categoryAxis"])) {
    ...
    public function getSeriesAxis()
    {
        if (array_key_exists("seriesAxis", $this->_propDict)) {
            if (is_a($this->_propDict["seriesAxis"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookChartAxis") || is_null($this->_propDict["seriesAxis"])) {
    ...
    public function getValueAxis()
    {
        if (array_key_exists("valueAxis", $this->_propDict)) {
            if (is_a($this->_propDict["valueAxis"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookChartAxis") || is_null($this->_propDict["valueAxis"])) {
