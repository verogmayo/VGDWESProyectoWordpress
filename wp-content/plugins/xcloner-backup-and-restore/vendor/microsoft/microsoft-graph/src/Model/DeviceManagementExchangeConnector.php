...
class DeviceManagementExchangeConnector extends Entity
{
    ...
    public function getExchangeConnectorType()
    {
        if (array_key_exists("exchangeConnectorType", $this->_propDict)) {
            if (is_a($this->_propDict["exchangeConnectorType"], "XCloner\\Microsoft\\Graph\\Model\\DeviceManagementExchangeConnectorType") || is_null($this->_propDict["exchangeConnectorType"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\DeviceManagementExchangeConnectorStatus") || is_null($this->_propDict["status"])) {
