...
class CalendarSharingMessageAction extends Entity
{
    ...
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "XCloner\\Microsoft\\Graph\\Model\\CalendarSharingAction") || is_null($this->_propDict["action"])) {
    ...
    public function getActionType()
    {
        if (array_key_exists("actionType", $this->_propDict)) {
            if (is_a($this->_propDict["actionType"], "XCloner\\Microsoft\\Graph\\Model\\CalendarSharingActionType") || is_null($this->_propDict["actionType"])) {
    ...
    public function getImportance()
    {
        if (array_key_exists("importance", $this->_propDict)) {
            if (is_a($this->_propDict["importance"], "XCloner\\Microsoft\\Graph\\Model\\CalendarSharingActionImportance") || is_null($this->_propDict["importance"])) {
