...
class SubjectRightsRequestDetail extends Entity
{
    ...
    public function getInsightCounts()
    {
        if (array_key_exists("insightCounts", $this->_propDict)) {
            if (is_a($this->_propDict["insightCounts"], "XCloner\\Microsoft\\Graph\\Model\\KeyValuePair") || is_null($this->_propDict["insightCounts"])) {
    ...
    public function getProductItemCounts()
    {
        if (array_key_exists("productItemCounts", $this->_propDict)) {
            if (is_a($this->_propDict["productItemCounts"], "XCloner\\Microsoft\\Graph\\Model\\KeyValuePair") || is_null($this->_propDict["productItemCounts"])) {
