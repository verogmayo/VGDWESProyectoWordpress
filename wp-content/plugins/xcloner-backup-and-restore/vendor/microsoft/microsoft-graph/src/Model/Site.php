...
class Site extends BaseItem
{
    ...
    public function getSiteCollection()
    {
        if (array_key_exists("siteCollection", $this->_propDict)) {
            if (is_a($this->_propDict["siteCollection"], "XCloner\\Microsoft\\Graph\\Model\\SiteCollection") || is_null($this->_propDict["siteCollection"])) {
    ...
    public function getTermStore()
    {
        if (array_key_exists("termStore", $this->_propDict)) {
            if (is_a($this->_propDict["termStore"], "XCloner\\Microsoft\\Graph\\TermStore\\Model\\Store") || is_null($this->_propDict["termStore"])) {
                return $this->_propDict["termStore"];
            } else {
                $this->_propDict["termStore"] = new \XCloner\Microsoft\Graph\TermStore\Model\Store($this->_propDict["termStore"]);
                return $this->_propDict["termStore"];
            }
        }
        return null;
