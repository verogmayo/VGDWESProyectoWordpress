...
class BookingService extends Entity
{
    ...
    public function getDefaultLocation()
    {
        if (array_key_exists("defaultLocation", $this->_propDict)) {
            if (is_a($this->_propDict["defaultLocation"], "XCloner\\Microsoft\\Graph\\Model\\Location") || is_null($this->_propDict["defaultLocation"])) {
    ...
    public function getDefaultPriceType()
    {
        if (array_key_exists("defaultPriceType", $this->_propDict)) {
            if (is_a($this->_propDict["defaultPriceType"], "XCloner\\Microsoft\\Graph\\Model\\BookingPriceType") || is_null($this->_propDict["defaultPriceType"])) {
    ...
    public function getSchedulingPolicy()
    {
        if (array_key_exists("schedulingPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["schedulingPolicy"], "XCloner\\Microsoft\\Graph\\Model\\BookingSchedulingPolicy") || is_null($this->_propDict["schedulingPolicy"])) {
