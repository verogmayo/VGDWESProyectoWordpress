...
class TodoTask extends Entity
{
    ...
    public function getReminderDateTime()
    {
        if (array_key_exists("reminderDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["reminderDateTime"], "XCloner\\Microsoft\\Graph\\Model\\DateTimeTimeZone") || is_null($this->_propDict["reminderDateTime"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\TaskStatus") || is_null($this->_propDict["status"])) {
