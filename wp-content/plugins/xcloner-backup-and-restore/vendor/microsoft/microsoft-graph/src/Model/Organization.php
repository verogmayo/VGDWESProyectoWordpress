...
class Organization extends DirectoryObject
{
    ...
    public function getPrivacyProfile()
    {
        if (array_key_exists("privacyProfile", $this->_propDict)) {
            if (is_a($this->_propDict["privacyProfile"], "XCloner\\Microsoft\\Graph\\Model\\PrivacyProfile") || is_null($this->_propDict["privacyProfile"])) {
    ...
    public function getMobileDeviceManagementAuthority()
    {
        if (array_key_exists("mobileDeviceManagementAuthority", $this->_propDict)) {
            if (is_a($this->_propDict["mobileDeviceManagementAuthority"], "XCloner\\Microsoft\\Graph\\Model\\MdmAuthority") || is_null($this->_propDict["mobileDeviceManagementAuthority"])) {
    ...
    public function getBranding()
    {
        if (array_key_exists("branding", $this->_propDict)) {
            if (is_a($this->_propDict["branding"], "XCloner\\Microsoft\\Graph\\Model\\OrganizationalBranding") || is_null($this->_propDict["branding"])) {
