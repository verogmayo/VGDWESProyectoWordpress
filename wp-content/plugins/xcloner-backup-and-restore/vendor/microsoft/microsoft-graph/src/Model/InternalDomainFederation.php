...
class InternalDomainFederation extends SamlOrWsFedProvider
{
    ...
    public function getFederatedIdpMfaBehavior()
    {
        if (array_key_exists("federatedIdpMfaBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["federatedIdpMfaBehavior"], "XCloner\\Microsoft\\Graph\\Model\\FederatedIdpMfaBehavior") || is_null($this->_propDict["federatedIdpMfaBehavior"])) {
    ...
    public function getPromptLoginBehavior()
    {
        if (array_key_exists("promptLoginBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["promptLoginBehavior"], "XCloner\\Microsoft\\Graph\\Model\\PromptLoginBehavior") || is_null($this->_propDict["promptLoginBehavior"])) {
    ...
    public function getSigningCertificateUpdateStatus()
    {
        if (array_key_exists("signingCertificateUpdateStatus", $this->_propDict)) {
            if (is_a($this->_propDict["signingCertificateUpdateStatus"], "XCloner\\Microsoft\\Graph\\Model\\SigningCertificateUpdateStatus") || is_null($this->_propDict["signingCertificateUpdateStatus"])) {
