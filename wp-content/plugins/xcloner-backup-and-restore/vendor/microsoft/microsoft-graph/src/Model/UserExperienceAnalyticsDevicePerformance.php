...
class UserExperienceAnalyticsDevicePerformance extends Entity
{
    ...
    public function getDiskType()
    {
        if (array_key_exists("diskType", $this->_propDict)) {
            if (is_a($this->_propDict["diskType"], "XCloner\\Microsoft\\Graph\\Model\\DiskType") || is_null($this->_propDict["diskType"])) {
    ...
    public function getHealthStatus()
    {
        if (array_key_exists("healthStatus", $this->_propDict)) {
            if (is_a($this->_propDict["healthStatus"], "XCloner\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsHealthState") || is_null($this->_propDict["healthStatus"])) {
