...
class TeamsAppDefinition extends Entity
{
    ...
    public function getPublishingState()
    {
        if (array_key_exists("publishingState", $this->_propDict)) {
            if (is_a($this->_propDict["publishingState"], "XCloner\\Microsoft\\Graph\\Model\\TeamsAppPublishingState") || is_null($this->_propDict["publishingState"])) {
    ...
    public function getBot()
    {
        if (array_key_exists("bot", $this->_propDict)) {
            if (is_a($this->_propDict["bot"], "XCloner\\Microsoft\\Graph\\Model\\TeamworkBot") || is_null($this->_propDict["bot"])) {
