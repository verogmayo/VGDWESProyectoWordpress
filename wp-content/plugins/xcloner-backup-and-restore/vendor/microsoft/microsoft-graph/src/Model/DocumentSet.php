...
class DocumentSet extends Entity
{
    ...
    public function getAllowedContentTypes()
    {
        if (array_key_exists("allowedContentTypes", $this->_propDict)) {
            if (is_a($this->_propDict["allowedContentTypes"], "XCloner\\Microsoft\\Graph\\Model\\ContentTypeInfo") || is_null($this->_propDict["allowedContentTypes"])) {
    ...
    public function getDefaultContents()
    {
        if (array_key_exists("defaultContents", $this->_propDict)) {
            if (is_a($this->_propDict["defaultContents"], "XCloner\\Microsoft\\Graph\\Model\\DocumentSetContent") || is_null($this->_propDict["defaultContents"])) {
    ...
    public function getSharedColumns()
    {
        if (array_key_exists("sharedColumns", $this->_propDict)) {
            if (is_a($this->_propDict["sharedColumns"], "XCloner\\Microsoft\\Graph\\Model\\ColumnDefinition") || is_null($this->_propDict["sharedColumns"])) {
    ...
    public function getWelcomePageColumns()
    {
        if (array_key_exists("welcomePageColumns", $this->_propDict)) {
            if (is_a($this->_propDict["welcomePageColumns"], "XCloner\\Microsoft\\Graph\\Model\\ColumnDefinition") || is_null($this->_propDict["welcomePageColumns"])) {
