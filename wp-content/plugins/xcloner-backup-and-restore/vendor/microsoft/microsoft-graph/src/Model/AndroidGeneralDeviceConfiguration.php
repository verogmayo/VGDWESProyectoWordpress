...
class AndroidGeneralDeviceConfiguration extends DeviceConfiguration
{
    ...
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "XCloner\\Microsoft\\Graph\\Model\\AndroidRequiredPasswordType") || is_null($this->_propDict["passwordRequiredType"])) {
    ...
    public function getWebBrowserCookieSettings()
    {
        if (array_key_exists("webBrowserCookieSettings", $this->_propDict)) {
            if (is_a($this->_propDict["webBrowserCookieSettings"], "XCloner\\Microsoft\\Graph\\Model\\WebBrowserCookieSettings") || is_null($this->_propDict["webBrowserCookieSettings"])) {
