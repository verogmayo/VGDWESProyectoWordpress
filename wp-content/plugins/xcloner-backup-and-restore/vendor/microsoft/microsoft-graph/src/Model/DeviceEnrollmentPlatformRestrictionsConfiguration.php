...
class DeviceEnrollmentPlatformRestrictionsConfiguration extends DeviceEnrollmentConfiguration
{
    ...
    public function getAndroidRestriction()
    {
        if (array_key_exists("androidRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["androidRestriction"], "XCloner\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["androidRestriction"])) {
    ...
    public function getIosRestriction()
    {
        if (array_key_exists("iosRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["iosRestriction"], "XCloner\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["iosRestriction"])) {
    ...
    public function getMacOSRestriction()
    {
        if (array_key_exists("macOSRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["macOSRestriction"], "XCloner\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["macOSRestriction"])) {
    ...
    public function getWindowsMobileRestriction()
    {
        if (array_key_exists("windowsMobileRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsMobileRestriction"], "XCloner\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["windowsMobileRestriction"])) {
    ...
    public function getWindowsRestriction()
    {
        if (array_key_exists("windowsRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsRestriction"], "XCloner\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["windowsRestriction"])) {
