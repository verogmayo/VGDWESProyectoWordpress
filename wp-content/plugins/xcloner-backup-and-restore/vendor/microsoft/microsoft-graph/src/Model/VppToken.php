...
class VppToken extends Entity
{
    ...
    public function getLastSyncStatus()
    {
        if (array_key_exists("lastSyncStatus", $this->_propDict)) {
            if (is_a($this->_propDict["lastSyncStatus"], "XCloner\\Microsoft\\Graph\\Model\\VppTokenSyncStatus") || is_null($this->_propDict["lastSyncStatus"])) {
    ...
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "XCloner\\Microsoft\\Graph\\Model\\VppTokenState") || is_null($this->_propDict["state"])) {
