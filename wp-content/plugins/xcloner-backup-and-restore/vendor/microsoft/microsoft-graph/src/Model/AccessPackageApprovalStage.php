...
class AccessPackageApprovalStage extends Entity
{
    ...
    public function getEscalationApprovers()
    {
        if (array_key_exists("escalationApprovers", $this->_propDict)) {
            if (is_a($this->_propDict["escalationApprovers"], "XCloner\\Microsoft\\Graph\\Model\\SubjectSet") || is_null($this->_propDict["escalationApprovers"])) {
    ...
    public function getFallbackEscalationApprovers()
    {
        if (array_key_exists("fallbackEscalationApprovers", $this->_propDict)) {
            if (is_a($this->_propDict["fallbackEscalationApprovers"], "XCloner\\Microsoft\\Graph\\Model\\SubjectSet") || is_null($this->_propDict["fallbackEscalationApprovers"])) {
    ...
    public function getFallbackPrimaryApprovers()
    {
        if (array_key_exists("fallbackPrimaryApprovers", $this->_propDict)) {
            if (is_a($this->_propDict["fallbackPrimaryApprovers"], "XCloner\\Microsoft\\Graph\\Model\\SubjectSet") || is_null($this->_propDict["fallbackPrimaryApprovers"])) {
    ...
    public function getPrimaryApprovers()
    {
        if (array_key_exists("primaryApprovers", $this->_propDict)) {
            if (is_a($this->_propDict["primaryApprovers"], "XCloner\\Microsoft\\Graph\\Model\\SubjectSet") || is_null($this->_propDict["primaryApprovers"])) {
