...
class ServiceHealthIssue extends ServiceAnnouncementBase
{
    ...
    public function getClassification()
    {
        if (array_key_exists("classification", $this->_propDict)) {
            if (is_a($this->_propDict["classification"], "XCloner\\Microsoft\\Graph\\Model\\ServiceHealthClassificationType") || is_null($this->_propDict["classification"])) {
    ...
    public function getOrigin()
    {
        if (array_key_exists("origin", $this->_propDict)) {
            if (is_a($this->_propDict["origin"], "XCloner\\Microsoft\\Graph\\Model\\ServiceHealthOrigin") || is_null($this->_propDict["origin"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\ServiceHealthStatus") || is_null($this->_propDict["status"])) {
