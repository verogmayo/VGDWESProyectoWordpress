...
class AccessPackageAssignmentPolicy extends Entity
{
    ...
    public function getAllowedTargetScope()
    {
        if (array_key_exists("allowedTargetScope", $this->_propDict)) {
            if (is_a($this->_propDict["allowedTargetScope"], "XCloner\\Microsoft\\Graph\\Model\\AllowedTargetScope") || is_null($this->_propDict["allowedTargetScope"])) {
    ...
    public function getAutomaticRequestSettings()
    {
        if (array_key_exists("automaticRequestSettings", $this->_propDict)) {
            if (is_a($this->_propDict["automaticRequestSettings"], "XCloner\\Microsoft\\Graph\\Model\\AccessPackageAutomaticRequestSettings") || is_null($this->_propDict["automaticRequestSettings"])) {
    ...
    public function getRequestApprovalSettings()
    {
        if (array_key_exists("requestApprovalSettings", $this->_propDict)) {
            if (is_a($this->_propDict["requestApprovalSettings"], "XCloner\\Microsoft\\Graph\\Model\\AccessPackageAssignmentApprovalSettings") || is_null($this->_propDict["requestApprovalSettings"])) {
    ...
    public function getRequestorSettings()
    {
        if (array_key_exists("requestorSettings", $this->_propDict)) {
            if (is_a($this->_propDict["requestorSettings"], "XCloner\\Microsoft\\Graph\\Model\\AccessPackageAssignmentRequestorSettings") || is_null($this->_propDict["requestorSettings"])) {
    ...
    public function getReviewSettings()
    {
        if (array_key_exists("reviewSettings", $this->_propDict)) {
            if (is_a($this->_propDict["reviewSettings"], "XCloner\\Microsoft\\Graph\\Model\\AccessPackageAssignmentReviewSettings") || is_null($this->_propDict["reviewSettings"])) {
