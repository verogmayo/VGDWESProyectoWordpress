...
class UserSecurityState extends Entity
{
    ...
    public function getEmailRole()
    {
        if (array_key_exists("emailRole", $this->_propDict)) {
            if (is_a($this->_propDict["emailRole"], "XCloner\\Microsoft\\Graph\\Model\\EmailRole") || is_null($this->_propDict["emailRole"])) {
    ...
    public function getLogonType()
    {
        if (array_key_exists("logonType", $this->_propDict)) {
            if (is_a($this->_propDict["logonType"], "XCloner\\Microsoft\\Graph\\Model\\LogonType") || is_null($this->_propDict["logonType"])) {
    ...
    public function getUserAccountType()
    {
        if (array_key_exists("userAccountType", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountType"], "XCloner\\Microsoft\\Graph\\Model\\UserAccountSecurityType") || is_null($this->_propDict["userAccountType"])) {
