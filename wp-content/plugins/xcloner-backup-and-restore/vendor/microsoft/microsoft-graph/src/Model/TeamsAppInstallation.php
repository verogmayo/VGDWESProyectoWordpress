...
class TeamsAppInstallation extends Entity
{
    ...
    public function getTeamsApp()
    {
        if (array_key_exists("teamsApp", $this->_propDict)) {
            if (is_a($this->_propDict["teamsApp"], "XCloner\\Microsoft\\Graph\\Model\\TeamsApp") || is_null($this->_propDict["teamsApp"])) {
    ...
    public function getTeamsAppDefinition()
    {
        if (array_key_exists("teamsAppDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["teamsAppDefinition"], "XCloner\\Microsoft\\Graph\\Model\\TeamsAppDefinition") || is_null($this->_propDict["teamsAppDefinition"])) {
