...
class MailboxSettings extends Entity
{
    ...
    public function getAutomaticRepliesSetting()
    {
        if (array_key_exists("automaticRepliesSetting", $this->_propDict)) {
            if (is_a($this->_propDict["automaticRepliesSetting"], "XCloner\\Microsoft\\Graph\\Model\\AutomaticRepliesSetting") || is_null($this->_propDict["automaticRepliesSetting"])) {
    ...
    public function getDelegateMeetingMessageDeliveryOptions()
    {
        if (array_key_exists("delegateMeetingMessageDeliveryOptions", $this->_propDict)) {
            if (is_a($this->_propDict["delegateMeetingMessageDeliveryOptions"], "XCloner\\Microsoft\\Graph\\Model\\DelegateMeetingMessageDeliveryOptions") || is_null($this->_propDict["delegateMeetingMessageDeliveryOptions"])) {
    ...
    public function getLanguage()
    {
        if (array_key_exists("language", $this->_propDict)) {
            if (is_a($this->_propDict["language"], "XCloner\\Microsoft\\Graph\\Model\\LocaleInfo") || is_null($this->_propDict["language"])) {
    ...
    public function getUserPurpose()
    {
        if (array_key_exists("userPurpose", $this->_propDict)) {
            if (is_a($this->_propDict["userPurpose"], "XCloner\\Microsoft\\Graph\\Model\\UserPurpose") || is_null($this->_propDict["userPurpose"])) {
    ...
    public function getWorkingHours()
    {
        if (array_key_exists("workingHours", $this->_propDict)) {
            if (is_a($this->_propDict["workingHours"], "XCloner\\Microsoft\\Graph\\Model\\WorkingHours") || is_null($this->_propDict["workingHours"])) {
