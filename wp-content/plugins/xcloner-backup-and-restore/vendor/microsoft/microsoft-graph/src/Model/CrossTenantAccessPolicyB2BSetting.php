...
class CrossTenantAccessPolicyB2BSetting extends Entity
{
    ...
    public function getApplications()
    {
        if (array_key_exists("applications", $this->_propDict)) {
            if (is_a($this->_propDict["applications"], "XCloner\\Microsoft\\Graph\\Model\\CrossTenantAccessPolicyTargetConfiguration") || is_null($this->_propDict["applications"])) {
    ...
    public function getUsersAndGroups()
    {
        if (array_key_exists("usersAndGroups", $this->_propDict)) {
            if (is_a($this->_propDict["usersAndGroups"], "XCloner\\Microsoft\\Graph\\Model\\CrossTenantAccessPolicyTargetConfiguration") || is_null($this->_propDict["usersAndGroups"])) {
