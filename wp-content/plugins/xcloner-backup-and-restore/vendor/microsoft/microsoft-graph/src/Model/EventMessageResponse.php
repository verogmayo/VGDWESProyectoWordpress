...
class EventMessageResponse extends EventMessage
{
    ...
    public function getProposedNewTime()
    {
        if (array_key_exists("proposedNewTime", $this->_propDict)) {
            if (is_a($this->_propDict["proposedNewTime"], "XCloner\\Microsoft\\Graph\\Model\\TimeSlot") || is_null($this->_propDict["proposedNewTime"])) {
    ...
    public function getResponseType()
    {
        if (array_key_exists("responseType", $this->_propDict)) {
            if (is_a($this->_propDict["responseType"], "XCloner\\Microsoft\\Graph\\Model\\ResponseType") || is_null($this->_propDict["responseType"])) {
