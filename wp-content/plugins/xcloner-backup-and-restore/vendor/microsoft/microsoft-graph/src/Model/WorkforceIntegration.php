...
class WorkforceIntegration extends ChangeTrackedEntity
{
    ...
    public function getEncryption()
    {
        if (array_key_exists("encryption", $this->_propDict)) {
            if (is_a($this->_propDict["encryption"], "XCloner\\Microsoft\\Graph\\Model\\WorkforceIntegrationEncryption") || is_null($this->_propDict["encryption"])) {
    ...
    public function getSupportedEntities()
    {
        if (array_key_exists("supportedEntities", $this->_propDict)) {
            if (is_a($this->_propDict["supportedEntities"], "XCloner\\Microsoft\\Graph\\Model\\WorkforceIntegrationSupportedEntities") || is_null($this->_propDict["supportedEntities"])) {
