...
class MediaStream extends Entity
{
    ...
    public function getDirection()
    {
        if (array_key_exists("direction", $this->_propDict)) {
            if (is_a($this->_propDict["direction"], "XCloner\\Microsoft\\Graph\\Model\\MediaDirection") || is_null($this->_propDict["direction"])) {
    ...
    public function getMediaType()
    {
        if (array_key_exists("mediaType", $this->_propDict)) {
            if (is_a($this->_propDict["mediaType"], "XCloner\\Microsoft\\Graph\\Model\\Modality") || is_null($this->_propDict["mediaType"])) {
