...
class EducationFeedbackOutcome extends EducationOutcome
{
    ...
    public function getFeedback()
    {
        if (array_key_exists("feedback", $this->_propDict)) {
            if (is_a($this->_propDict["feedback"], "XCloner\\Microsoft\\Graph\\Model\\EducationFeedback") || is_null($this->_propDict["feedback"])) {
    ...
    public function getPublishedFeedback()
    {
        if (array_key_exists("publishedFeedback", $this->_propDict)) {
            if (is_a($this->_propDict["publishedFeedback"], "XCloner\\Microsoft\\Graph\\Model\\EducationFeedback") || is_null($this->_propDict["publishedFeedback"])) {
