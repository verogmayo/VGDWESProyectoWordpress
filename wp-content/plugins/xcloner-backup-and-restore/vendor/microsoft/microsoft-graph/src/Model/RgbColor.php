...
class RgbColor extends Entity
{
    ...
    public function getB()
    {
        if (array_key_exists("b", $this->_propDict)) {
            if (is_a($this->_propDict["b"], "XCloner\\Microsoft\\Graph\\Model\\Byte") || is_null($this->_propDict["b"])) {
    ...
    public function getG()
    {
        if (array_key_exists("g", $this->_propDict)) {
            if (is_a($this->_propDict["g"], "XCloner\\Microsoft\\Graph\\Model\\Byte") || is_null($this->_propDict["g"])) {
    ...
    public function getR()
    {
        if (array_key_exists("r", $this->_propDict)) {
            if (is_a($this->_propDict["r"], "XCloner\\Microsoft\\Graph\\Model\\Byte") || is_null($this->_propDict["r"])) {
