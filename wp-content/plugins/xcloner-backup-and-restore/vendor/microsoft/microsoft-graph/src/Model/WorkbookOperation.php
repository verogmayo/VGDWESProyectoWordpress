...
class WorkbookOperation extends Entity
{
    ...
    public function getError()
    {
        if (array_key_exists("error", $this->_propDict)) {
            if (is_a($this->_propDict["error"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookOperationError") || is_null($this->_propDict["error"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\WorkbookOperationStatus") || is_null($this->_propDict["status"])) {
