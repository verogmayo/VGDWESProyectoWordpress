...
class ManagedDeviceMobileAppConfiguration extends Entity
{
    ...
    public function getDeviceStatusSummary()
    {
        if (array_key_exists("deviceStatusSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStatusSummary"], "XCloner\\Microsoft\\Graph\\Model\\ManagedDeviceMobileAppConfigurationDeviceSummary") || is_null($this->_propDict["deviceStatusSummary"])) {
    ...
    public function getUserStatusSummary()
    {
        if (array_key_exists("userStatusSummary", $this->_propDict)) {
            if (is_a($this->_propDict["userStatusSummary"], "XCloner\\Microsoft\\Graph\\Model\\ManagedDeviceMobileAppConfigurationUserSummary") || is_null($this->_propDict["userStatusSummary"])) {
