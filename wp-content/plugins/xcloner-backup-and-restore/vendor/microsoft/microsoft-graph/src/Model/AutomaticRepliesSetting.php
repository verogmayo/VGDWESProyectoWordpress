...
class AutomaticRepliesSetting extends Entity
{
    ...
    public function getExternalAudience()
    {
        if (array_key_exists("externalAudience", $this->_propDict)) {
            if (is_a($this->_propDict["externalAudience"], "XCloner\\Microsoft\\Graph\\Model\\ExternalAudienceScope") || is_null($this->_propDict["externalAudience"])) {
    ...
    public function getScheduledEndDateTime()
    {
        if (array_key_exists("scheduledEndDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledEndDateTime"], "XCloner\\Microsoft\\Graph\\Model\\DateTimeTimeZone") || is_null($this->_propDict["scheduledEndDateTime"])) {
    ...
    public function getScheduledStartDateTime()
    {
        if (array_key_exists("scheduledStartDateTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledStartDateTime"], "XCloner\\Microsoft\\Graph\\Model\\DateTimeTimeZone") || is_null($this->_propDict["scheduledStartDateTime"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Microsoft\\Graph\\Model\\AutomaticRepliesStatus") || is_null($this->_propDict["status"])) {
