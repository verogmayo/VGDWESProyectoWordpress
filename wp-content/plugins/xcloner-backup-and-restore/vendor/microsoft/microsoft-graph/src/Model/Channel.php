...
class Channel extends Entity
{
    ...
    public function getMembershipType()
    {
        if (array_key_exists("membershipType", $this->_propDict)) {
            if (is_a($this->_propDict["membershipType"], "XCloner\\Microsoft\\Graph\\Model\\ChannelMembershipType") || is_null($this->_propDict["membershipType"])) {
    ...
    public function getFilesFolder()
    {
        if (array_key_exists("filesFolder", $this->_propDict)) {
            if (is_a($this->_propDict["filesFolder"], "XCloner\\Microsoft\\Graph\\Model\\DriveItem") || is_null($this->_propDict["filesFolder"])) {
