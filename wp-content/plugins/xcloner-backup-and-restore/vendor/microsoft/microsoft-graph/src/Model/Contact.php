...
class Contact extends OutlookItem
{
    ...
    public function getBusinessAddress()
    {
        if (array_key_exists("businessAddress", $this->_propDict)) {
            if (is_a($this->_propDict["businessAddress"], "XCloner\\Microsoft\\Graph\\Model\\PhysicalAddress") || is_null($this->_propDict["businessAddress"])) {
    ...
    public function getHomeAddress()
    {
        if (array_key_exists("homeAddress", $this->_propDict)) {
            if (is_a($this->_propDict["homeAddress"], "XCloner\\Microsoft\\Graph\\Model\\PhysicalAddress") || is_null($this->_propDict["homeAddress"])) {
    ...
    public function getOtherAddress()
    {
        if (array_key_exists("otherAddress", $this->_propDict)) {
            if (is_a($this->_propDict["otherAddress"], "XCloner\\Microsoft\\Graph\\Model\\PhysicalAddress") || is_null($this->_propDict["otherAddress"])) {
