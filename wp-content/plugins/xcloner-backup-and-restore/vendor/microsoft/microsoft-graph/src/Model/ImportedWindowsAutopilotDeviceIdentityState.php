...
class ImportedWindowsAutopilotDeviceIdentityState extends Entity
{
    ...
    public function getDeviceImportStatus()
    {
        if (array_key_exists("deviceImportStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deviceImportStatus"], "XCloner\\Microsoft\\Graph\\Model\\ImportedWindowsAutopilotDeviceIdentityImportStatus") || is_null($this->_propDict["deviceImportStatus"])) {
