...
class BucketAggregationDefinition extends Entity
{
    ...
    public function getRanges()
    {
        if (array_key_exists("ranges", $this->_propDict)) {
            if (is_a($this->_propDict["ranges"], "XCloner\\Microsoft\\Graph\\Model\\BucketAggregationRange") || is_null($this->_propDict["ranges"])) {
    ...
    public function getSortBy()
    {
        if (array_key_exists("sortBy", $this->_propDict)) {
            if (is_a($this->_propDict["sortBy"], "XCloner\\Microsoft\\Graph\\Model\\BucketAggregationSortProperty") || is_null($this->_propDict["sortBy"])) {
