...
class PhoneAuthenticationMethod extends AuthenticationMethod
{
    ...
    public function getPhoneType()
    {
        if (array_key_exists("phoneType", $this->_propDict)) {
            if (is_a($this->_propDict["phoneType"], "XCloner\\Microsoft\\Graph\\Model\\AuthenticationPhoneType") || is_null($this->_propDict["phoneType"])) {
    ...
    public function getSmsSignInState()
    {
        if (array_key_exists("smsSignInState", $this->_propDict)) {
            if (is_a($this->_propDict["smsSignInState"], "XCloner\\Microsoft\\Graph\\Model\\AuthenticationMethodSignInState") || is_null($this->_propDict["smsSignInState"])) {
