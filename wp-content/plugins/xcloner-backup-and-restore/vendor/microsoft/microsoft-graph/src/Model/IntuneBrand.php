...
class IntuneBrand extends Entity
{
    ...
    public function getDarkBackgroundLogo()
    {
        if (array_key_exists("darkBackgroundLogo", $this->_propDict)) {
            if (is_a($this->_propDict["darkBackgroundLogo"], "XCloner\\Microsoft\\Graph\\Model\\MimeContent") || is_null($this->_propDict["darkBackgroundLogo"])) {
    ...
    public function getLightBackgroundLogo()
    {
        if (array_key_exists("lightBackgroundLogo", $this->_propDict)) {
            if (is_a($this->_propDict["lightBackgroundLogo"], "XCloner\\Microsoft\\Graph\\Model\\MimeContent") || is_null($this->_propDict["lightBackgroundLogo"])) {
    ...
    public function getThemeColor()
    {
        if (array_key_exists("themeColor", $this->_propDict)) {
            if (is_a($this->_propDict["themeColor"], "XCloner\\Microsoft\\Graph\\Model\\RgbColor") || is_null($this->_propDict["themeColor"])) {
