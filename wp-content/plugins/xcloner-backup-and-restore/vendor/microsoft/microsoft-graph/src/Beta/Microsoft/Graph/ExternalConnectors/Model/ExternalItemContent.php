...
* @link      https://graph.microsoft.com
*/
class ExternalItemContent extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the type
    ...
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\ExternalItemContentType") || is_null($this->_propDict["type"])) {
