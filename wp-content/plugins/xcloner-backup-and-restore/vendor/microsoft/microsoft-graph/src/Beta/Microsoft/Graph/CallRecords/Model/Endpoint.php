...
* @link      https://graph.microsoft.com
*/
class Endpoint extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the userAgent
    ...
    public function getUserAgent()
    {
        if (array_key_exists("userAgent", $this->_propDict)) {
            if (is_a($this->_propDict["userAgent"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\UserAgent") || is_null($this->_propDict["userAgent"])) {
