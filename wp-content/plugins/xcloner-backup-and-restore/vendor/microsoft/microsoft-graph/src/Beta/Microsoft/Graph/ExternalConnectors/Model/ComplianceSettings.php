...
* @link      https://graph.microsoft.com
*/
class ComplianceSettings extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getEDiscoveryResultTemplates()
    {
        if (array_key_exists("eDiscoveryResultTemplates", $this->_propDict)) {
            if (is_a($this->_propDict["eDiscoveryResultTemplates"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\DisplayTemplate") || is_null($this->_propDict["eDiscoveryResultTemplates"])) {
