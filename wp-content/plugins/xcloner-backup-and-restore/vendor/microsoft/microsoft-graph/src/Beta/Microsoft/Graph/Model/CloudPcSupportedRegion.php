...
class CloudPcSupportedRegion extends Entity
{
    ...
    public function getRegionStatus()
    {
        if (array_key_exists("regionStatus", $this->_propDict)) {
            if (is_a($this->_propDict["regionStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcSupportedRegionStatus") || is_null($this->_propDict["regionStatus"])) {
    ...
    public function getSupportedSolution()
    {
        if (array_key_exists("supportedSolution", $this->_propDict)) {
            if (is_a($this->_propDict["supportedSolution"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcManagementService") || is_null($this->_propDict["supportedSolution"])) {
