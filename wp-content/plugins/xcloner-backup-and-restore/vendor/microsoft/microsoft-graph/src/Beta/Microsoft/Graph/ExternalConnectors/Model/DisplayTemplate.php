...
* @link      https://graph.microsoft.com
*/
class DisplayTemplate extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the id
    ...
    public function getRules()
    {
        if (array_key_exists("rules", $this->_propDict)) {
            if (is_a($this->_propDict["rules"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\PropertyRule") || is_null($this->_propDict["rules"])) {
