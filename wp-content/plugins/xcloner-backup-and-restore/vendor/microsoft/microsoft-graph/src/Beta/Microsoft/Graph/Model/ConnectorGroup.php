...
class ConnectorGroup extends Entity
{
    ...
    public function getConnectorGroupType()
    {
        if (array_key_exists("connectorGroupType", $this->_propDict)) {
            if (is_a($this->_propDict["connectorGroupType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConnectorGroupType") || is_null($this->_propDict["connectorGroupType"])) {
    ...
    public function getRegion()
    {
        if (array_key_exists("region", $this->_propDict)) {
            if (is_a($this->_propDict["region"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConnectorGroupRegion") || is_null($this->_propDict["region"])) {
