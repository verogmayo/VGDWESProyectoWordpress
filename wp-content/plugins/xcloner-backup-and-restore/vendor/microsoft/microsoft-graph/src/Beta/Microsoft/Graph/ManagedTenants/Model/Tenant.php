...
* @link      https://graph.microsoft.com
*/
class Tenant extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the contract
    ...
    public function getContract()
    {
        if (array_key_exists("contract", $this->_propDict)) {
            if (is_a($this->_propDict["contract"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\TenantContract") || is_null($this->_propDict["contract"])) {
    ...
    public function getTenantStatusInformation()
    {
        if (array_key_exists("tenantStatusInformation", $this->_propDict)) {
            if (is_a($this->_propDict["tenantStatusInformation"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\TenantStatusInformation") || is_null($this->_propDict["tenantStatusInformation"])) {
