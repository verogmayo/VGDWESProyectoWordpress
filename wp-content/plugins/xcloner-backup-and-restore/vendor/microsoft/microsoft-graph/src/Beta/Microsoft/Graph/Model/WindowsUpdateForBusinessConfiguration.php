...
class WindowsUpdateForBusinessConfiguration extends DeviceConfiguration
{
    ...
    public function getAutomaticUpdateMode()
    {
        if (array_key_exists("automaticUpdateMode", $this->_propDict)) {
            if (is_a($this->_propDict["automaticUpdateMode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AutomaticUpdateMode") || is_null($this->_propDict["automaticUpdateMode"])) {
    ...
    public function getAutoRestartNotificationDismissal()
    {
        if (array_key_exists("autoRestartNotificationDismissal", $this->_propDict)) {
            if (is_a($this->_propDict["autoRestartNotificationDismissal"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AutoRestartNotificationDismissalMethod") || is_null($this->_propDict["autoRestartNotificationDismissal"])) {
    ...
    public function getBusinessReadyUpdatesOnly()
    {
        if (array_key_exists("businessReadyUpdatesOnly", $this->_propDict)) {
            if (is_a($this->_propDict["businessReadyUpdatesOnly"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsUpdateType") || is_null($this->_propDict["businessReadyUpdatesOnly"])) {
    ...
    public function getDeliveryOptimizationMode()
    {
        if (array_key_exists("deliveryOptimizationMode", $this->_propDict)) {
            if (is_a($this->_propDict["deliveryOptimizationMode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsDeliveryOptimizationMode") || is_null($this->_propDict["deliveryOptimizationMode"])) {
    ...
    public function getInstallationSchedule()
    {
        if (array_key_exists("installationSchedule", $this->_propDict)) {
            if (is_a($this->_propDict["installationSchedule"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsUpdateInstallScheduleType") || is_null($this->_propDict["installationSchedule"])) {
    ...
    public function getPrereleaseFeatures()
    {
        if (array_key_exists("prereleaseFeatures", $this->_propDict)) {
            if (is_a($this->_propDict["prereleaseFeatures"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrereleaseFeatures") || is_null($this->_propDict["prereleaseFeatures"])) {
    ...
    public function getUpdateNotificationLevel()
    {
        if (array_key_exists("updateNotificationLevel", $this->_propDict)) {
            if (is_a($this->_propDict["updateNotificationLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsUpdateNotificationDisplayOption") || is_null($this->_propDict["updateNotificationLevel"])) {
    ...
    public function getUpdateWeeks()
    {
        if (array_key_exists("updateWeeks", $this->_propDict)) {
            if (is_a($this->_propDict["updateWeeks"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsUpdateForBusinessUpdateWeeks") || is_null($this->_propDict["updateWeeks"])) {
    ...
    public function getUserPauseAccess()
    {
        if (array_key_exists("userPauseAccess", $this->_propDict)) {
            if (is_a($this->_propDict["userPauseAccess"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["userPauseAccess"])) {
    ...
    public function getUserWindowsUpdateScanAccess()
    {
        if (array_key_exists("userWindowsUpdateScanAccess", $this->_propDict)) {
            if (is_a($this->_propDict["userWindowsUpdateScanAccess"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["userWindowsUpdateScanAccess"])) {
