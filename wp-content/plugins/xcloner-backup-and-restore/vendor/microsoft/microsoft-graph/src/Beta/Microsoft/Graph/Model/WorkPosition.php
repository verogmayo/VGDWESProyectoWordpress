...
class WorkPosition extends ItemFacet
{
    ...
    public function getDetail()
    {
        if (array_key_exists("detail", $this->_propDict)) {
            if (is_a($this->_propDict["detail"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PositionDetail") || is_null($this->_propDict["detail"])) {
    ...
    public function getManager()
    {
        if (array_key_exists("manager", $this->_propDict)) {
            if (is_a($this->_propDict["manager"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RelatedPerson") || is_null($this->_propDict["manager"])) {
