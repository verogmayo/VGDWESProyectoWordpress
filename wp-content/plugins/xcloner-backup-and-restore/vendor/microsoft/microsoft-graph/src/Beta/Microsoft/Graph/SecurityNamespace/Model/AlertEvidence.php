...
* @link      https://graph.microsoft.com
*/
class AlertEvidence extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getRemediationStatus()
    {
        if (array_key_exists("remediationStatus", $this->_propDict)) {
            if (is_a($this->_propDict["remediationStatus"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\EvidenceRemediationStatus") || is_null($this->_propDict["remediationStatus"])) {
    ...
    public function getRoles()
    {
        if (array_key_exists("roles", $this->_propDict)) {
            if (is_a($this->_propDict["roles"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\EvidenceRole") || is_null($this->_propDict["roles"])) {
    ...
    public function getVerdict()
    {
        if (array_key_exists("verdict", $this->_propDict)) {
            if (is_a($this->_propDict["verdict"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\EvidenceVerdict") || is_null($this->_propDict["verdict"])) {
