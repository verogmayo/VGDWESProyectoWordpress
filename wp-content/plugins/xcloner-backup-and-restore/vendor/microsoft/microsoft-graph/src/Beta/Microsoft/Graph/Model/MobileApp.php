...
class MobileApp extends Entity
{
    ...
    public function getLargeIcon()
    {
        if (array_key_exists("largeIcon", $this->_propDict)) {
            if (is_a($this->_propDict["largeIcon"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MimeContent") || is_null($this->_propDict["largeIcon"])) {
    ...
    public function getPublishingState()
    {
        if (array_key_exists("publishingState", $this->_propDict)) {
            if (is_a($this->_propDict["publishingState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MobileAppPublishingState") || is_null($this->_propDict["publishingState"])) {
    ...
    public function getInstallSummary()
    {
        if (array_key_exists("installSummary", $this->_propDict)) {
            if (is_a($this->_propDict["installSummary"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MobileAppInstallSummary") || is_null($this->_propDict["installSummary"])) {
