...
class TeamworkDeviceConfiguration extends Entity
{
    ...
    public function getCameraConfiguration()
    {
        if (array_key_exists("cameraConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["cameraConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkCameraConfiguration") || is_null($this->_propDict["cameraConfiguration"])) {
    ...
    public function getDisplayConfiguration()
    {
        if (array_key_exists("displayConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["displayConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkDisplayConfiguration") || is_null($this->_propDict["displayConfiguration"])) {
    ...
    public function getHardwareConfiguration()
    {
        if (array_key_exists("hardwareConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["hardwareConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkHardwareConfiguration") || is_null($this->_propDict["hardwareConfiguration"])) {
    ...
    public function getMicrophoneConfiguration()
    {
        if (array_key_exists("microphoneConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["microphoneConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkMicrophoneConfiguration") || is_null($this->_propDict["microphoneConfiguration"])) {
    ...
    public function getSoftwareVersions()
    {
        if (array_key_exists("softwareVersions", $this->_propDict)) {
            if (is_a($this->_propDict["softwareVersions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkDeviceSoftwareVersions") || is_null($this->_propDict["softwareVersions"])) {
    ...
    public function getSpeakerConfiguration()
    {
        if (array_key_exists("speakerConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["speakerConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkSpeakerConfiguration") || is_null($this->_propDict["speakerConfiguration"])) {
    ...
    public function getSystemConfiguration()
    {
        if (array_key_exists("systemConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["systemConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkSystemConfiguration") || is_null($this->_propDict["systemConfiguration"])) {
    ...
    public function getTeamsClientConfiguration()
    {
        if (array_key_exists("teamsClientConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["teamsClientConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkTeamsClientConfiguration") || is_null($this->_propDict["teamsClientConfiguration"])) {
