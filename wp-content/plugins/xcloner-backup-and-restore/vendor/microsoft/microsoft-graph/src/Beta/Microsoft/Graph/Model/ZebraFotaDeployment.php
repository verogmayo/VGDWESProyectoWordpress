...
class ZebraFotaDeployment extends Entity
{
    ...
    public function getDeploymentSettings()
    {
        if (array_key_exists("deploymentSettings", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ZebraFotaDeploymentSettings") || is_null($this->_propDict["deploymentSettings"])) {
    ...
    public function getDeploymentStatus()
    {
        if (array_key_exists("deploymentStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ZebraFotaDeploymentStatus") || is_null($this->_propDict["deploymentStatus"])) {
