...
class WindowsNetworkIsolationPolicy extends Entity
{
    ...
    public function getEnterpriseCloudResources()
    {
        if (array_key_exists("enterpriseCloudResources", $this->_propDict)) {
            if (is_a($this->_propDict["enterpriseCloudResources"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ProxiedDomain") || is_null($this->_propDict["enterpriseCloudResources"])) {
    ...
    public function getEnterpriseIPRanges()
    {
        if (array_key_exists("enterpriseIPRanges", $this->_propDict)) {
            if (is_a($this->_propDict["enterpriseIPRanges"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IpRange") || is_null($this->_propDict["enterpriseIPRanges"])) {
