...
class CustomExtensionHandlerInstance extends Entity
{
    ...
    public function getStage()
    {
        if (array_key_exists("stage", $this->_propDict)) {
            if (is_a($this->_propDict["stage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageCustomExtensionStage") || is_null($this->_propDict["stage"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageCustomExtensionHandlerStatus") || is_null($this->_propDict["status"])) {
