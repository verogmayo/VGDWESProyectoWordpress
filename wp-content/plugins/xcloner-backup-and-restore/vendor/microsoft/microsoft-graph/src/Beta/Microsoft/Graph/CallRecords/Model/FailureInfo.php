...
* @link      https://graph.microsoft.com
*/
class FailureInfo extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the reason
    ...
    public function getStage()
    {
        if (array_key_exists("stage", $this->_propDict)) {
            if (is_a($this->_propDict["stage"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\FailureStage") || is_null($this->_propDict["stage"])) {
