...
class HardwareInformation extends Entity
{
    ...
    public function getDeviceGuardLocalSystemAuthorityCredentialGuardState()
    {
        if (array_key_exists("deviceGuardLocalSystemAuthorityCredentialGuardState", $this->_propDict)) {
            if (is_a($this->_propDict["deviceGuardLocalSystemAuthorityCredentialGuardState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceGuardLocalSystemAuthorityCredentialGuardState") || is_null($this->_propDict["deviceGuardLocalSystemAuthorityCredentialGuardState"])) {
    ...
    public function getDeviceGuardVirtualizationBasedSecurityHardwareRequirementState()
    {
        if (array_key_exists("deviceGuardVirtualizationBasedSecurityHardwareRequirementState", $this->_propDict)) {
            if (is_a($this->_propDict["deviceGuardVirtualizationBasedSecurityHardwareRequirementState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceGuardVirtualizationBasedSecurityHardwareRequirementState") || is_null($this->_propDict["deviceGuardVirtualizationBasedSecurityHardwareRequirementState"])) {
    ...
    public function getDeviceGuardVirtualizationBasedSecurityState()
    {
        if (array_key_exists("deviceGuardVirtualizationBasedSecurityState", $this->_propDict)) {
            if (is_a($this->_propDict["deviceGuardVirtualizationBasedSecurityState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceGuardVirtualizationBasedSecurityState") || is_null($this->_propDict["deviceGuardVirtualizationBasedSecurityState"])) {
    ...
    public function getDeviceLicensingStatus()
    {
        if (array_key_exists("deviceLicensingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deviceLicensingStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceLicensingStatus") || is_null($this->_propDict["deviceLicensingStatus"])) {
    ...
    public function getSharedDeviceCachedUsers()
    {
        if (array_key_exists("sharedDeviceCachedUsers", $this->_propDict)) {
            if (is_a($this->_propDict["sharedDeviceCachedUsers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharedAppleDeviceUser") || is_null($this->_propDict["sharedDeviceCachedUsers"])) {
