...
class Device extends DirectoryObject
{
    ...
    public function getExtensionAttributes()
    {
        if (array_key_exists("extensionAttributes", $this->_propDict)) {
            if (is_a($this->_propDict["extensionAttributes"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OnPremisesExtensionAttributes") || is_null($this->_propDict["extensionAttributes"])) {
