...
class IdentityUserFlowAttributeAssignment extends Entity
{
    ...
    public function getUserInputType()
    {
        if (array_key_exists("userInputType", $this->_propDict)) {
            if (is_a($this->_propDict["userInputType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityUserFlowAttributeInputType") || is_null($this->_propDict["userInputType"])) {
    ...
    public function getUserAttribute()
    {
        if (array_key_exists("userAttribute", $this->_propDict)) {
            if (is_a($this->_propDict["userAttribute"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityUserFlowAttribute") || is_null($this->_propDict["userAttribute"])) {
