...
class DelegatedAdminAccessContainer extends Entity
{
    ...
    public function getAccessContainerType()
    {
        if (array_key_exists("accessContainerType", $this->_propDict)) {
            if (is_a($this->_propDict["accessContainerType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DelegatedAdminAccessContainerType") || is_null($this->_propDict["accessContainerType"])) {
