...
class CallEndedEventMessageDetail extends EventMessageDetail
{
    ...
    public function getCallEventType()
    {
        if (array_key_exists("callEventType", $this->_propDict)) {
            if (is_a($this->_propDict["callEventType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkCallEventType") || is_null($this->_propDict["callEventType"])) {
    ...
    public function getCallParticipants()
    {
        if (array_key_exists("callParticipants", $this->_propDict)) {
            if (is_a($this->_propDict["callParticipants"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CallParticipantInfo") || is_null($this->_propDict["callParticipants"])) {
