...
class ConditionalAccessTemplate extends Entity
{
    ...
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict)) {
            if (is_a($this->_propDict["details"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessPolicyDetail") || is_null($this->_propDict["details"])) {
    ...
    public function getScenarios()
    {
        if (array_key_exists("scenarios", $this->_propDict)) {
            if (is_a($this->_propDict["scenarios"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TemplateScenarios") || is_null($this->_propDict["scenarios"])) {
