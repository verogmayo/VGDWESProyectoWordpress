...
class WindowsHelloForBusinessAuthenticationMethod extends AuthenticationMethod
{
    ...
    public function getKeyStrength()
    {
        if (array_key_exists("keyStrength", $this->_propDict)) {
            if (is_a($this->_propDict["keyStrength"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationMethodKeyStrength") || is_null($this->_propDict["keyStrength"])) {
    ...
    public function getDevice()
    {
        if (array_key_exists("device", $this->_propDict)) {
            if (is_a($this->_propDict["device"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Device") || is_null($this->_propDict["device"])) {
