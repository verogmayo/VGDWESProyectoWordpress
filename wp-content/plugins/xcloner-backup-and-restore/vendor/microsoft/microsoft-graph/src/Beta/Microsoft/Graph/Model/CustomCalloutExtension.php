...
class CustomCalloutExtension extends Entity
{
    ...
    public function getAuthenticationConfiguration()
    {
        if (array_key_exists("authenticationConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CustomExtensionAuthenticationConfiguration") || is_null($this->_propDict["authenticationConfiguration"])) {
    ...
    public function getClientConfiguration()
    {
        if (array_key_exists("clientConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["clientConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CustomExtensionClientConfiguration") || is_null($this->_propDict["clientConfiguration"])) {
    ...
    public function getEndpointConfiguration()
    {
        if (array_key_exists("endpointConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["endpointConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CustomExtensionEndpointConfiguration") || is_null($this->_propDict["endpointConfiguration"])) {
