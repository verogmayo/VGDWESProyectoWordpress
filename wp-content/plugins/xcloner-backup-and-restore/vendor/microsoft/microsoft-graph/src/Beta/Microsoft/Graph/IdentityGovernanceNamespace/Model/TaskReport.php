...
* @link      https://graph.microsoft.com
*/
class TaskReport extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getTaskDefinition()
    {
        if (array_key_exists("taskDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["taskDefinition"], "XCloner\\Beta\\Microsoft\\Graph\\IdentityGovernanceNamespace\\Model\\TaskDefinition") || is_null($this->_propDict["taskDefinition"])) {
