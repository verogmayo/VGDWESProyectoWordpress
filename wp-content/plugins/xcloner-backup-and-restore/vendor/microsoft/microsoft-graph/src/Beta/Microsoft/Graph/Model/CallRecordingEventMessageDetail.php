...
class CallRecordingEventMessageDetail extends EventMessageDetail
{
    ...
    public function getCallRecordingStatus()
    {
        if (array_key_exists("callRecordingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["callRecordingStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CallRecordingStatus") || is_null($this->_propDict["callRecordingStatus"])) {
    ...
    public function getMeetingOrganizer()
    {
        if (array_key_exists("meetingOrganizer", $this->_propDict)) {
            if (is_a($this->_propDict["meetingOrganizer"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["meetingOrganizer"])) {
