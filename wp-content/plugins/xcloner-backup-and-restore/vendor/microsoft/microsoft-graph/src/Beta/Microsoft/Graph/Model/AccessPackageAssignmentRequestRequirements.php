...
class AccessPackageAssignmentRequestRequirements extends Entity
{
    ...
    public function getExistingAnswers()
    {
        if (array_key_exists("existingAnswers", $this->_propDict)) {
            if (is_a($this->_propDict["existingAnswers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageAnswer") || is_null($this->_propDict["existingAnswers"])) {
    ...
    public function getQuestions()
    {
        if (array_key_exists("questions", $this->_propDict)) {
            if (is_a($this->_propDict["questions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageQuestion") || is_null($this->_propDict["questions"])) {
