...
class CloudPcOnPremisesConnectionHealthCheck extends Entity
{
    ...
    public function getErrorType()
    {
        if (array_key_exists("errorType", $this->_propDict)) {
            if (is_a($this->_propDict["errorType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcOnPremisesConnectionHealthCheckErrorType") || is_null($this->_propDict["errorType"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcOnPremisesConnectionStatus") || is_null($this->_propDict["status"])) {
