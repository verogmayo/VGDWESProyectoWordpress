...
class RegistryKeyState extends Entity
{
    ...
    public function getHive()
    {
        if (array_key_exists("hive", $this->_propDict)) {
            if (is_a($this->_propDict["hive"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RegistryHive") || is_null($this->_propDict["hive"])) {
    ...
    public function getOperation()
    {
        if (array_key_exists("operation", $this->_propDict)) {
            if (is_a($this->_propDict["operation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RegistryOperation") || is_null($this->_propDict["operation"])) {
    ...
    public function getValueType()
    {
        if (array_key_exists("valueType", $this->_propDict)) {
            if (is_a($this->_propDict["valueType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RegistryValueType") || is_null($this->_propDict["valueType"])) {
