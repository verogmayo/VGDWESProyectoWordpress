...
class OrganizationalBrandingProperties extends Entity
{
    ...
    public function getBackgroundImage()
    {
        if (array_key_exists("backgroundImage", $this->_propDict)) {
            if (is_a($this->_propDict["backgroundImage"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["backgroundImage"])) {
                return $this->_propDict["backgroundImage"];
            } else {
                $this->_propDict["backgroundImage"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["backgroundImage"]);
                return $this->_propDict["backgroundImage"];
            }
        }
        return null;
    ...
    public function getBannerLogo()
    {
        if (array_key_exists("bannerLogo", $this->_propDict)) {
            if (is_a($this->_propDict["bannerLogo"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["bannerLogo"])) {
                return $this->_propDict["bannerLogo"];
            } else {
                $this->_propDict["bannerLogo"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["bannerLogo"]);
                return $this->_propDict["bannerLogo"];
            }
        }
        return null;
    ...
    public function getFavicon()
    {
        if (array_key_exists("favicon", $this->_propDict)) {
            if (is_a($this->_propDict["favicon"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["favicon"])) {
                return $this->_propDict["favicon"];
            } else {
                $this->_propDict["favicon"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["favicon"]);
                return $this->_propDict["favicon"];
            }
        }
        return null;
    ...
    public function getLoginPageTextVisibilitySettings()
    {
        if (array_key_exists("loginPageTextVisibilitySettings", $this->_propDict)) {
            if (is_a($this->_propDict["loginPageTextVisibilitySettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\LoginPageTextVisibilitySettings") || is_null($this->_propDict["loginPageTextVisibilitySettings"])) {
    ...
    public function getSquareLogo()
    {
        if (array_key_exists("squareLogo", $this->_propDict)) {
            if (is_a($this->_propDict["squareLogo"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["squareLogo"])) {
                return $this->_propDict["squareLogo"];
            } else {
                $this->_propDict["squareLogo"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["squareLogo"]);
                return $this->_propDict["squareLogo"];
            }
        }
        return null;
    ...
    public function getSquareLogoDark()
    {
        if (array_key_exists("squareLogoDark", $this->_propDict)) {
            if (is_a($this->_propDict["squareLogoDark"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["squareLogoDark"])) {
                return $this->_propDict["squareLogoDark"];
            } else {
                $this->_propDict["squareLogoDark"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["squareLogoDark"]);
                return $this->_propDict["squareLogoDark"];
            }
        }
        return null;
