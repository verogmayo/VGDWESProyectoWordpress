...
class AndroidManagedStoreAccountEnterpriseSettings extends Entity
{
    ...
    public function getBindStatus()
    {
        if (array_key_exists("bindStatus", $this->_propDict)) {
            if (is_a($this->_propDict["bindStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidManagedStoreAccountBindStatus") || is_null($this->_propDict["bindStatus"])) {
    ...
    public function getEnrollmentTarget()
    {
        if (array_key_exists("enrollmentTarget", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentTarget"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidManagedStoreAccountEnrollmentTarget") || is_null($this->_propDict["enrollmentTarget"])) {
    ...
    public function getLastAppSyncStatus()
    {
        if (array_key_exists("lastAppSyncStatus", $this->_propDict)) {
            if (is_a($this->_propDict["lastAppSyncStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidManagedStoreAccountAppSyncStatus") || is_null($this->_propDict["lastAppSyncStatus"])) {
