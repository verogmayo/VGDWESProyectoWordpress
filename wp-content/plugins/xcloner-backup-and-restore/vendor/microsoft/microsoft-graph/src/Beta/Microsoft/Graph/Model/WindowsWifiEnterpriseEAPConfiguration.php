...
class WindowsWifiEnterpriseEAPConfiguration extends WindowsWifiConfiguration
{
    ...
    public function getAuthenticationType()
    {
        if (array_key_exists("authenticationType", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WifiAuthenticationType") || is_null($this->_propDict["authenticationType"])) {
    ...
    public function getEapType()
    {
        if (array_key_exists("eapType", $this->_propDict)) {
            if (is_a($this->_propDict["eapType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EapType") || is_null($this->_propDict["eapType"])) {
    ...
    public function getNetworkSingleSignOn()
    {
        if (array_key_exists("networkSingleSignOn", $this->_propDict)) {
            if (is_a($this->_propDict["networkSingleSignOn"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\NetworkSingleSignOnType") || is_null($this->_propDict["networkSingleSignOn"])) {
    ...
    public function getIdentityCertificateForClientAuthentication()
    {
        if (array_key_exists("identityCertificateForClientAuthentication", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificateForClientAuthentication"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsCertificateProfileBase") || is_null($this->_propDict["identityCertificateForClientAuthentication"])) {
    ...
    public function getRootCertificateForClientValidation()
    {
        if (array_key_exists("rootCertificateForClientValidation", $this->_propDict)) {
            if (is_a($this->_propDict["rootCertificateForClientValidation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Windows81TrustedRootCertificate") || is_null($this->_propDict["rootCertificateForClientValidation"])) {
