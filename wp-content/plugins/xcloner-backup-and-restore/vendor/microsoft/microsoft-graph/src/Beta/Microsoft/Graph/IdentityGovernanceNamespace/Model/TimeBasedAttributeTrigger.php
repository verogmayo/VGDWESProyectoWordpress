...
class TimeBasedAttributeTrigger extends WorkflowExecutionTrigger
{
    ...
    public function getTimeBasedAttribute()
    {
        if (array_key_exists("timeBasedAttribute", $this->_propDict)) {
            if (is_a($this->_propDict["timeBasedAttribute"], "XCloner\\Beta\\Microsoft\\Graph\\IdentityGovernanceNamespace\\Model\\WorkflowTriggerTimeBasedAttribute") || is_null($this->_propDict["timeBasedAttribute"])) {
