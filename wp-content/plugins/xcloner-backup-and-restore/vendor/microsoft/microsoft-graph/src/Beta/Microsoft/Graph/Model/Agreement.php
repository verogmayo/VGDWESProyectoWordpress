...
class Agreement extends Entity
{
    ...
    public function getTermsExpiration()
    {
        if (array_key_exists("termsExpiration", $this->_propDict)) {
            if (is_a($this->_propDict["termsExpiration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TermsExpiration") || is_null($this->_propDict["termsExpiration"])) {
    ...
    public function getFile()
    {
        if (array_key_exists("file", $this->_propDict)) {
            if (is_a($this->_propDict["file"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AgreementFile") || is_null($this->_propDict["file"])) {
