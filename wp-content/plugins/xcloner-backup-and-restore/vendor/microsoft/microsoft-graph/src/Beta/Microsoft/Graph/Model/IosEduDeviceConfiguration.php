...
class IosEduDeviceConfiguration extends DeviceConfiguration
{
    ...
    public function getDeviceCertificateSettings()
    {
        if (array_key_exists("deviceCertificateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["deviceCertificateSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosEduCertificateSettings") || is_null($this->_propDict["deviceCertificateSettings"])) {
    ...
    public function getStudentCertificateSettings()
    {
        if (array_key_exists("studentCertificateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["studentCertificateSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosEduCertificateSettings") || is_null($this->_propDict["studentCertificateSettings"])) {
    ...
    public function getTeacherCertificateSettings()
    {
        if (array_key_exists("teacherCertificateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["teacherCertificateSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosEduCertificateSettings") || is_null($this->_propDict["teacherCertificateSettings"])) {
