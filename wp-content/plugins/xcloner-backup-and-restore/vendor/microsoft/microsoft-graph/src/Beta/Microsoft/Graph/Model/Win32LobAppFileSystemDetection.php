...
class Win32LobAppFileSystemDetection extends Win32LobAppDetection
{
    ...
    public function getDetectionType()
    {
        if (array_key_exists("detectionType", $this->_propDict)) {
            if (is_a($this->_propDict["detectionType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppFileSystemDetectionType") || is_null($this->_propDict["detectionType"])) {
    ...
    public function getOperator()
    {
        if (array_key_exists("operator", $this->_propDict)) {
            if (is_a($this->_propDict["operator"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppDetectionOperator") || is_null($this->_propDict["operator"])) {
