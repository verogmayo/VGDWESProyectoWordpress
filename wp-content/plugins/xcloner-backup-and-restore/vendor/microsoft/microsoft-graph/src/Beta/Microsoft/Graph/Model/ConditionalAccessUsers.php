...
class ConditionalAccessUsers extends Entity
{
    ...
    public function getExcludeGuestsOrExternalUsers()
    {
        if (array_key_exists("excludeGuestsOrExternalUsers", $this->_propDict)) {
            if (is_a($this->_propDict["excludeGuestsOrExternalUsers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessGuestsOrExternalUsers") || is_null($this->_propDict["excludeGuestsOrExternalUsers"])) {
    ...
    public function getIncludeGuestsOrExternalUsers()
    {
        if (array_key_exists("includeGuestsOrExternalUsers", $this->_propDict)) {
            if (is_a($this->_propDict["includeGuestsOrExternalUsers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessGuestsOrExternalUsers") || is_null($this->_propDict["includeGuestsOrExternalUsers"])) {
