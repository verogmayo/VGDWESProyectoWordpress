...
class AssignmentReviewSettings extends Entity
{
    ...
    public function getAccessReviewTimeoutBehavior()
    {
        if (array_key_exists("accessReviewTimeoutBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["accessReviewTimeoutBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewTimeoutBehavior") || is_null($this->_propDict["accessReviewTimeoutBehavior"])) {
    ...
    public function getReviewers()
    {
        if (array_key_exists("reviewers", $this->_propDict)) {
            if (is_a($this->_propDict["reviewers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserSet") || is_null($this->_propDict["reviewers"])) {
