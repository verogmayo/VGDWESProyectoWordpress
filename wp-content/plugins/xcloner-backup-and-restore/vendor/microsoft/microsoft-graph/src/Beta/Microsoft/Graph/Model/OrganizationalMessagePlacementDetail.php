...
class OrganizationalMessagePlacementDetail extends Entity
{
    ...
    public function getPlacement()
    {
        if (array_key_exists("placement", $this->_propDict)) {
            if (is_a($this->_propDict["placement"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OrganizationalMessagePlacement") || is_null($this->_propDict["placement"])) {
    ...
    public function getVariants()
    {
        if (array_key_exists("variants", $this->_propDict)) {
            if (is_a($this->_propDict["variants"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OrganizationalMessageVariant") || is_null($this->_propDict["variants"])) {
