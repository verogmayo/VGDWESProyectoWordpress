...
class CryptographySuite extends Entity
{
    ...
    public function getAuthenticationTransformConstants()
    {
        if (array_key_exists("authenticationTransformConstants", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationTransformConstants"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationTransformConstant") || is_null($this->_propDict["authenticationTransformConstants"])) {
    ...
    public function getCipherTransformConstants()
    {
        if (array_key_exists("cipherTransformConstants", $this->_propDict)) {
            if (is_a($this->_propDict["cipherTransformConstants"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnEncryptionAlgorithmType") || is_null($this->_propDict["cipherTransformConstants"])) {
    ...
    public function getDhGroup()
    {
        if (array_key_exists("dhGroup", $this->_propDict)) {
            if (is_a($this->_propDict["dhGroup"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DiffieHellmanGroup") || is_null($this->_propDict["dhGroup"])) {
    ...
    public function getEncryptionMethod()
    {
        if (array_key_exists("encryptionMethod", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionMethod"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnEncryptionAlgorithmType") || is_null($this->_propDict["encryptionMethod"])) {
    ...
    public function getIntegrityCheckMethod()
    {
        if (array_key_exists("integrityCheckMethod", $this->_propDict)) {
            if (is_a($this->_propDict["integrityCheckMethod"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnIntegrityAlgorithmType") || is_null($this->_propDict["integrityCheckMethod"])) {
    ...
    public function getPfsGroup()
    {
        if (array_key_exists("pfsGroup", $this->_propDict)) {
            if (is_a($this->_propDict["pfsGroup"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PerfectForwardSecrecyGroup") || is_null($this->_propDict["pfsGroup"])) {
