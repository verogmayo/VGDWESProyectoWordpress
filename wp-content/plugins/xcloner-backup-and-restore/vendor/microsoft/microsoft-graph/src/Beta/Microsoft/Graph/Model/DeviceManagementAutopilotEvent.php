...
class DeviceManagementAutopilotEvent extends Entity
{
    ...
    public function getAccountSetupStatus()
    {
        if (array_key_exists("accountSetupStatus", $this->_propDict)) {
            if (is_a($this->_propDict["accountSetupStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeploymentState") || is_null($this->_propDict["accountSetupStatus"])) {
    ...
    public function getDeploymentState()
    {
        if (array_key_exists("deploymentState", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeploymentState") || is_null($this->_propDict["deploymentState"])) {
    ...
    public function getDeviceSetupStatus()
    {
        if (array_key_exists("deviceSetupStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deviceSetupStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeploymentState") || is_null($this->_propDict["deviceSetupStatus"])) {
    ...
    public function getEnrollmentType()
    {
        if (array_key_exists("enrollmentType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotEnrollmentType") || is_null($this->_propDict["enrollmentType"])) {
