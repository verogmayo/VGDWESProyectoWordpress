...
class ServicePrincipal extends DirectoryObject
{
    ...
    public function getPasswordSingleSignOnSettings()
    {
        if (array_key_exists("passwordSingleSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["passwordSingleSignOnSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PasswordSingleSignOnSettings") || is_null($this->_propDict["passwordSingleSignOnSettings"])) {
    ...
    public function getSamlSingleSignOnSettings()
    {
        if (array_key_exists("samlSingleSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["samlSingleSignOnSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SamlSingleSignOnSettings") || is_null($this->_propDict["samlSingleSignOnSettings"])) {
