...
* @link      https://graph.microsoft.com
*/
class Session extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the callee
    ...
    public function getCallee()
    {
        if (array_key_exists("callee", $this->_propDict)) {
            if (is_a($this->_propDict["callee"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\Endpoint") || is_null($this->_propDict["callee"])) {
    ...
    public function getCaller()
    {
        if (array_key_exists("caller", $this->_propDict)) {
            if (is_a($this->_propDict["caller"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\Endpoint") || is_null($this->_propDict["caller"])) {
    ...
    public function getFailureInfo()
    {
        if (array_key_exists("failureInfo", $this->_propDict)) {
            if (is_a($this->_propDict["failureInfo"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\FailureInfo") || is_null($this->_propDict["failureInfo"])) {
