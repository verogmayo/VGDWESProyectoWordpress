...
class GroupPolicyCategory extends Entity
{
    ...
    public function getIngestionSource()
    {
        if (array_key_exists("ingestionSource", $this->_propDict)) {
            if (is_a($this->_propDict["ingestionSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IngestionSource") || is_null($this->_propDict["ingestionSource"])) {
    ...
    public function getDefinitionFile()
    {
        if (array_key_exists("definitionFile", $this->_propDict)) {
            if (is_a($this->_propDict["definitionFile"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\GroupPolicyDefinitionFile") || is_null($this->_propDict["definitionFile"])) {
    ...
    public function getParent()
    {
        if (array_key_exists("parent", $this->_propDict)) {
            if (is_a($this->_propDict["parent"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\GroupPolicyCategory") || is_null($this->_propDict["parent"])) {
