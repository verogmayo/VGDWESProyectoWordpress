...
class WindowsAutopilotDeploymentProfile extends Entity
{
    ...
    public function getDeviceType()
    {
        if (array_key_exists("deviceType", $this->_propDict)) {
            if (is_a($this->_propDict["deviceType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeviceType") || is_null($this->_propDict["deviceType"])) {
    ...
    public function getEnrollmentStatusScreenSettings()
    {
        if (array_key_exists("enrollmentStatusScreenSettings", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentStatusScreenSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsEnrollmentStatusScreenSettings") || is_null($this->_propDict["enrollmentStatusScreenSettings"])) {
    ...
    public function getOutOfBoxExperienceSettings()
    {
        if (array_key_exists("outOfBoxExperienceSettings", $this->_propDict)) {
            if (is_a($this->_propDict["outOfBoxExperienceSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OutOfBoxExperienceSettings") || is_null($this->_propDict["outOfBoxExperienceSettings"])) {
