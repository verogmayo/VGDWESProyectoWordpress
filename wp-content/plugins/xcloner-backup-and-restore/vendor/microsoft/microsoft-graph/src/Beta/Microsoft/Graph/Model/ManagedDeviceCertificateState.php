...
class ManagedDeviceCertificateState extends Entity
{
    ...
    public function getCertificateIssuanceState()
    {
        if (array_key_exists("certificateIssuanceState", $this->_propDict)) {
            if (is_a($this->_propDict["certificateIssuanceState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CertificateIssuanceStates") || is_null($this->_propDict["certificateIssuanceState"])) {
    ...
    public function getCertificateKeyStorageProvider()
    {
        if (array_key_exists("certificateKeyStorageProvider", $this->_propDict)) {
            if (is_a($this->_propDict["certificateKeyStorageProvider"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\KeyStorageProviderOption") || is_null($this->_propDict["certificateKeyStorageProvider"])) {
    ...
    public function getCertificateKeyUsage()
    {
        if (array_key_exists("certificateKeyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["certificateKeyUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\KeyUsages") || is_null($this->_propDict["certificateKeyUsage"])) {
    ...
    public function getCertificateRevokeStatus()
    {
        if (array_key_exists("certificateRevokeStatus", $this->_propDict)) {
            if (is_a($this->_propDict["certificateRevokeStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CertificateRevocationStatus") || is_null($this->_propDict["certificateRevokeStatus"])) {
    ...
    public function getCertificateSubjectAlternativeNameFormat()
    {
        if (array_key_exists("certificateSubjectAlternativeNameFormat", $this->_propDict)) {
            if (is_a($this->_propDict["certificateSubjectAlternativeNameFormat"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SubjectAlternativeNameType") || is_null($this->_propDict["certificateSubjectAlternativeNameFormat"])) {
    ...
    public function getCertificateSubjectNameFormat()
    {
        if (array_key_exists("certificateSubjectNameFormat", $this->_propDict)) {
            if (is_a($this->_propDict["certificateSubjectNameFormat"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SubjectNameFormat") || is_null($this->_propDict["certificateSubjectNameFormat"])) {
    ...
    public function getCertificateValidityPeriodUnits()
    {
        if (array_key_exists("certificateValidityPeriodUnits", $this->_propDict)) {
            if (is_a($this->_propDict["certificateValidityPeriodUnits"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CertificateValidityPeriodScale") || is_null($this->_propDict["certificateValidityPeriodUnits"])) {
    ...
    public function getDevicePlatform()
    {
        if (array_key_exists("devicePlatform", $this->_propDict)) {
            if (is_a($this->_propDict["devicePlatform"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DevicePlatformType") || is_null($this->_propDict["devicePlatform"])) {
