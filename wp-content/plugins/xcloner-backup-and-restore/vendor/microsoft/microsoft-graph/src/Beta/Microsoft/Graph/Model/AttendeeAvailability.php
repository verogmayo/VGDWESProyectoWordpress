...
class AttendeeAvailability extends Entity
{
    ...
    public function getAttendee()
    {
        if (array_key_exists("attendee", $this->_propDict)) {
            if (is_a($this->_propDict["attendee"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AttendeeBase") || is_null($this->_propDict["attendee"])) {
    ...
    public function getAvailability()
    {
        if (array_key_exists("availability", $this->_propDict)) {
            if (is_a($this->_propDict["availability"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\FreeBusyStatus") || is_null($this->_propDict["availability"])) {
