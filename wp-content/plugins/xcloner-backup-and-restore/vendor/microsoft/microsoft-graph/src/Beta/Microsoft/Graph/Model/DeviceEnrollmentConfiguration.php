...
class DeviceEnrollmentConfiguration extends Entity
{
    ...
    public function getDeviceEnrollmentConfigurationType()
    {
        if (array_key_exists("deviceEnrollmentConfigurationType", $this->_propDict)) {
            if (is_a($this->_propDict["deviceEnrollmentConfigurationType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentConfigurationType") || is_null($this->_propDict["deviceEnrollmentConfigurationType"])) {
