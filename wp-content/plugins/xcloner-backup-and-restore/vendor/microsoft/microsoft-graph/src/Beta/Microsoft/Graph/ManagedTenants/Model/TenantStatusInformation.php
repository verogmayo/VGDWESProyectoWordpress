...
* @link      https://graph.microsoft.com
*/
class TenantStatusInformation extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getDelegatedPrivilegeStatus()
    {
        if (array_key_exists("delegatedPrivilegeStatus", $this->_propDict)) {
            if (is_a($this->_propDict["delegatedPrivilegeStatus"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\DelegatedPrivilegeStatus") || is_null($this->_propDict["delegatedPrivilegeStatus"])) {
    ...
    public function getOnboardingStatus()
    {
        if (array_key_exists("onboardingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["onboardingStatus"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\TenantOnboardingStatus") || is_null($this->_propDict["onboardingStatus"])) {
    ...
    public function getTenantOnboardingEligibilityReason()
    {
        if (array_key_exists("tenantOnboardingEligibilityReason", $this->_propDict)) {
            if (is_a($this->_propDict["tenantOnboardingEligibilityReason"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\TenantOnboardingEligibilityReason") || is_null($this->_propDict["tenantOnboardingEligibilityReason"])) {
    ...
    public function getWorkloadStatuses()
    {
        if (array_key_exists("workloadStatuses", $this->_propDict)) {
            if (is_a($this->_propDict["workloadStatuses"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\WorkloadStatus") || is_null($this->_propDict["workloadStatuses"])) {
