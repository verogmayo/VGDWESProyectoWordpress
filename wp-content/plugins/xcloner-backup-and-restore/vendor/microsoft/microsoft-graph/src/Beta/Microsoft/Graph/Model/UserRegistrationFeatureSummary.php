...
class UserRegistrationFeatureSummary extends Entity
{
    ...
    public function getUserRegistrationFeatureCounts()
    {
        if (array_key_exists("userRegistrationFeatureCounts", $this->_propDict)) {
            if (is_a($this->_propDict["userRegistrationFeatureCounts"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserRegistrationFeatureCount") || is_null($this->_propDict["userRegistrationFeatureCounts"])) {
    ...
    public function getUserRoles()
    {
        if (array_key_exists("userRoles", $this->_propDict)) {
            if (is_a($this->_propDict["userRoles"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IncludedUserRoles") || is_null($this->_propDict["userRoles"])) {
    ...
    public function getUserTypes()
    {
        if (array_key_exists("userTypes", $this->_propDict)) {
            if (is_a($this->_propDict["userTypes"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IncludedUserTypes") || is_null($this->_propDict["userTypes"])) {
