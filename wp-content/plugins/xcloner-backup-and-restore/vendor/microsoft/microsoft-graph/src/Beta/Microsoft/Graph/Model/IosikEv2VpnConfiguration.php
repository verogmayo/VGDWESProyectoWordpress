...
class IosikEv2VpnConfiguration extends IosVpnConfiguration
{
    ...
    public function getAlwaysOnConfiguration()
    {
        if (array_key_exists("alwaysOnConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["alwaysOnConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AppleVpnAlwaysOnConfiguration") || is_null($this->_propDict["alwaysOnConfiguration"])) {
    ...
    public function getChildSecurityAssociationParameters()
    {
        if (array_key_exists("childSecurityAssociationParameters", $this->_propDict)) {
            if (is_a($this->_propDict["childSecurityAssociationParameters"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosVpnSecurityAssociationParameters") || is_null($this->_propDict["childSecurityAssociationParameters"])) {
    ...
    public function getClientAuthenticationType()
    {
        if (array_key_exists("clientAuthenticationType", $this->_propDict)) {
            if (is_a($this->_propDict["clientAuthenticationType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnClientAuthenticationType") || is_null($this->_propDict["clientAuthenticationType"])) {
    ...
    public function getDeadPeerDetectionRate()
    {
        if (array_key_exists("deadPeerDetectionRate", $this->_propDict)) {
            if (is_a($this->_propDict["deadPeerDetectionRate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnDeadPeerDetectionRate") || is_null($this->_propDict["deadPeerDetectionRate"])) {
    ...
    public function getLocalIdentifier()
    {
        if (array_key_exists("localIdentifier", $this->_propDict)) {
            if (is_a($this->_propDict["localIdentifier"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnLocalIdentifier") || is_null($this->_propDict["localIdentifier"])) {
    ...
    public function getSecurityAssociationParameters()
    {
        if (array_key_exists("securityAssociationParameters", $this->_propDict)) {
            if (is_a($this->_propDict["securityAssociationParameters"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosVpnSecurityAssociationParameters") || is_null($this->_propDict["securityAssociationParameters"])) {
    ...
    public function getServerCertificateType()
    {
        if (array_key_exists("serverCertificateType", $this->_propDict)) {
            if (is_a($this->_propDict["serverCertificateType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnServerCertificateType") || is_null($this->_propDict["serverCertificateType"])) {
