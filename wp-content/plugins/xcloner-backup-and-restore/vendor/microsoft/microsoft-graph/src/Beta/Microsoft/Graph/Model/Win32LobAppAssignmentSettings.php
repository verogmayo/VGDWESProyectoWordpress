...
class Win32LobAppAssignmentSettings extends MobileAppAssignmentSettings
{
    ...
    public function getDeliveryOptimizationPriority()
    {
        if (array_key_exists("deliveryOptimizationPriority", $this->_propDict)) {
            if (is_a($this->_propDict["deliveryOptimizationPriority"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppDeliveryOptimizationPriority") || is_null($this->_propDict["deliveryOptimizationPriority"])) {
    ...
    public function getInstallTimeSettings()
    {
        if (array_key_exists("installTimeSettings", $this->_propDict)) {
            if (is_a($this->_propDict["installTimeSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MobileAppInstallTimeSettings") || is_null($this->_propDict["installTimeSettings"])) {
    ...
    public function getNotifications()
    {
        if (array_key_exists("notifications", $this->_propDict)) {
            if (is_a($this->_propDict["notifications"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppNotification") || is_null($this->_propDict["notifications"])) {
    ...
    public function getRestartSettings()
    {
        if (array_key_exists("restartSettings", $this->_propDict)) {
            if (is_a($this->_propDict["restartSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppRestartSettings") || is_null($this->_propDict["restartSettings"])) {
