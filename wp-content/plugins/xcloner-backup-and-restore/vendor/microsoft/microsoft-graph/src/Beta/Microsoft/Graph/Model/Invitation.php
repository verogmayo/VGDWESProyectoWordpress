...
class Invitation extends Entity
{
    ...
    public function getInvitedUserMessageInfo()
    {
        if (array_key_exists("invitedUserMessageInfo", $this->_propDict)) {
            if (is_a($this->_propDict["invitedUserMessageInfo"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InvitedUserMessageInfo") || is_null($this->_propDict["invitedUserMessageInfo"])) {
    ...
    public function getInvitedUser()
    {
        if (array_key_exists("invitedUser", $this->_propDict)) {
            if (is_a($this->_propDict["invitedUser"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\User") || is_null($this->_propDict["invitedUser"])) {
