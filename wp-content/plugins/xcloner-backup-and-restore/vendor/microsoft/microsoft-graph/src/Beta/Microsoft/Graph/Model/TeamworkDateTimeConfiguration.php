...
class TeamworkDateTimeConfiguration extends Entity
{
    ...
    public function getOfficeHoursEndTime()
    {
        if (array_key_exists("officeHoursEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["officeHoursEndTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["officeHoursEndTime"])) {
    ...
    public function getOfficeHoursStartTime()
    {
        if (array_key_exists("officeHoursStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["officeHoursStartTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["officeHoursStartTime"])) {
