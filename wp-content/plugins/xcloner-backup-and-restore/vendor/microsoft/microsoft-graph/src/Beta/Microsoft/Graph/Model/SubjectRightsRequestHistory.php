...
class SubjectRightsRequestHistory extends Entity
{
    ...
    public function getChangedBy()
    {
        if (array_key_exists("changedBy", $this->_propDict)) {
            if (is_a($this->_propDict["changedBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["changedBy"])) {
    ...
    public function getStage()
    {
        if (array_key_exists("stage", $this->_propDict)) {
            if (is_a($this->_propDict["stage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SubjectRightsRequestStage") || is_null($this->_propDict["stage"])) {
    ...
    public function getStageStatus()
    {
        if (array_key_exists("stageStatus", $this->_propDict)) {
            if (is_a($this->_propDict["stageStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SubjectRightsRequestStageStatus") || is_null($this->_propDict["stageStatus"])) {
