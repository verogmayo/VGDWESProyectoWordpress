...
class CopyNotebookModel extends Entity
{
    ...
    public function getCreatedByIdentity()
    {
        if (array_key_exists("createdByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["createdByIdentity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["createdByIdentity"])) {
    ...
    public function getLastModifiedByIdentity()
    {
        if (array_key_exists("lastModifiedByIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["lastModifiedByIdentity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["lastModifiedByIdentity"])) {
    ...
    public function getLinks()
    {
        if (array_key_exists("links", $this->_propDict)) {
            if (is_a($this->_propDict["links"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\NotebookLinks") || is_null($this->_propDict["links"])) {
    ...
    public function getUserRole()
    {
        if (array_key_exists("userRole", $this->_propDict)) {
            if (is_a($this->_propDict["userRole"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OnenoteUserRole") || is_null($this->_propDict["userRole"])) {
