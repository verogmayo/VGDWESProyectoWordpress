...
class AuthenticationMethodsPolicy extends Entity
{
    ...
    public function getRegistrationEnforcement()
    {
        if (array_key_exists("registrationEnforcement", $this->_propDict)) {
            if (is_a($this->_propDict["registrationEnforcement"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RegistrationEnforcement") || is_null($this->_propDict["registrationEnforcement"])) {
