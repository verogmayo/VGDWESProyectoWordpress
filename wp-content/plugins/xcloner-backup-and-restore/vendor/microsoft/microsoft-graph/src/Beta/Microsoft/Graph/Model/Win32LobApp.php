...
class Win32LobApp extends MobileLobApp
{
    ...
    public function getInstallExperience()
    {
        if (array_key_exists("installExperience", $this->_propDict)) {
            if (is_a($this->_propDict["installExperience"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppInstallExperience") || is_null($this->_propDict["installExperience"])) {
    ...
    public function getMsiInformation()
    {
        if (array_key_exists("msiInformation", $this->_propDict)) {
            if (is_a($this->_propDict["msiInformation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppMsiInformation") || is_null($this->_propDict["msiInformation"])) {
