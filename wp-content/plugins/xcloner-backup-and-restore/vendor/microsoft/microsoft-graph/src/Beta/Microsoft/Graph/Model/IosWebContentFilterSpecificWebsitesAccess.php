...
class IosWebContentFilterSpecificWebsitesAccess extends IosWebContentFilterBase
{
    ...
    public function getSpecificWebsitesOnly()
    {
        if (array_key_exists("specificWebsitesOnly", $this->_propDict)) {
            if (is_a($this->_propDict["specificWebsitesOnly"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosBookmark") || is_null($this->_propDict["specificWebsitesOnly"])) {
    ...
    public function getWebsiteList()
    {
        if (array_key_exists("websiteList", $this->_propDict)) {
            if (is_a($this->_propDict["websiteList"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosBookmark") || is_null($this->_propDict["websiteList"])) {
