...
class TeamTemplateDefinition extends Entity
{
    ...
    public function getAudience()
    {
        if (array_key_exists("audience", $this->_propDict)) {
            if (is_a($this->_propDict["audience"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamTemplateAudience") || is_null($this->_propDict["audience"])) {
    ...
    public function getTeamDefinition()
    {
        if (array_key_exists("teamDefinition", $this->_propDict)) {
            if (is_a($this->_propDict["teamDefinition"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Team") || is_null($this->_propDict["teamDefinition"])) {
