...
* @link      https://graph.microsoft.com
*/
class Incident extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the assignedTo
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\IncidentStatus") || is_null($this->_propDict["status"])) {
