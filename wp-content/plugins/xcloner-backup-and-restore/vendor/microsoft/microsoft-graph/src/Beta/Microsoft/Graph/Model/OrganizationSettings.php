...
class OrganizationSettings extends Entity
{
    ...
    public function getMicrosoftApplicationDataAccess()
    {
        if (array_key_exists("microsoftApplicationDataAccess", $this->_propDict)) {
            if (is_a($this->_propDict["microsoftApplicationDataAccess"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MicrosoftApplicationDataAccessSettings") || is_null($this->_propDict["microsoftApplicationDataAccess"])) {
    ...
    public function getContactInsights()
    {
        if (array_key_exists("contactInsights", $this->_propDict)) {
            if (is_a($this->_propDict["contactInsights"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InsightsSettings") || is_null($this->_propDict["contactInsights"])) {
    ...
    public function getItemInsights()
    {
        if (array_key_exists("itemInsights", $this->_propDict)) {
            if (is_a($this->_propDict["itemInsights"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InsightsSettings") || is_null($this->_propDict["itemInsights"])) {
    ...
    public function getPeopleInsights()
    {
        if (array_key_exists("peopleInsights", $this->_propDict)) {
            if (is_a($this->_propDict["peopleInsights"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InsightsSettings") || is_null($this->_propDict["peopleInsights"])) {
