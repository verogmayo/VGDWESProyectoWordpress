...
class AospDeviceOwnerCertificateProfileBase extends DeviceConfiguration
{
    ...
    public function getSubjectNameFormat()
    {
        if (array_key_exists("subjectNameFormat", $this->_propDict)) {
            if (is_a($this->_propDict["subjectNameFormat"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SubjectNameFormat") || is_null($this->_propDict["subjectNameFormat"])) {
     ...
     *
     * @return AospDeviceOwnerTrustedRootCertificate|null The rootCertificate
     */
    public function getRootCertificate()
    {
        if (array_key_exists("rootCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["rootCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AospDeviceOwnerTrustedRootCertificate") || is_null($this->_propDict["rootCertificate"])) {
     ...
     * Trusted Root Certificate.
     *
     * @param AospDeviceOwnerTrustedRootCertificate $val The rootCertificate
     *
     * @return AospDeviceOwnerCertificateProfileBase
     */
