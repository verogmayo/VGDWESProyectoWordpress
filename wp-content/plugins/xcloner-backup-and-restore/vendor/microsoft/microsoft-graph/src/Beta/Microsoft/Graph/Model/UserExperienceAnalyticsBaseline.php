...
class UserExperienceAnalyticsBaseline extends Entity
{
    ...
    public function getAppHealthMetrics()
    {
        if (array_key_exists("appHealthMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["appHealthMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["appHealthMetrics"])) {
    ...
    public function getBatteryHealthMetrics()
    {
        if (array_key_exists("batteryHealthMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["batteryHealthMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["batteryHealthMetrics"])) {
    ...
    public function getBestPracticesMetrics()
    {
        if (array_key_exists("bestPracticesMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["bestPracticesMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["bestPracticesMetrics"])) {
    ...
    public function getDeviceBootPerformanceMetrics()
    {
        if (array_key_exists("deviceBootPerformanceMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["deviceBootPerformanceMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["deviceBootPerformanceMetrics"])) {
    ...
    public function getRebootAnalyticsMetrics()
    {
        if (array_key_exists("rebootAnalyticsMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["rebootAnalyticsMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["rebootAnalyticsMetrics"])) {
    ...
    public function getResourcePerformanceMetrics()
    {
        if (array_key_exists("resourcePerformanceMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["resourcePerformanceMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["resourcePerformanceMetrics"])) {
    ...
    public function getWorkFromAnywhereMetrics()
    {
        if (array_key_exists("workFromAnywhereMetrics", $this->_propDict)) {
            if (is_a($this->_propDict["workFromAnywhereMetrics"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserExperienceAnalyticsCategory") || is_null($this->_propDict["workFromAnywhereMetrics"])) {
