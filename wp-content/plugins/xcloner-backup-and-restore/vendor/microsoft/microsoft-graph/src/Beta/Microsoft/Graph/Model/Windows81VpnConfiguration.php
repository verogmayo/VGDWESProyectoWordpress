...
class Windows81VpnConfiguration extends WindowsVpnConfiguration
{
    ...
    public function getConnectionType()
    {
        if (array_key_exists("connectionType", $this->_propDict)) {
            if (is_a($this->_propDict["connectionType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsVpnConnectionType") || is_null($this->_propDict["connectionType"])) {
    ...
    public function getProxyServer()
    {
        if (array_key_exists("proxyServer", $this->_propDict)) {
            if (is_a($this->_propDict["proxyServer"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Windows81VpnProxyServer") || is_null($this->_propDict["proxyServer"])) {
