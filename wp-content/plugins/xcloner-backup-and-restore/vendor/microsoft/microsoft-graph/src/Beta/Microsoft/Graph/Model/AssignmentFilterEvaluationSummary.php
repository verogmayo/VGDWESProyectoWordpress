...
class AssignmentFilterEvaluationSummary extends Entity
{
    ...
    public function getAssignmentFilterPlatform()
    {
        if (array_key_exists("assignmentFilterPlatform", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentFilterPlatform"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DevicePlatformType") || is_null($this->_propDict["assignmentFilterPlatform"])) {
    ...
    public function getAssignmentFilterTypeAndEvaluationResults()
    {
        if (array_key_exists("assignmentFilterTypeAndEvaluationResults", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentFilterTypeAndEvaluationResults"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AssignmentFilterTypeAndEvaluationResult") || is_null($this->_propDict["assignmentFilterTypeAndEvaluationResults"])) {
