...
* @link      https://graph.microsoft.com
*/
class CaseSettings extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the ocr
    ...
    public function getOcr()
    {
        if (array_key_exists("ocr", $this->_propDict)) {
            if (is_a($this->_propDict["ocr"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\OcrSettings") || is_null($this->_propDict["ocr"])) {
    ...
    public function getRedundancyDetection()
    {
        if (array_key_exists("redundancyDetection", $this->_propDict)) {
            if (is_a($this->_propDict["redundancyDetection"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\RedundancyDetectionSettings") || is_null($this->_propDict["redundancyDetection"])) {
    ...
    public function getTopicModeling()
    {
        if (array_key_exists("topicModeling", $this->_propDict)) {
            if (is_a($this->_propDict["topicModeling"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\TopicModelingSettings") || is_null($this->_propDict["topicModeling"])) {
