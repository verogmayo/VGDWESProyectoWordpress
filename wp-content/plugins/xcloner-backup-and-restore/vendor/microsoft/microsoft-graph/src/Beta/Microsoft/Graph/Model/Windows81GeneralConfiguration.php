...
class Windows81GeneralConfiguration extends DeviceConfiguration
{
    ...
    public function getBrowserInternetSecurityLevel()
    {
        if (array_key_exists("browserInternetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserInternetSecurityLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InternetSiteSecurityLevel") || is_null($this->_propDict["browserInternetSecurityLevel"])) {
    ...
    public function getBrowserIntranetSecurityLevel()
    {
        if (array_key_exists("browserIntranetSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserIntranetSecurityLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SiteSecurityLevel") || is_null($this->_propDict["browserIntranetSecurityLevel"])) {
    ...
    public function getBrowserTrustedSitesSecurityLevel()
    {
        if (array_key_exists("browserTrustedSitesSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["browserTrustedSitesSecurityLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SiteSecurityLevel") || is_null($this->_propDict["browserTrustedSitesSecurityLevel"])) {
    ...
    public function getMinimumAutoInstallClassification()
    {
        if (array_key_exists("minimumAutoInstallClassification", $this->_propDict)) {
            if (is_a($this->_propDict["minimumAutoInstallClassification"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UpdateClassification") || is_null($this->_propDict["minimumAutoInstallClassification"])) {
    ...
    public function getUpdatesMinimumAutoInstallClassification()
    {
        if (array_key_exists("updatesMinimumAutoInstallClassification", $this->_propDict)) {
            if (is_a($this->_propDict["updatesMinimumAutoInstallClassification"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UpdateClassification") || is_null($this->_propDict["updatesMinimumAutoInstallClassification"])) {
    ...
    public function getUserAccountControlSettings()
    {
        if (array_key_exists("userAccountControlSettings", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountControlSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsUserAccountControlSettings") || is_null($this->_propDict["userAccountControlSettings"])) {
