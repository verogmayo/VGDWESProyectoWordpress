...
class WindowsWifiConfiguration extends DeviceConfiguration
{
    ...
    public function getMeteredConnectionLimit()
    {
        if (array_key_exists("meteredConnectionLimit", $this->_propDict)) {
            if (is_a($this->_propDict["meteredConnectionLimit"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MeteredConnectionLimitType") || is_null($this->_propDict["meteredConnectionLimit"])) {
    ...
    public function getProxySetting()
    {
        if (array_key_exists("proxySetting", $this->_propDict)) {
            if (is_a($this->_propDict["proxySetting"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WiFiProxySetting") || is_null($this->_propDict["proxySetting"])) {
    ...
    public function getWifiSecurityType()
    {
        if (array_key_exists("wifiSecurityType", $this->_propDict)) {
            if (is_a($this->_propDict["wifiSecurityType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WiFiSecurityType") || is_null($this->_propDict["wifiSecurityType"])) {
