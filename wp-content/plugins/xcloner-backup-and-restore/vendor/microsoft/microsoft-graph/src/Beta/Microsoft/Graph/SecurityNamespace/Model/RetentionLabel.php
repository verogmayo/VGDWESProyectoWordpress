...
* @link      https://graph.microsoft.com
*/
class RetentionLabel extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getActionAfterRetentionPeriod()
    {
        if (array_key_exists("actionAfterRetentionPeriod", $this->_propDict)) {
            if (is_a($this->_propDict["actionAfterRetentionPeriod"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\ActionAfterRetentionPeriod") || is_null($this->_propDict["actionAfterRetentionPeriod"])) {
    ...
    public function getBehaviorDuringRetentionPeriod()
    {
        if (array_key_exists("behaviorDuringRetentionPeriod", $this->_propDict)) {
            if (is_a($this->_propDict["behaviorDuringRetentionPeriod"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\BehaviorDuringRetentionPeriod") || is_null($this->_propDict["behaviorDuringRetentionPeriod"])) {
    ...
    public function getDefaultRecordBehavior()
    {
        if (array_key_exists("defaultRecordBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["defaultRecordBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\DefaultRecordBehavior") || is_null($this->_propDict["defaultRecordBehavior"])) {
    ...
    public function getRetentionDuration()
    {
        if (array_key_exists("retentionDuration", $this->_propDict)) {
            if (is_a($this->_propDict["retentionDuration"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\RetentionDuration") || is_null($this->_propDict["retentionDuration"])) {
    ...
    public function getRetentionTrigger()
    {
        if (array_key_exists("retentionTrigger", $this->_propDict)) {
            if (is_a($this->_propDict["retentionTrigger"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\RetentionTrigger") || is_null($this->_propDict["retentionTrigger"])) {
    ...
    public function getRetentionEventType()
    {
        if (array_key_exists("retentionEventType", $this->_propDict)) {
            if (is_a($this->_propDict["retentionEventType"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\RetentionEventType") || is_null($this->_propDict["retentionEventType"])) {
