...
class CaseExportOperation extends CaseOperation
{
    ...
    public function getExportOptions()
    {
        if (array_key_exists("exportOptions", $this->_propDict)) {
            if (is_a($this->_propDict["exportOptions"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\ExportOptions") || is_null($this->_propDict["exportOptions"])) {
    ...
    public function getExportStructure()
    {
        if (array_key_exists("exportStructure", $this->_propDict)) {
            if (is_a($this->_propDict["exportStructure"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\ExportFileStructure") || is_null($this->_propDict["exportStructure"])) {
