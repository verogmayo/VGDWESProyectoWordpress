...
class LogonUser extends Entity
{
    ...
    public function getAccountType()
    {
        if (array_key_exists("accountType", $this->_propDict)) {
            if (is_a($this->_propDict["accountType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserAccountSecurityType") || is_null($this->_propDict["accountType"])) {
    ...
    public function getLogonTypes()
    {
        if (array_key_exists("logonTypes", $this->_propDict)) {
            if (is_a($this->_propDict["logonTypes"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\LogonType") || is_null($this->_propDict["logonTypes"])) {
