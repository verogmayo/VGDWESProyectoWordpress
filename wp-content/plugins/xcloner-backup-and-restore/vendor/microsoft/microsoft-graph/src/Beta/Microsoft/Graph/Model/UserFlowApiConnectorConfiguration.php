...
class UserFlowApiConnectorConfiguration extends Entity
{
    ...
    public function getPostAttributeCollection()
    {
        if (array_key_exists("postAttributeCollection", $this->_propDict)) {
            if (is_a($this->_propDict["postAttributeCollection"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityApiConnector") || is_null($this->_propDict["postAttributeCollection"])) {
    ...
    public function getPostFederationSignup()
    {
        if (array_key_exists("postFederationSignup", $this->_propDict)) {
            if (is_a($this->_propDict["postFederationSignup"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityApiConnector") || is_null($this->_propDict["postFederationSignup"])) {
    ...
    public function getPreTokenIssuance()
    {
        if (array_key_exists("preTokenIssuance", $this->_propDict)) {
            if (is_a($this->_propDict["preTokenIssuance"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityApiConnector") || is_null($this->_propDict["preTokenIssuance"])) {
