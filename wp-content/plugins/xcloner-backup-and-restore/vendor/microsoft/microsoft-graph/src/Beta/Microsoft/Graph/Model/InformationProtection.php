...
class InformationProtection extends Entity
{
    ...
    public function getBitlocker()
    {
        if (array_key_exists("bitlocker", $this->_propDict)) {
            if (is_a($this->_propDict["bitlocker"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Bitlocker") || is_null($this->_propDict["bitlocker"])) {
    ...
    public function getSensitivityPolicySettings()
    {
        if (array_key_exists("sensitivityPolicySettings", $this->_propDict)) {
            if (is_a($this->_propDict["sensitivityPolicySettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SensitivityPolicySettings") || is_null($this->_propDict["sensitivityPolicySettings"])) {
    ...
    public function getPolicy()
    {
        if (array_key_exists("policy", $this->_propDict)) {
            if (is_a($this->_propDict["policy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InformationProtectionPolicy") || is_null($this->_propDict["policy"])) {
