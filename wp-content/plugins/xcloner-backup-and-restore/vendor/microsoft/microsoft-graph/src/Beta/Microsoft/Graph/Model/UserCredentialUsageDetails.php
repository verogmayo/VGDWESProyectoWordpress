...
class UserCredentialUsageDetails extends Entity
{
    ...
    public function getAuthMethod()
    {
        if (array_key_exists("authMethod", $this->_propDict)) {
            if (is_a($this->_propDict["authMethod"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UsageAuthMethod") || is_null($this->_propDict["authMethod"])) {
    ...
    public function getFeature()
    {
        if (array_key_exists("feature", $this->_propDict)) {
            if (is_a($this->_propDict["feature"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\FeatureType") || is_null($this->_propDict["feature"])) {
