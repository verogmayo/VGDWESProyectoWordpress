...
class AccessReviewScheduleDefinition extends Entity
{
    ...
    public function getInstanceEnumerationScope()
    {
        if (array_key_exists("instanceEnumerationScope", $this->_propDict)) {
            if (is_a($this->_propDict["instanceEnumerationScope"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewScope") || is_null($this->_propDict["instanceEnumerationScope"])) {
    ...
    public function getScope()
    {
        if (array_key_exists("scope", $this->_propDict)) {
            if (is_a($this->_propDict["scope"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewScope") || is_null($this->_propDict["scope"])) {
