...
class SynchronizationRule extends Entity
{
    ...
    public function getMetadata()
    {
        if (array_key_exists("metadata", $this->_propDict)) {
            if (is_a($this->_propDict["metadata"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\StringKeyStringValuePair") || is_null($this->_propDict["metadata"])) {
    ...
    public function getObjectMappings()
    {
        if (array_key_exists("objectMappings", $this->_propDict)) {
            if (is_a($this->_propDict["objectMappings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ObjectMapping") || is_null($this->_propDict["objectMappings"])) {
