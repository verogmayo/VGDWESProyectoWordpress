...
class AttributeDefinition extends Entity
{
    ...
    public function getApiExpressions()
    {
        if (array_key_exists("apiExpressions", $this->_propDict)) {
            if (is_a($this->_propDict["apiExpressions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\StringKeyStringValuePair") || is_null($this->_propDict["apiExpressions"])) {
    ...
    public function getMutability()
    {
        if (array_key_exists("mutability", $this->_propDict)) {
            if (is_a($this->_propDict["mutability"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Mutability") || is_null($this->_propDict["mutability"])) {
    ...
    public function getReferencedObjects()
    {
        if (array_key_exists("referencedObjects", $this->_propDict)) {
            if (is_a($this->_propDict["referencedObjects"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ReferencedObject") || is_null($this->_propDict["referencedObjects"])) {
