...
* @link      https://graph.microsoft.com
*/
class File extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the content
     *
    ...
    public function getExtractedTextContent()
    {
        if (array_key_exists("extractedTextContent", $this->_propDict)) {
            if (is_a($this->_propDict["extractedTextContent"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["extractedTextContent"])) {
                return $this->_propDict["extractedTextContent"];
            } else {
                $this->_propDict["extractedTextContent"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["extractedTextContent"]);
                return $this->_propDict["extractedTextContent"];
            }
        }
        return null;
    ...
    public function getOtherProperties()
    {
        if (array_key_exists("otherProperties", $this->_propDict)) {
            if (is_a($this->_propDict["otherProperties"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\StringValueDictionary") || is_null($this->_propDict["otherProperties"])) {
    ...
    public function getProcessingStatus()
    {
        if (array_key_exists("processingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["processingStatus"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\FileProcessingStatus") || is_null($this->_propDict["processingStatus"])) {
    ...
    public function getSourceType()
    {
        if (array_key_exists("sourceType", $this->_propDict)) {
            if (is_a($this->_propDict["sourceType"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\SourceType") || is_null($this->_propDict["sourceType"])) {
