...
class WindowsHealthMonitoringConfiguration extends DeviceConfiguration
{
    ...
    public function getAllowDeviceHealthMonitoring()
    {
        if (array_key_exists("allowDeviceHealthMonitoring", $this->_propDict)) {
            if (is_a($this->_propDict["allowDeviceHealthMonitoring"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["allowDeviceHealthMonitoring"])) {
    ...
    public function getConfigDeviceHealthMonitoringScope()
    {
        if (array_key_exists("configDeviceHealthMonitoringScope", $this->_propDict)) {
            if (is_a($this->_propDict["configDeviceHealthMonitoringScope"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsHealthMonitoringScope") || is_null($this->_propDict["configDeviceHealthMonitoringScope"])) {
