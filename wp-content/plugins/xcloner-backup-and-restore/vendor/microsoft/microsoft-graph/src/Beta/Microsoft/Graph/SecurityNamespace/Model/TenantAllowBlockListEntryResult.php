...
* @link      https://graph.microsoft.com
*/
class TenantAllowBlockListEntryResult extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the entryType
    ...
    public function getEntryType()
    {
        if (array_key_exists("entryType", $this->_propDict)) {
            if (is_a($this->_propDict["entryType"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\TenantAllowBlockListEntryType") || is_null($this->_propDict["entryType"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\LongRunningOperationStatus") || is_null($this->_propDict["status"])) {
