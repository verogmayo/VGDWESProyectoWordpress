...
class OnenotePatchContentCommand extends Entity
{
    ...
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OnenotePatchActionType") || is_null($this->_propDict["action"])) {
    ...
    public function getPosition()
    {
        if (array_key_exists("position", $this->_propDict)) {
            if (is_a($this->_propDict["position"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OnenotePatchInsertPosition") || is_null($this->_propDict["position"])) {
