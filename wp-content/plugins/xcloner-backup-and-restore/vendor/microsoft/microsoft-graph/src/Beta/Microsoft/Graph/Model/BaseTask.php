...
class BaseTask extends Entity
{
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TaskStatus_v2") || is_null($this->_propDict["status"])) {
    ...
    public function getViewpoint()
    {
        if (array_key_exists("viewpoint", $this->_propDict)) {
            if (is_a($this->_propDict["viewpoint"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TaskViewpoint") || is_null($this->_propDict["viewpoint"])) {
    ...
    public function getParentList()
    {
        if (array_key_exists("parentList", $this->_propDict)) {
            if (is_a($this->_propDict["parentList"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\BaseTaskList") || is_null($this->_propDict["parentList"])) {
