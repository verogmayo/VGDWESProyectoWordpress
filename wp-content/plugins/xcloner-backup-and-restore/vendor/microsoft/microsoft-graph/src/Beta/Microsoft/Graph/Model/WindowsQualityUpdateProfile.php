...
class WindowsQualityUpdateProfile extends Entity
{
    ...
    public function getExpeditedUpdateSettings()
    {
        if (array_key_exists("expeditedUpdateSettings", $this->_propDict)) {
            if (is_a($this->_propDict["expeditedUpdateSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ExpeditedWindowsQualityUpdateSettings") || is_null($this->_propDict["expeditedUpdateSettings"])) {
