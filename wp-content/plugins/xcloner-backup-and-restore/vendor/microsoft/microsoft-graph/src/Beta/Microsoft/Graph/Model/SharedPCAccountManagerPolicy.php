...
class SharedPCAccountManagerPolicy extends Entity
{
    ...
    public function getAccountDeletionPolicy()
    {
        if (array_key_exists("accountDeletionPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["accountDeletionPolicy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharedPCAccountDeletionPolicyType") || is_null($this->_propDict["accountDeletionPolicy"])) {
