...
class PrintTask extends Entity
{
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrintTaskStatus") || is_null($this->_propDict["status"])) {
    ...
    public function getDefinition()
    {
        if (array_key_exists("definition", $this->_propDict)) {
            if (is_a($this->_propDict["definition"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrintTaskDefinition") || is_null($this->_propDict["definition"])) {
    ...
    public function getTrigger()
    {
        if (array_key_exists("trigger", $this->_propDict)) {
            if (is_a($this->_propDict["trigger"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrintTaskTrigger") || is_null($this->_propDict["trigger"])) {
