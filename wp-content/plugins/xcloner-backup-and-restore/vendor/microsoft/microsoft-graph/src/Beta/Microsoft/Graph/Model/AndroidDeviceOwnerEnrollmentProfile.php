...
class AndroidDeviceOwnerEnrollmentProfile extends Entity
{
    ...
    public function getEnrollmentMode()
    {
        if (array_key_exists("enrollmentMode", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentMode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidDeviceOwnerEnrollmentMode") || is_null($this->_propDict["enrollmentMode"])) {
    ...
    public function getEnrollmentTokenType()
    {
        if (array_key_exists("enrollmentTokenType", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentTokenType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidDeviceOwnerEnrollmentTokenType") || is_null($this->_propDict["enrollmentTokenType"])) {
    ...
    public function getWifiSecurityType()
    {
        if (array_key_exists("wifiSecurityType", $this->_propDict)) {
            if (is_a($this->_propDict["wifiSecurityType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AospWifiSecurityType") || is_null($this->_propDict["wifiSecurityType"])) {
