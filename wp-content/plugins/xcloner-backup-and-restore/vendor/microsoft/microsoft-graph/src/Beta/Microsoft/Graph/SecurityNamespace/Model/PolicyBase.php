...
* @link      https://graph.microsoft.com
*/
class PolicyBase extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the createdBy
     *
     ...
     * Gets the status
     *
     * @return PolicyStatus|null The status
     */
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\PolicyStatus") || is_null($this->_propDict["status"])) {
                return $this->_propDict["status"];
            } else {
                $this->_propDict["status"] = new PolicyStatus($this->_propDict["status"]);
                return $this->_propDict["status"];
            }
        }
        return null;
     ...
     * Sets the status
     *
     * @param PolicyStatus $val The status
     *
     * @return PolicyBase
     */
