...
class DelegatedAdminRelationship extends Entity
{
    ...
    public function getCustomer()
    {
        if (array_key_exists("customer", $this->_propDict)) {
            if (is_a($this->_propDict["customer"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DelegatedAdminRelationshipCustomerParticipant") || is_null($this->_propDict["customer"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DelegatedAdminRelationshipStatus") || is_null($this->_propDict["status"])) {
