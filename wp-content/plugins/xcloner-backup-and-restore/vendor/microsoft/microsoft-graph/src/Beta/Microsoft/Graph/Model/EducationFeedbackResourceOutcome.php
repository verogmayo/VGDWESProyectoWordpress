...
class EducationFeedbackResourceOutcome extends EducationOutcome
{
    ...
    public function getFeedbackResource()
    {
        if (array_key_exists("feedbackResource", $this->_propDict)) {
            if (is_a($this->_propDict["feedbackResource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationResource") || is_null($this->_propDict["feedbackResource"])) {
    ...
    public function getResourceStatus()
    {
        if (array_key_exists("resourceStatus", $this->_propDict)) {
            if (is_a($this->_propDict["resourceStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationFeedbackResourceOutcomeStatus") || is_null($this->_propDict["resourceStatus"])) {
