...
class AccessReview extends Entity
{
    ...
    public function getReviewedEntity()
    {
        if (array_key_exists("reviewedEntity", $this->_propDict)) {
            if (is_a($this->_propDict["reviewedEntity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["reviewedEntity"])) {
    ...
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewSettings") || is_null($this->_propDict["settings"])) {
