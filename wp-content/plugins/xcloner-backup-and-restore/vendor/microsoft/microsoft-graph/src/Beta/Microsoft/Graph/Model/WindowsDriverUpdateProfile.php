...
class WindowsDriverUpdateProfile extends Entity
{
    ...
    public function getApprovalType()
    {
        if (array_key_exists("approvalType", $this->_propDict)) {
            if (is_a($this->_propDict["approvalType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DriverUpdateProfileApprovalType") || is_null($this->_propDict["approvalType"])) {
    ...
    public function getInventorySyncStatus()
    {
        if (array_key_exists("inventorySyncStatus", $this->_propDict)) {
            if (is_a($this->_propDict["inventorySyncStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsDriverUpdateProfileInventorySyncStatus") || is_null($this->_propDict["inventorySyncStatus"])) {
