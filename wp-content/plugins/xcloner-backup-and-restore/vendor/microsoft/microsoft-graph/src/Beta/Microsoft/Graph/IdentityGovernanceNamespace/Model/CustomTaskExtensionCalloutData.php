...
* @link      https://graph.microsoft.com
*/
class CustomTaskExtensionCalloutData extends \XCloner\Beta\Microsoft\Graph\Model\CustomExtensionData
{
    /**
     * Gets the subject
     *
    ...
    public function getTaskProcessingresult()
    {
        if (array_key_exists("taskProcessingresult", $this->_propDict)) {
            if (is_a($this->_propDict["taskProcessingresult"], "XCloner\\Beta\\Microsoft\\Graph\\IdentityGovernanceNamespace\\Model\\TaskProcessingResult") || is_null($this->_propDict["taskProcessingresult"])) {
    ...
    public function getWorkflow()
    {
        if (array_key_exists("workflow", $this->_propDict)) {
            if (is_a($this->_propDict["workflow"], "XCloner\\Beta\\Microsoft\\Graph\\IdentityGovernanceNamespace\\Model\\Workflow") || is_null($this->_propDict["workflow"])) {
