...
class Site extends BaseItem
{
    ...
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SiteSettings") || is_null($this->_propDict["settings"])) {
    ...
    public function getSiteCollection()
    {
        if (array_key_exists("siteCollection", $this->_propDict)) {
            if (is_a($this->_propDict["siteCollection"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SiteCollection") || is_null($this->_propDict["siteCollection"])) {
    ...
    public function getTermStore()
    {
        if (array_key_exists("termStore", $this->_propDict)) {
            if (is_a($this->_propDict["termStore"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Store") || is_null($this->_propDict["termStore"])) {
                return $this->_propDict["termStore"];
            } else {
                $this->_propDict["termStore"] = new \XCloner\Beta\Microsoft\Graph\TermStore\Model\Store($this->_propDict["termStore"]);
                return $this->_propDict["termStore"];
            }
        }
        return null;
