...
class CloudPcProvisioningPolicy extends Entity
{
    ...
    public function getDomainJoinConfiguration()
    {
        if (array_key_exists("domainJoinConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["domainJoinConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcDomainJoinConfiguration") || is_null($this->_propDict["domainJoinConfiguration"])) {
    ...
    public function getImageType()
    {
        if (array_key_exists("imageType", $this->_propDict)) {
            if (is_a($this->_propDict["imageType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcProvisioningPolicyImageType") || is_null($this->_propDict["imageType"])) {
    ...
    public function getManagedBy()
    {
        if (array_key_exists("managedBy", $this->_propDict)) {
            if (is_a($this->_propDict["managedBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcManagementService") || is_null($this->_propDict["managedBy"])) {
    ...
    public function getMicrosoftManagedDesktop()
    {
        if (array_key_exists("microsoftManagedDesktop", $this->_propDict)) {
            if (is_a($this->_propDict["microsoftManagedDesktop"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MicrosoftManagedDesktop") || is_null($this->_propDict["microsoftManagedDesktop"])) {
    ...
    public function getWindowsSettings()
    {
        if (array_key_exists("windowsSettings", $this->_propDict)) {
            if (is_a($this->_propDict["windowsSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcWindowsSettings") || is_null($this->_propDict["windowsSettings"])) {
