...
class SynchronizationJob extends Entity
{
    ...
    public function getSchedule()
    {
        if (array_key_exists("schedule", $this->_propDict)) {
            if (is_a($this->_propDict["schedule"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SynchronizationSchedule") || is_null($this->_propDict["schedule"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SynchronizationStatus") || is_null($this->_propDict["status"])) {
    ...
    public function getSchema()
    {
        if (array_key_exists("schema", $this->_propDict)) {
            if (is_a($this->_propDict["schema"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SynchronizationSchema") || is_null($this->_propDict["schema"])) {
