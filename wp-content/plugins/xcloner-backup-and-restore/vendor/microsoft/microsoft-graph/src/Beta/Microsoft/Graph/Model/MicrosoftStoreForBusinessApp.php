...
class MicrosoftStoreForBusinessApp extends MobileApp
{
    ...
    public function getLicenseType()
    {
        if (array_key_exists("licenseType", $this->_propDict)) {
            if (is_a($this->_propDict["licenseType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MicrosoftStoreForBusinessLicenseType") || is_null($this->_propDict["licenseType"])) {
    ...
    public function getLicensingType()
    {
        if (array_key_exists("licensingType", $this->_propDict)) {
            if (is_a($this->_propDict["licensingType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VppLicensingType") || is_null($this->_propDict["licensingType"])) {
