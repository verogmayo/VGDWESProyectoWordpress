...
class ConditionalAccessSessionControls extends Entity
{
    ...
    public function getApplicationEnforcedRestrictions()
    {
        if (array_key_exists("applicationEnforcedRestrictions", $this->_propDict)) {
            if (is_a($this->_propDict["applicationEnforcedRestrictions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ApplicationEnforcedRestrictionsSessionControl") || is_null($this->_propDict["applicationEnforcedRestrictions"])) {
    ...
    public function getCloudAppSecurity()
    {
        if (array_key_exists("cloudAppSecurity", $this->_propDict)) {
            if (is_a($this->_propDict["cloudAppSecurity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudAppSecuritySessionControl") || is_null($this->_propDict["cloudAppSecurity"])) {
    ...
    public function getContinuousAccessEvaluation()
    {
        if (array_key_exists("continuousAccessEvaluation", $this->_propDict)) {
            if (is_a($this->_propDict["continuousAccessEvaluation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ContinuousAccessEvaluationSessionControl") || is_null($this->_propDict["continuousAccessEvaluation"])) {
    ...
    public function getPersistentBrowser()
    {
        if (array_key_exists("persistentBrowser", $this->_propDict)) {
            if (is_a($this->_propDict["persistentBrowser"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PersistentBrowserSessionControl") || is_null($this->_propDict["persistentBrowser"])) {
    ...
    public function getSignInFrequency()
    {
        if (array_key_exists("signInFrequency", $this->_propDict)) {
            if (is_a($this->_propDict["signInFrequency"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SignInFrequencySessionControl") || is_null($this->_propDict["signInFrequency"])) {
