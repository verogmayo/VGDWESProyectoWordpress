...
class IosDeviceFeaturesConfiguration extends AppleDeviceFeaturesConfigurationBase
{
    ...
    public function getContentFilterSettings()
    {
        if (array_key_exists("contentFilterSettings", $this->_propDict)) {
            if (is_a($this->_propDict["contentFilterSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosWebContentFilterBase") || is_null($this->_propDict["contentFilterSettings"])) {
    ...
    public function getIosSingleSignOnExtension()
    {
        if (array_key_exists("iosSingleSignOnExtension", $this->_propDict)) {
            if (is_a($this->_propDict["iosSingleSignOnExtension"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosSingleSignOnExtension") || is_null($this->_propDict["iosSingleSignOnExtension"])) {
    ...
    public function getSingleSignOnExtension()
    {
        if (array_key_exists("singleSignOnExtension", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnExtension"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SingleSignOnExtension") || is_null($this->_propDict["singleSignOnExtension"])) {
    ...
    public function getSingleSignOnSettings()
    {
        if (array_key_exists("singleSignOnSettings", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosSingleSignOnSettings") || is_null($this->_propDict["singleSignOnSettings"])) {
    ...
    public function getWallpaperDisplayLocation()
    {
        if (array_key_exists("wallpaperDisplayLocation", $this->_propDict)) {
            if (is_a($this->_propDict["wallpaperDisplayLocation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosWallpaperDisplayLocation") || is_null($this->_propDict["wallpaperDisplayLocation"])) {
    ...
    public function getWallpaperImage()
    {
        if (array_key_exists("wallpaperImage", $this->_propDict)) {
            if (is_a($this->_propDict["wallpaperImage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MimeContent") || is_null($this->_propDict["wallpaperImage"])) {
    ...
    public function getIdentityCertificateForClientAuthentication()
    {
        if (array_key_exists("identityCertificateForClientAuthentication", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificateForClientAuthentication"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosCertificateProfileBase") || is_null($this->_propDict["identityCertificateForClientAuthentication"])) {
    ...
    public function getSingleSignOnExtensionPkinitCertificate()
    {
        if (array_key_exists("singleSignOnExtensionPkinitCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnExtensionPkinitCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosCertificateProfileBase") || is_null($this->_propDict["singleSignOnExtensionPkinitCertificate"])) {
