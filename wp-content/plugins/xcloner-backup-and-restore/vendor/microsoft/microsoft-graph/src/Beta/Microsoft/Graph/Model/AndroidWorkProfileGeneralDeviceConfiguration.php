...
class AndroidWorkProfileGeneralDeviceConfiguration extends DeviceConfiguration
{
    ...
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidWorkProfileRequiredPasswordType") || is_null($this->_propDict["passwordRequiredType"])) {
    ...
    public function getRequiredPasswordComplexity()
    {
        if (array_key_exists("requiredPasswordComplexity", $this->_propDict)) {
            if (is_a($this->_propDict["requiredPasswordComplexity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidRequiredPasswordComplexity") || is_null($this->_propDict["requiredPasswordComplexity"])) {
    ...
    public function getWorkProfileDataSharingType()
    {
        if (array_key_exists("workProfileDataSharingType", $this->_propDict)) {
            if (is_a($this->_propDict["workProfileDataSharingType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidWorkProfileCrossProfileDataSharingType") || is_null($this->_propDict["workProfileDataSharingType"])) {
    ...
    public function getWorkProfileDefaultAppPermissionPolicy()
    {
        if (array_key_exists("workProfileDefaultAppPermissionPolicy", $this->_propDict)) {
            if (is_a($this->_propDict["workProfileDefaultAppPermissionPolicy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidWorkProfileDefaultAppPermissionPolicyType") || is_null($this->_propDict["workProfileDefaultAppPermissionPolicy"])) {
    ...
    public function getWorkProfilePasswordRequiredType()
    {
        if (array_key_exists("workProfilePasswordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["workProfilePasswordRequiredType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidWorkProfileRequiredPasswordType") || is_null($this->_propDict["workProfilePasswordRequiredType"])) {
    ...
    public function getWorkProfileRequiredPasswordComplexity()
    {
        if (array_key_exists("workProfileRequiredPasswordComplexity", $this->_propDict)) {
            if (is_a($this->_propDict["workProfileRequiredPasswordComplexity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidRequiredPasswordComplexity") || is_null($this->_propDict["workProfileRequiredPasswordComplexity"])) {
