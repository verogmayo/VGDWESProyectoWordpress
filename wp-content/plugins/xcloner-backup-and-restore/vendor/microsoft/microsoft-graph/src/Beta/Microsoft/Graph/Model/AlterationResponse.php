...
class AlterationResponse extends Entity
{
    ...
    public function getQueryAlteration()
    {
        if (array_key_exists("queryAlteration", $this->_propDict)) {
            if (is_a($this->_propDict["queryAlteration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SearchAlteration") || is_null($this->_propDict["queryAlteration"])) {
    ...
    public function getQueryAlterationType()
    {
        if (array_key_exists("queryAlterationType", $this->_propDict)) {
            if (is_a($this->_propDict["queryAlterationType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SearchAlterationType") || is_null($this->_propDict["queryAlterationType"])) {
