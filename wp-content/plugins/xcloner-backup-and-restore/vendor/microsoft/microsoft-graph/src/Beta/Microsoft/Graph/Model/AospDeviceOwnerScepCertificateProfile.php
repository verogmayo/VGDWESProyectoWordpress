...
* 
* AospDeviceOwnerScepCertificateProfile File
* PHP version 7
*
* @category  Library
...
/**
* AospDeviceOwnerScepCertificateProfile class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class AospDeviceOwnerScepCertificateProfile extends AospDeviceOwnerCertificateProfileBase
{
    /**
    ...
    public function getHashAlgorithm()
    {
        if (array_key_exists("hashAlgorithm", $this->_propDict)) {
            if (is_a($this->_propDict["hashAlgorithm"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\HashAlgorithms") || is_null($this->_propDict["hashAlgorithm"])) {
    ...
    public function getKeySize()
    {
        if (array_key_exists("keySize", $this->_propDict)) {
            if (is_a($this->_propDict["keySize"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\KeySize") || is_null($this->_propDict["keySize"])) {
    ...
    public function getKeyUsage()
    {
        if (array_key_exists("keyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["keyUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\KeyUsages") || is_null($this->_propDict["keyUsage"])) {
