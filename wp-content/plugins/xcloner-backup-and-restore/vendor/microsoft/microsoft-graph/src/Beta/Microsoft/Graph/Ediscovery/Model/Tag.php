...
* @link      https://graph.microsoft.com
*/
class Tag extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getChildSelectability()
    {
        if (array_key_exists("childSelectability", $this->_propDict)) {
            if (is_a($this->_propDict["childSelectability"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\ChildSelectability") || is_null($this->_propDict["childSelectability"])) {
    ...
    public function getParent()
    {
        if (array_key_exists("parent", $this->_propDict)) {
            if (is_a($this->_propDict["parent"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\Tag") || is_null($this->_propDict["parent"])) {
