...
class DepOnboardingSetting extends Entity
{
    ...
    public function getTokenType()
    {
        if (array_key_exists("tokenType", $this->_propDict)) {
            if (is_a($this->_propDict["tokenType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DepTokenType") || is_null($this->_propDict["tokenType"])) {
    ...
    public function getDefaultIosEnrollmentProfile()
    {
        if (array_key_exists("defaultIosEnrollmentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["defaultIosEnrollmentProfile"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DepIOSEnrollmentProfile") || is_null($this->_propDict["defaultIosEnrollmentProfile"])) {
    ...
    public function getDefaultMacOsEnrollmentProfile()
    {
        if (array_key_exists("defaultMacOsEnrollmentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["defaultMacOsEnrollmentProfile"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DepMacOSEnrollmentProfile") || is_null($this->_propDict["defaultMacOsEnrollmentProfile"])) {
