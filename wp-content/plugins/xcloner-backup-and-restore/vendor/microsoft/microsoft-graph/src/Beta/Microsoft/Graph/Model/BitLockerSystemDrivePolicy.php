...
class BitLockerSystemDrivePolicy extends Entity
{
    ...
    public function getEncryptionMethod()
    {
        if (array_key_exists("encryptionMethod", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionMethod"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\BitLockerEncryptionMethod") || is_null($this->_propDict["encryptionMethod"])) {
    ...
    public function getRecoveryOptions()
    {
        if (array_key_exists("recoveryOptions", $this->_propDict)) {
            if (is_a($this->_propDict["recoveryOptions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\BitLockerRecoveryOptions") || is_null($this->_propDict["recoveryOptions"])) {
    ...
    public function getStartupAuthenticationTpmKeyUsage()
    {
        if (array_key_exists("startupAuthenticationTpmKeyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmKeyUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["startupAuthenticationTpmKeyUsage"])) {
    ...
    public function getStartupAuthenticationTpmPinAndKeyUsage()
    {
        if (array_key_exists("startupAuthenticationTpmPinAndKeyUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmPinAndKeyUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["startupAuthenticationTpmPinAndKeyUsage"])) {
    ...
    public function getStartupAuthenticationTpmPinUsage()
    {
        if (array_key_exists("startupAuthenticationTpmPinUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmPinUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["startupAuthenticationTpmPinUsage"])) {
    ...
    public function getStartupAuthenticationTpmUsage()
    {
        if (array_key_exists("startupAuthenticationTpmUsage", $this->_propDict)) {
            if (is_a($this->_propDict["startupAuthenticationTpmUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["startupAuthenticationTpmUsage"])) {
