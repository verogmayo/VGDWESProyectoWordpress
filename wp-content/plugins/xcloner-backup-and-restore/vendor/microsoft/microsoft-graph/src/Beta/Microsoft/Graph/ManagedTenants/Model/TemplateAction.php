...
* @link      https://graph.microsoft.com
*/
class TemplateAction extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\Setting") || is_null($this->_propDict["settings"])) {
    ...
    public function getLicenses()
    {
        if (array_key_exists("licenses", $this->_propDict)) {
            if (is_a($this->_propDict["licenses"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\LicenseDetails") || is_null($this->_propDict["licenses"])) {
                return $this->_propDict["licenses"];
            } else {
                $this->_propDict["licenses"] = new \XCloner\Beta\Microsoft\Graph\Model\LicenseDetails($this->_propDict["licenses"]);
                return $this->_propDict["licenses"];
            }
        }
        return null;
