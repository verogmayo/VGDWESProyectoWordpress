...
* @link      https://graph.microsoft.com
*/
class ExternalItem extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the acl
    ...
    public function getContent()
    {
        if (array_key_exists("content", $this->_propDict)) {
            if (is_a($this->_propDict["content"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\ExternalItemContent") || is_null($this->_propDict["content"])) {
    ...
    public function getExternalItemProperties()
    {
        if (array_key_exists("properties", $this->_propDict)) {
            if (is_a($this->_propDict["properties"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\Properties") || is_null($this->_propDict["properties"])) {
