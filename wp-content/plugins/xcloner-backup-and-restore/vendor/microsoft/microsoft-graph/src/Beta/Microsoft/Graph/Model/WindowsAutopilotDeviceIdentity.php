...
class WindowsAutopilotDeviceIdentity extends Entity
{
    ...
    public function getDeploymentProfileAssignmentDetailedStatus()
    {
        if (array_key_exists("deploymentProfileAssignmentDetailedStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentProfileAssignmentDetailedStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotProfileAssignmentDetailedStatus") || is_null($this->_propDict["deploymentProfileAssignmentDetailedStatus"])) {
    ...
    public function getDeploymentProfileAssignmentStatus()
    {
        if (array_key_exists("deploymentProfileAssignmentStatus", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentProfileAssignmentStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotProfileAssignmentStatus") || is_null($this->_propDict["deploymentProfileAssignmentStatus"])) {
    ...
    public function getEnrollmentState()
    {
        if (array_key_exists("enrollmentState", $this->_propDict)) {
            if (is_a($this->_propDict["enrollmentState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EnrollmentState") || is_null($this->_propDict["enrollmentState"])) {
    ...
    public function getRemediationState()
    {
        if (array_key_exists("remediationState", $this->_propDict)) {
            if (is_a($this->_propDict["remediationState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeviceRemediationState") || is_null($this->_propDict["remediationState"])) {
    ...
    public function getDeploymentProfile()
    {
        if (array_key_exists("deploymentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["deploymentProfile"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeploymentProfile") || is_null($this->_propDict["deploymentProfile"])) {
    ...
    public function getIntendedDeploymentProfile()
    {
        if (array_key_exists("intendedDeploymentProfile", $this->_propDict)) {
            if (is_a($this->_propDict["intendedDeploymentProfile"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsAutopilotDeploymentProfile") || is_null($this->_propDict["intendedDeploymentProfile"])) {
