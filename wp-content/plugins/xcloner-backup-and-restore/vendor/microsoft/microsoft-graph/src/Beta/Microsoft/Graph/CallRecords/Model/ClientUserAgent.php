...
class ClientUserAgent extends UserAgent
{
    ...
    public function getPlatform()
    {
        if (array_key_exists("platform", $this->_propDict)) {
            if (is_a($this->_propDict["platform"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\ClientPlatform") || is_null($this->_propDict["platform"])) {
    ...
    public function getProductFamily()
    {
        if (array_key_exists("productFamily", $this->_propDict)) {
            if (is_a($this->_propDict["productFamily"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\ProductFamily") || is_null($this->_propDict["productFamily"])) {
