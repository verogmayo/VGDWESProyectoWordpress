...
class TeamworkSystemConfiguration extends Entity
{
    ...
    public function getDateTimeConfiguration()
    {
        if (array_key_exists("dateTimeConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["dateTimeConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkDateTimeConfiguration") || is_null($this->_propDict["dateTimeConfiguration"])) {
    ...
    public function getNetworkConfiguration()
    {
        if (array_key_exists("networkConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["networkConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkNetworkConfiguration") || is_null($this->_propDict["networkConfiguration"])) {
