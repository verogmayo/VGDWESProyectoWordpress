...
class GraphPrint implements \JsonSerializable
{
    ...
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrintSettings") || is_null($this->_propDict["settings"])) {
    ...
    public function getReports()
    {
        if (array_key_exists("reports", $this->_propDict)) {
            if (is_a($this->_propDict["reports"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ReportRoot") || is_null($this->_propDict["reports"])) {
