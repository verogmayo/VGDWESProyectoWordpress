...
class MembershipOutlierInsight extends GovernanceInsight
{
    ...
    public function getOutlierContainerType()
    {
        if (array_key_exists("outlierContainerType", $this->_propDict)) {
            if (is_a($this->_propDict["outlierContainerType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OutlierContainerType") || is_null($this->_propDict["outlierContainerType"])) {
    ...
    public function getOutlierMemberType()
    {
        if (array_key_exists("outlierMemberType", $this->_propDict)) {
            if (is_a($this->_propDict["outlierMemberType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\OutlierMemberType") || is_null($this->_propDict["outlierMemberType"])) {
    ...
    public function getContainer()
    {
        if (array_key_exists("container", $this->_propDict)) {
            if (is_a($this->_propDict["container"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DirectoryObject") || is_null($this->_propDict["container"])) {
    ...
    public function getMember()
    {
        if (array_key_exists("member", $this->_propDict)) {
            if (is_a($this->_propDict["member"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DirectoryObject") || is_null($this->_propDict["member"])) {
