...
class ZebraFotaDeploymentSettings extends Entity
{
    ...
    public function getDownloadRuleNetworkType()
    {
        if (array_key_exists("downloadRuleNetworkType", $this->_propDict)) {
            if (is_a($this->_propDict["downloadRuleNetworkType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ZebraFotaNetworkType") || is_null($this->_propDict["downloadRuleNetworkType"])) {
    ...
    public function getInstallRuleWindowEndTime()
    {
        if (array_key_exists("installRuleWindowEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["installRuleWindowEndTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["installRuleWindowEndTime"])) {
    ...
    public function getInstallRuleWindowStartTime()
    {
        if (array_key_exists("installRuleWindowStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["installRuleWindowStartTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["installRuleWindowStartTime"])) {
    ...
    public function getScheduleMode()
    {
        if (array_key_exists("scheduleMode", $this->_propDict)) {
            if (is_a($this->_propDict["scheduleMode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ZebraFotaScheduleMode") || is_null($this->_propDict["scheduleMode"])) {
    ...
    public function getUpdateType()
    {
        if (array_key_exists("updateType", $this->_propDict)) {
            if (is_a($this->_propDict["updateType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ZebraFotaUpdateType") || is_null($this->_propDict["updateType"])) {
