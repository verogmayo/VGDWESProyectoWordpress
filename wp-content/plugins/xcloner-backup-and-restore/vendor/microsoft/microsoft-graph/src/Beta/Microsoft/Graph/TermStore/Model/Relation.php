...
* @link      https://graph.microsoft.com
*/
class Relation extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getRelationship()
    {
        if (array_key_exists("relationship", $this->_propDict)) {
            if (is_a($this->_propDict["relationship"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\RelationType") || is_null($this->_propDict["relationship"])) {
    ...
    public function getFromTerm()
    {
        if (array_key_exists("fromTerm", $this->_propDict)) {
            if (is_a($this->_propDict["fromTerm"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Term") || is_null($this->_propDict["fromTerm"])) {
    ...
    public function getSet()
    {
        if (array_key_exists("set", $this->_propDict)) {
            if (is_a($this->_propDict["set"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Set") || is_null($this->_propDict["set"])) {
    ...
    public function getToTerm()
    {
        if (array_key_exists("toTerm", $this->_propDict)) {
            if (is_a($this->_propDict["toTerm"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Term") || is_null($this->_propDict["toTerm"])) {
