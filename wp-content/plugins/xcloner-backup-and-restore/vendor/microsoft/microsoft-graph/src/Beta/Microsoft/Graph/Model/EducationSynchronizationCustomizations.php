...
class EducationSynchronizationCustomizations extends EducationSynchronizationCustomizationsBase
{
    ...
    public function getSchool()
    {
        if (array_key_exists("school", $this->_propDict)) {
            if (is_a($this->_propDict["school"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationSynchronizationCustomization") || is_null($this->_propDict["school"])) {
    ...
    public function getSection()
    {
        if (array_key_exists("section", $this->_propDict)) {
            if (is_a($this->_propDict["section"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationSynchronizationCustomization") || is_null($this->_propDict["section"])) {
    ...
    public function getStudent()
    {
        if (array_key_exists("student", $this->_propDict)) {
            if (is_a($this->_propDict["student"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationSynchronizationCustomization") || is_null($this->_propDict["student"])) {
    ...
    public function getStudentEnrollment()
    {
        if (array_key_exists("studentEnrollment", $this->_propDict)) {
            if (is_a($this->_propDict["studentEnrollment"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationSynchronizationCustomization") || is_null($this->_propDict["studentEnrollment"])) {
    ...
    public function getTeacher()
    {
        if (array_key_exists("teacher", $this->_propDict)) {
            if (is_a($this->_propDict["teacher"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationSynchronizationCustomization") || is_null($this->_propDict["teacher"])) {
    ...
    public function getTeacherRoster()
    {
        if (array_key_exists("teacherRoster", $this->_propDict)) {
            if (is_a($this->_propDict["teacherRoster"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EducationSynchronizationCustomization") || is_null($this->_propDict["teacherRoster"])) {
