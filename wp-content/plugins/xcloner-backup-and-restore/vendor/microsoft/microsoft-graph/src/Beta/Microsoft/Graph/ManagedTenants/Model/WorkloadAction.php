...
* @link      https://graph.microsoft.com
*/
class WorkloadAction extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the actionId
    ...
    public function getCategory()
    {
        if (array_key_exists("category", $this->_propDict)) {
            if (is_a($this->_propDict["category"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\WorkloadActionCategory") || is_null($this->_propDict["category"])) {
