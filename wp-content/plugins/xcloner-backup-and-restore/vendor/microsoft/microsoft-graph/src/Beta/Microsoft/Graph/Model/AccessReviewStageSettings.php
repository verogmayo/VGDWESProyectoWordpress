...
class AccessReviewStageSettings extends Entity
{
    ...
    public function getFallbackReviewers()
    {
        if (array_key_exists("fallbackReviewers", $this->_propDict)) {
            if (is_a($this->_propDict["fallbackReviewers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewReviewerScope") || is_null($this->_propDict["fallbackReviewers"])) {
    ...
    public function getRecommendationInsightSettings()
    {
        if (array_key_exists("recommendationInsightSettings", $this->_propDict)) {
            if (is_a($this->_propDict["recommendationInsightSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewRecommendationInsightSetting") || is_null($this->_propDict["recommendationInsightSettings"])) {
    ...
    public function getReviewers()
    {
        if (array_key_exists("reviewers", $this->_propDict)) {
            if (is_a($this->_propDict["reviewers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewReviewerScope") || is_null($this->_propDict["reviewers"])) {
