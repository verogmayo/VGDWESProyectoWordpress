...
class DeviceScopeActionResult extends Entity
{
    ...
    public function getDeviceScopeAction()
    {
        if (array_key_exists("deviceScopeAction", $this->_propDict)) {
            if (is_a($this->_propDict["deviceScopeAction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceScopeAction") || is_null($this->_propDict["deviceScopeAction"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceScopeActionStatus") || is_null($this->_propDict["status"])) {
