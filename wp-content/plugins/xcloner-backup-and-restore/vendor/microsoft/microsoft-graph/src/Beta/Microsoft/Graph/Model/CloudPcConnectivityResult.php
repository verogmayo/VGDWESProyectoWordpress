...
class CloudPcConnectivityResult extends Entity
{
    ...
    public function getFailedHealthCheckItems()
    {
        if (array_key_exists("failedHealthCheckItems", $this->_propDict)) {
            if (is_a($this->_propDict["failedHealthCheckItems"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcHealthCheckItem") || is_null($this->_propDict["failedHealthCheckItems"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcConnectivityStatus") || is_null($this->_propDict["status"])) {
