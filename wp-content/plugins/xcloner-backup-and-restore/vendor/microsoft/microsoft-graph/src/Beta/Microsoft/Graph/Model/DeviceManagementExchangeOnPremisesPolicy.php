...
class DeviceManagementExchangeOnPremisesPolicy extends Entity
{
    ...
    public function getDefaultAccessLevel()
    {
        if (array_key_exists("defaultAccessLevel", $this->_propDict)) {
            if (is_a($this->_propDict["defaultAccessLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementExchangeAccessLevel") || is_null($this->_propDict["defaultAccessLevel"])) {
    ...
    public function getNotificationContent()
    {
        if (array_key_exists("notificationContent", $this->_propDict)) {
            if (is_a($this->_propDict["notificationContent"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["notificationContent"])) {
                return $this->_propDict["notificationContent"];
            } else {
                $this->_propDict["notificationContent"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["notificationContent"]);
                return $this->_propDict["notificationContent"];
            }
        }
        return null;
