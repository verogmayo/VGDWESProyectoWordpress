...
* @link      https://graph.microsoft.com
*/
class ExternalActivity extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getType()
    {
        if (array_key_exists("type", $this->_propDict)) {
            if (is_a($this->_propDict["type"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\ExternalActivityType") || is_null($this->_propDict["type"])) {
    ...
    public function getPerformedBy()
    {
        if (array_key_exists("performedBy", $this->_propDict)) {
            if (is_a($this->_propDict["performedBy"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\Identity") || is_null($this->_propDict["performedBy"])) {
