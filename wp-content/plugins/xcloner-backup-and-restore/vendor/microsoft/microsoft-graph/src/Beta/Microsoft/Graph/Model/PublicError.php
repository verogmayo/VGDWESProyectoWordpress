...
class PublicError extends Entity
{
    ...
    public function getDetails()
    {
        if (array_key_exists("details", $this->_propDict)) {
            if (is_a($this->_propDict["details"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PublicErrorDetail") || is_null($this->_propDict["details"])) {
    ...
    public function getInnerError()
    {
        if (array_key_exists("innerError", $this->_propDict)) {
            if (is_a($this->_propDict["innerError"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PublicInnerError") || is_null($this->_propDict["innerError"])) {
