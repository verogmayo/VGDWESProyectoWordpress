...
class QualityUpdateReference extends WindowsUpdateReference
{
    ...
    public function getClassification()
    {
        if (array_key_exists("classification", $this->_propDict)) {
            if (is_a($this->_propDict["classification"], "XCloner\\Beta\\Microsoft\\Graph\\WindowsUpdates\\Model\\QualityUpdateClassification") || is_null($this->_propDict["classification"])) {
