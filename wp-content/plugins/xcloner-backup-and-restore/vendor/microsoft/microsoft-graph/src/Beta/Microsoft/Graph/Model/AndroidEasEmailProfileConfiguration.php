...
class AndroidEasEmailProfileConfiguration extends DeviceConfiguration
{
    ...
    public function getEmailSyncSchedule()
    {
        if (array_key_exists("emailSyncSchedule", $this->_propDict)) {
            if (is_a($this->_propDict["emailSyncSchedule"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EmailSyncSchedule") || is_null($this->_propDict["emailSyncSchedule"])) {
    ...
    public function getUserDomainNameSource()
    {
        if (array_key_exists("userDomainNameSource", $this->_propDict)) {
            if (is_a($this->_propDict["userDomainNameSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DomainNameSource") || is_null($this->_propDict["userDomainNameSource"])) {
    ...
    public function getUsernameSource()
    {
        if (array_key_exists("usernameSource", $this->_propDict)) {
            if (is_a($this->_propDict["usernameSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidUsernameSource") || is_null($this->_propDict["usernameSource"])) {
    ...
    public function getIdentityCertificate()
    {
        if (array_key_exists("identityCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidCertificateProfileBase") || is_null($this->_propDict["identityCertificate"])) {
    ...
    public function getSmimeSigningCertificate()
    {
        if (array_key_exists("smimeSigningCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["smimeSigningCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidCertificateProfileBase") || is_null($this->_propDict["smimeSigningCertificate"])) {
