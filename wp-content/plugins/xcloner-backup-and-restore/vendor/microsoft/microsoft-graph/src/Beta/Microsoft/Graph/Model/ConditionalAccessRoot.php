...
class ConditionalAccessRoot extends Entity
{
    ...
    public function getAuthenticationStrengths()
    {
        if (array_key_exists("authenticationStrengths", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationStrengths"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationStrengthRoot") || is_null($this->_propDict["authenticationStrengths"])) {
