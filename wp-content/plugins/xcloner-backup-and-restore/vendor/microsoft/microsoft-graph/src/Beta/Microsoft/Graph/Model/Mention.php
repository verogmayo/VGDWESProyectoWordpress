...
class Mention extends Entity
{
    ...
    public function getCreatedBy()
    {
        if (array_key_exists("createdBy", $this->_propDict)) {
            if (is_a($this->_propDict["createdBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EmailAddress") || is_null($this->_propDict["createdBy"])) {
    ...
    public function getMentioned()
    {
        if (array_key_exists("mentioned", $this->_propDict)) {
            if (is_a($this->_propDict["mentioned"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EmailAddress") || is_null($this->_propDict["mentioned"])) {
