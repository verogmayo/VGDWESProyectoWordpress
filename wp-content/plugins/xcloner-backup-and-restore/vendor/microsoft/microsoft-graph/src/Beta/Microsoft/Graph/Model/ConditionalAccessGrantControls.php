...
class ConditionalAccessGrantControls extends Entity
{
    ...
    public function getBuiltInControls()
    {
        if (array_key_exists("builtInControls", $this->_propDict)) {
            if (is_a($this->_propDict["builtInControls"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessGrantControl") || is_null($this->_propDict["builtInControls"])) {
    ...
    public function getAuthenticationStrength()
    {
        if (array_key_exists("authenticationStrength", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationStrength"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationStrengthPolicy") || is_null($this->_propDict["authenticationStrength"])) {
