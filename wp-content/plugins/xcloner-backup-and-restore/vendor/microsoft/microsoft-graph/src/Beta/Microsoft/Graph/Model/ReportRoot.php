...
class ReportRoot extends Entity
{
    ...
    public function getAuthenticationMethods()
    {
        if (array_key_exists("authenticationMethods", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethods"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationMethodsRoot") || is_null($this->_propDict["authenticationMethods"])) {
    ...
    public function getSecurity()
    {
        if (array_key_exists("security", $this->_propDict)) {
            if (is_a($this->_propDict["security"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SecurityReportsRoot") || is_null($this->_propDict["security"])) {
