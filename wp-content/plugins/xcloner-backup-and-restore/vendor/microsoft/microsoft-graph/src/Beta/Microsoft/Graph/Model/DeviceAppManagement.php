...
class DeviceAppManagement extends Entity
{
    ...
    public function getMicrosoftStoreForBusinessPortalSelection()
    {
        if (array_key_exists("microsoftStoreForBusinessPortalSelection", $this->_propDict)) {
            if (is_a($this->_propDict["microsoftStoreForBusinessPortalSelection"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MicrosoftStoreForBusinessPortalSelectionOptions") || is_null($this->_propDict["microsoftStoreForBusinessPortalSelection"])) {
    ...
    public function getSymantecCodeSigningCertificate()
    {
        if (array_key_exists("symantecCodeSigningCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["symantecCodeSigningCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SymantecCodeSigningCertificate") || is_null($this->_propDict["symantecCodeSigningCertificate"])) {
    ...
    public function getWindowsManagementApp()
    {
        if (array_key_exists("windowsManagementApp", $this->_propDict)) {
            if (is_a($this->_propDict["windowsManagementApp"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsManagementApp") || is_null($this->_propDict["windowsManagementApp"])) {
