...
class UserPFXCertificate extends Entity
{
    ...
    public function getEncryptedPfxBlob()
    {
        if (array_key_exists("encryptedPfxBlob", $this->_propDict)) {
            if (is_a($this->_propDict["encryptedPfxBlob"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["encryptedPfxBlob"])) {
                return $this->_propDict["encryptedPfxBlob"];
            } else {
                $this->_propDict["encryptedPfxBlob"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["encryptedPfxBlob"]);
                return $this->_propDict["encryptedPfxBlob"];
            }
        }
        return null;
    ...
    public function getIntendedPurpose()
    {
        if (array_key_exists("intendedPurpose", $this->_propDict)) {
            if (is_a($this->_propDict["intendedPurpose"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserPfxIntendedPurpose") || is_null($this->_propDict["intendedPurpose"])) {
    ...
    public function getPaddingScheme()
    {
        if (array_key_exists("paddingScheme", $this->_propDict)) {
            if (is_a($this->_propDict["paddingScheme"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserPfxPaddingScheme") || is_null($this->_propDict["paddingScheme"])) {
