...
class MobileAppInstallStatus extends Entity
{
    ...
    public function getMobileAppInstallStatusValue()
    {
        if (array_key_exists("mobileAppInstallStatusValue", $this->_propDict)) {
            if (is_a($this->_propDict["mobileAppInstallStatusValue"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ResultantAppState") || is_null($this->_propDict["mobileAppInstallStatusValue"])) {
    ...
    public function getApp()
    {
        if (array_key_exists("app", $this->_propDict)) {
            if (is_a($this->_propDict["app"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MobileApp") || is_null($this->_propDict["app"])) {
