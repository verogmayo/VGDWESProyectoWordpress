...
class DeviceRegistrationPolicy extends Entity
{
    ...
    public function getAzureADJoin()
    {
        if (array_key_exists("azureADJoin", $this->_propDict)) {
            if (is_a($this->_propDict["azureADJoin"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AzureAdJoinPolicy") || is_null($this->_propDict["azureADJoin"])) {
    ...
    public function getAzureADRegistration()
    {
        if (array_key_exists("azureADRegistration", $this->_propDict)) {
            if (is_a($this->_propDict["azureADRegistration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AzureADRegistrationPolicy") || is_null($this->_propDict["azureADRegistration"])) {
    ...
    public function getMultiFactorAuthConfiguration()
    {
        if (array_key_exists("multiFactorAuthConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["multiFactorAuthConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MultiFactorAuthConfiguration") || is_null($this->_propDict["multiFactorAuthConfiguration"])) {
