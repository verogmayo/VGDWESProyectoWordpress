...
* @link      https://graph.microsoft.com
*/
class LifecycleWorkflowsContainer extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getDeletedItems()
    {
        if (array_key_exists("deletedItems", $this->_propDict)) {
            if (is_a($this->_propDict["deletedItems"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeletedItemContainer") || is_null($this->_propDict["deletedItems"])) {
                return $this->_propDict["deletedItems"];
            } else {
                $this->_propDict["deletedItems"] = new \XCloner\Beta\Microsoft\Graph\Model\DeletedItemContainer($this->_propDict["deletedItems"]);
                return $this->_propDict["deletedItems"];
            }
        }
        return null;
    ...
    public function getSettings()
    {
        if (array_key_exists("settings", $this->_propDict)) {
            if (is_a($this->_propDict["settings"], "XCloner\\Beta\\Microsoft\\Graph\\IdentityGovernanceNamespace\\Model\\LifecycleManagementSettings") || is_null($this->_propDict["settings"])) {
