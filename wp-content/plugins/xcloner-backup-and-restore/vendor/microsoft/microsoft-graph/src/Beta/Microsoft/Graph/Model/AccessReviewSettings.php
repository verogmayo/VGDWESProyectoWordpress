...
class AccessReviewSettings extends Entity
{
    ...
    public function getAutoReviewSettings()
    {
        if (array_key_exists("autoReviewSettings", $this->_propDict)) {
            if (is_a($this->_propDict["autoReviewSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AutoReviewSettings") || is_null($this->_propDict["autoReviewSettings"])) {
    ...
    public function getRecurrenceSettings()
    {
        if (array_key_exists("recurrenceSettings", $this->_propDict)) {
            if (is_a($this->_propDict["recurrenceSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewRecurrenceSettings") || is_null($this->_propDict["recurrenceSettings"])) {
