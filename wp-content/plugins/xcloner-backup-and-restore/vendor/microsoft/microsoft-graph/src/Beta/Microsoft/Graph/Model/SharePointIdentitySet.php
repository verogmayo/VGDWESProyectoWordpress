...
class SharePointIdentitySet extends IdentitySet
{
    ...
    public function getSiteGroup()
    {
        if (array_key_exists("siteGroup", $this->_propDict)) {
            if (is_a($this->_propDict["siteGroup"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharePointIdentity") || is_null($this->_propDict["siteGroup"])) {
    ...
    public function getSiteUser()
    {
        if (array_key_exists("siteUser", $this->_propDict)) {
            if (is_a($this->_propDict["siteUser"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharePointIdentity") || is_null($this->_propDict["siteUser"])) {
