...
class MacOSEndpointProtectionConfiguration extends DeviceConfiguration
{
    ...
    public function getAdvancedThreatProtectionAutomaticSampleSubmission()
    {
        if (array_key_exists("advancedThreatProtectionAutomaticSampleSubmission", $this->_propDict)) {
            if (is_a($this->_propDict["advancedThreatProtectionAutomaticSampleSubmission"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["advancedThreatProtectionAutomaticSampleSubmission"])) {
    ...
    public function getAdvancedThreatProtectionCloudDelivered()
    {
        if (array_key_exists("advancedThreatProtectionCloudDelivered", $this->_propDict)) {
            if (is_a($this->_propDict["advancedThreatProtectionCloudDelivered"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["advancedThreatProtectionCloudDelivered"])) {
    ...
    public function getAdvancedThreatProtectionDiagnosticDataCollection()
    {
        if (array_key_exists("advancedThreatProtectionDiagnosticDataCollection", $this->_propDict)) {
            if (is_a($this->_propDict["advancedThreatProtectionDiagnosticDataCollection"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["advancedThreatProtectionDiagnosticDataCollection"])) {
    ...
    public function getAdvancedThreatProtectionRealTime()
    {
        if (array_key_exists("advancedThreatProtectionRealTime", $this->_propDict)) {
            if (is_a($this->_propDict["advancedThreatProtectionRealTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["advancedThreatProtectionRealTime"])) {
    ...
    public function getFileVaultInstitutionalRecoveryKeyCertificate()
    {
        if (array_key_exists("fileVaultInstitutionalRecoveryKeyCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["fileVaultInstitutionalRecoveryKeyCertificate"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["fileVaultInstitutionalRecoveryKeyCertificate"])) {
                return $this->_propDict["fileVaultInstitutionalRecoveryKeyCertificate"];
            } else {
                $this->_propDict["fileVaultInstitutionalRecoveryKeyCertificate"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["fileVaultInstitutionalRecoveryKeyCertificate"]);
                return $this->_propDict["fileVaultInstitutionalRecoveryKeyCertificate"];
            }
        }
        return null;
    ...
    public function getFileVaultSelectedRecoveryKeyTypes()
    {
        if (array_key_exists("fileVaultSelectedRecoveryKeyTypes", $this->_propDict)) {
            if (is_a($this->_propDict["fileVaultSelectedRecoveryKeyTypes"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSFileVaultRecoveryKeyTypes") || is_null($this->_propDict["fileVaultSelectedRecoveryKeyTypes"])) {
    ...
    public function getGatekeeperAllowedAppSource()
    {
        if (array_key_exists("gatekeeperAllowedAppSource", $this->_propDict)) {
            if (is_a($this->_propDict["gatekeeperAllowedAppSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSGatekeeperAppSources") || is_null($this->_propDict["gatekeeperAllowedAppSource"])) {
