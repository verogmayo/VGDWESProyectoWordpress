...
* @link      https://graph.microsoft.com
*/
class Settings extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getIdleSessionSignOut()
    {
        if (array_key_exists("idleSessionSignOut", $this->_propDict)) {
            if (is_a($this->_propDict["idleSessionSignOut"], "XCloner\\Beta\\Microsoft\\Graph\\TenantAdmin\\Model\\IdleSessionSignOut") || is_null($this->_propDict["idleSessionSignOut"])) {
    ...
    public function getImageTaggingOption()
    {
        if (array_key_exists("imageTaggingOption", $this->_propDict)) {
            if (is_a($this->_propDict["imageTaggingOption"], "XCloner\\Beta\\Microsoft\\Graph\\TenantAdmin\\Model\\ImageTaggingChoice") || is_null($this->_propDict["imageTaggingOption"])) {
    ...
    public function getSharingCapability()
    {
        if (array_key_exists("sharingCapability", $this->_propDict)) {
            if (is_a($this->_propDict["sharingCapability"], "XCloner\\Beta\\Microsoft\\Graph\\TenantAdmin\\Model\\SharingCapabilities") || is_null($this->_propDict["sharingCapability"])) {
    ...
    public function getSharingDomainRestrictionMode()
    {
        if (array_key_exists("sharingDomainRestrictionMode", $this->_propDict)) {
            if (is_a($this->_propDict["sharingDomainRestrictionMode"], "XCloner\\Beta\\Microsoft\\Graph\\TenantAdmin\\Model\\SharingDomainRestrictionMode") || is_null($this->_propDict["sharingDomainRestrictionMode"])) {
