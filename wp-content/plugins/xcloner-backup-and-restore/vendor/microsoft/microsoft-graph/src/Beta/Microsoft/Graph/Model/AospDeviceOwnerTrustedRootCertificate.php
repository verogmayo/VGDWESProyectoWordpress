...
* 
* AospDeviceOwnerTrustedRootCertificate File
* PHP version 7
*
* @category  Library
...
/**
* AospDeviceOwnerTrustedRootCertificate class
*
* @category  Model
* @package   Microsoft.Graph
* @copyright (c) Microsoft Corporation. All rights reserved.
...
* @link      https://graph.microsoft.com
*/
class AospDeviceOwnerTrustedRootCertificate extends DeviceConfiguration
{
    /**
