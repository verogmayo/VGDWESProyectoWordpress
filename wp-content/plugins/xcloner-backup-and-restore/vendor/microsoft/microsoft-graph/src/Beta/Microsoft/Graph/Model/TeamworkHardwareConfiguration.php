...
class TeamworkHardwareConfiguration extends Entity
{
    ...
    public function getCompute()
    {
        if (array_key_exists("compute", $this->_propDict)) {
            if (is_a($this->_propDict["compute"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkPeripheral") || is_null($this->_propDict["compute"])) {
    ...
    public function getHdmiIngest()
    {
        if (array_key_exists("hdmiIngest", $this->_propDict)) {
            if (is_a($this->_propDict["hdmiIngest"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkPeripheral") || is_null($this->_propDict["hdmiIngest"])) {
