...
class ConditionalAccessRuleSatisfied extends Entity
{
    ...
    public function getConditionalAccessCondition()
    {
        if (array_key_exists("conditionalAccessCondition", $this->_propDict)) {
            if (is_a($this->_propDict["conditionalAccessCondition"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessConditions") || is_null($this->_propDict["conditionalAccessCondition"])) {
    ...
    public function getRuleSatisfied()
    {
        if (array_key_exists("ruleSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["ruleSatisfied"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessRule") || is_null($this->_propDict["ruleSatisfied"])) {
