...
class AutomaticRepliesMailTips extends Entity
{
    ...
    public function getMessageLanguage()
    {
        if (array_key_exists("messageLanguage", $this->_propDict)) {
            if (is_a($this->_propDict["messageLanguage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\LocaleInfo") || is_null($this->_propDict["messageLanguage"])) {
    ...
    public function getScheduledEndTime()
    {
        if (array_key_exists("scheduledEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledEndTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DateTimeTimeZone") || is_null($this->_propDict["scheduledEndTime"])) {
    ...
    public function getScheduledStartTime()
    {
        if (array_key_exists("scheduledStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["scheduledStartTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DateTimeTimeZone") || is_null($this->_propDict["scheduledStartTime"])) {
