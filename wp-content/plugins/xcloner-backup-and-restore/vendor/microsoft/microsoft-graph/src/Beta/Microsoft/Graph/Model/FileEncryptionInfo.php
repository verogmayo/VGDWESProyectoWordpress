...
class FileEncryptionInfo extends Entity
{
    ...
    public function getEncryptionKey()
    {
        if (array_key_exists("encryptionKey", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionKey"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["encryptionKey"])) {
                return $this->_propDict["encryptionKey"];
            } else {
                $this->_propDict["encryptionKey"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["encryptionKey"]);
                return $this->_propDict["encryptionKey"];
            }
        }
        return null;
    ...
    public function getFileDigest()
    {
        if (array_key_exists("fileDigest", $this->_propDict)) {
            if (is_a($this->_propDict["fileDigest"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["fileDigest"])) {
                return $this->_propDict["fileDigest"];
            } else {
                $this->_propDict["fileDigest"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["fileDigest"]);
                return $this->_propDict["fileDigest"];
            }
        }
        return null;
    ...
    public function getInitializationVector()
    {
        if (array_key_exists("initializationVector", $this->_propDict)) {
            if (is_a($this->_propDict["initializationVector"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["initializationVector"])) {
                return $this->_propDict["initializationVector"];
            } else {
                $this->_propDict["initializationVector"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["initializationVector"]);
                return $this->_propDict["initializationVector"];
            }
        }
        return null;
    ...
    public function getMac()
    {
        if (array_key_exists("mac", $this->_propDict)) {
            if (is_a($this->_propDict["mac"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["mac"])) {
                return $this->_propDict["mac"];
            } else {
                $this->_propDict["mac"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["mac"]);
                return $this->_propDict["mac"];
            }
        }
        return null;
    ...
    public function getMacKey()
    {
        if (array_key_exists("macKey", $this->_propDict)) {
            if (is_a($this->_propDict["macKey"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["macKey"])) {
                return $this->_propDict["macKey"];
            } else {
                $this->_propDict["macKey"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["macKey"]);
                return $this->_propDict["macKey"];
            }
        }
        return null;
