...
class AccessPackageResource extends Entity
{
    ...
    public function getAccessPackageResourceEnvironment()
    {
        if (array_key_exists("accessPackageResourceEnvironment", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackageResourceEnvironment"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageResourceEnvironment") || is_null($this->_propDict["accessPackageResourceEnvironment"])) {
