...
* @link      https://graph.microsoft.com
*/
class Set extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getParentGroup()
    {
        if (array_key_exists("parentGroup", $this->_propDict)) {
            if (is_a($this->_propDict["parentGroup"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Group") || is_null($this->_propDict["parentGroup"])) {
