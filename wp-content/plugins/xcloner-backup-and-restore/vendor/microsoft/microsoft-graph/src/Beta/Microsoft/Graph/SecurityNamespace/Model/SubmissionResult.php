...
* @link      https://graph.microsoft.com
*/
class SubmissionResult extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the category
    ...
    public function getCategory()
    {
        if (array_key_exists("category", $this->_propDict)) {
            if (is_a($this->_propDict["category"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\SubmissionResultCategory") || is_null($this->_propDict["category"])) {
    ...
    public function getDetail()
    {
        if (array_key_exists("detail", $this->_propDict)) {
            if (is_a($this->_propDict["detail"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\SubmissionResultDetail") || is_null($this->_propDict["detail"])) {
    ...
    public function getDetectedFiles()
    {
        if (array_key_exists("detectedFiles", $this->_propDict)) {
            if (is_a($this->_propDict["detectedFiles"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\SubmissionDetectedFile") || is_null($this->_propDict["detectedFiles"])) {
    ...
    public function getUserMailboxSetting()
    {
        if (array_key_exists("userMailboxSetting", $this->_propDict)) {
            if (is_a($this->_propDict["userMailboxSetting"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\UserMailboxSetting") || is_null($this->_propDict["userMailboxSetting"])) {
