...
class MacOSSoftwareUpdateConfiguration extends DeviceConfiguration
{
    ...
    public function getAllOtherUpdateBehavior()
    {
        if (array_key_exists("allOtherUpdateBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["allOtherUpdateBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSSoftwareUpdateBehavior") || is_null($this->_propDict["allOtherUpdateBehavior"])) {
    ...
    public function getConfigDataUpdateBehavior()
    {
        if (array_key_exists("configDataUpdateBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["configDataUpdateBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSSoftwareUpdateBehavior") || is_null($this->_propDict["configDataUpdateBehavior"])) {
    ...
    public function getCriticalUpdateBehavior()
    {
        if (array_key_exists("criticalUpdateBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["criticalUpdateBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSSoftwareUpdateBehavior") || is_null($this->_propDict["criticalUpdateBehavior"])) {
    ...
    public function getFirmwareUpdateBehavior()
    {
        if (array_key_exists("firmwareUpdateBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["firmwareUpdateBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSSoftwareUpdateBehavior") || is_null($this->_propDict["firmwareUpdateBehavior"])) {
    ...
    public function getUpdateScheduleType()
    {
        if (array_key_exists("updateScheduleType", $this->_propDict)) {
            if (is_a($this->_propDict["updateScheduleType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSSoftwareUpdateScheduleType") || is_null($this->_propDict["updateScheduleType"])) {
