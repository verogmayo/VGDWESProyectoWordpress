...
class VpnOnDemandRule extends Entity
{
    ...
    public function getAction()
    {
        if (array_key_exists("action", $this->_propDict)) {
            if (is_a($this->_propDict["action"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnOnDemandRuleConnectionAction") || is_null($this->_propDict["action"])) {
    ...
    public function getDomainAction()
    {
        if (array_key_exists("domainAction", $this->_propDict)) {
            if (is_a($this->_propDict["domainAction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnOnDemandRuleConnectionDomainAction") || is_null($this->_propDict["domainAction"])) {
    ...
    public function getInterfaceTypeMatch()
    {
        if (array_key_exists("interfaceTypeMatch", $this->_propDict)) {
            if (is_a($this->_propDict["interfaceTypeMatch"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnOnDemandRuleInterfaceTypeMatch") || is_null($this->_propDict["interfaceTypeMatch"])) {
