...
class DeviceCustomAttributeShellScript extends Entity
{
    ...
    public function getCustomAttributeType()
    {
        if (array_key_exists("customAttributeType", $this->_propDict)) {
            if (is_a($this->_propDict["customAttributeType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceCustomAttributeValueType") || is_null($this->_propDict["customAttributeType"])) {
