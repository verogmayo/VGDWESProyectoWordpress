...
* @link      https://graph.microsoft.com
*/
class AlertRule extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getThreshold()
    {
        if (array_key_exists("threshold", $this->_propDict)) {
            if (is_a($this->_propDict["threshold"], "XCloner\\Beta\\Microsoft\\Graph\\DeviceManagementNamespace\\Model\\RuleThreshold") || is_null($this->_propDict["threshold"])) {
