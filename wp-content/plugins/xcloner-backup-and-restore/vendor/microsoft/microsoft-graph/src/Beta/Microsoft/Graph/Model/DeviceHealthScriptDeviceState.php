...
class DeviceHealthScriptDeviceState extends Entity
{
    ...
    public function getDetectionState()
    {
        if (array_key_exists("detectionState", $this->_propDict)) {
            if (is_a($this->_propDict["detectionState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RunState") || is_null($this->_propDict["detectionState"])) {
    ...
    public function getRemediationState()
    {
        if (array_key_exists("remediationState", $this->_propDict)) {
            if (is_a($this->_propDict["remediationState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RemediationState") || is_null($this->_propDict["remediationState"])) {
