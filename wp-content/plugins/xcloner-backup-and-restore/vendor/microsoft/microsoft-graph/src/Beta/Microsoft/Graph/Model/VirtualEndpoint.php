...
class VirtualEndpoint extends Entity
{
    ...
    public function getOrganizationSettings()
    {
        if (array_key_exists("organizationSettings", $this->_propDict)) {
            if (is_a($this->_propDict["organizationSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcOrganizationSettings") || is_null($this->_propDict["organizationSettings"])) {
    ...
    public function getReports()
    {
        if (array_key_exists("reports", $this->_propDict)) {
            if (is_a($this->_propDict["reports"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcReports") || is_null($this->_propDict["reports"])) {
