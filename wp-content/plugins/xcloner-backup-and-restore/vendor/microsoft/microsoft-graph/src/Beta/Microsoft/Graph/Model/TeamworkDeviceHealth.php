...
class TeamworkDeviceHealth extends Entity
{
    ...
    public function getHardwareHealth()
    {
        if (array_key_exists("hardwareHealth", $this->_propDict)) {
            if (is_a($this->_propDict["hardwareHealth"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkHardwareHealth") || is_null($this->_propDict["hardwareHealth"])) {
    ...
    public function getLoginStatus()
    {
        if (array_key_exists("loginStatus", $this->_propDict)) {
            if (is_a($this->_propDict["loginStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkLoginStatus") || is_null($this->_propDict["loginStatus"])) {
    ...
    public function getPeripheralsHealth()
    {
        if (array_key_exists("peripheralsHealth", $this->_propDict)) {
            if (is_a($this->_propDict["peripheralsHealth"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkPeripheralsHealth") || is_null($this->_propDict["peripheralsHealth"])) {
    ...
    public function getSoftwareUpdateHealth()
    {
        if (array_key_exists("softwareUpdateHealth", $this->_propDict)) {
            if (is_a($this->_propDict["softwareUpdateHealth"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkSoftwareUpdateHealth") || is_null($this->_propDict["softwareUpdateHealth"])) {
