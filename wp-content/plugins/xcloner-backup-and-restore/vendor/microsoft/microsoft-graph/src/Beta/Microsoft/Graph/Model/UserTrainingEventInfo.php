...
class UserTrainingEventInfo extends Entity
{
    ...
    public function getLatestTrainingStatus()
    {
        if (array_key_exists("latestTrainingStatus", $this->_propDict)) {
            if (is_a($this->_propDict["latestTrainingStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TrainingStatus") || is_null($this->_propDict["latestTrainingStatus"])) {
    ...
    public function getTrainingAssignedProperties()
    {
        if (array_key_exists("trainingAssignedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["trainingAssignedProperties"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserTrainingContentEventInfo") || is_null($this->_propDict["trainingAssignedProperties"])) {
    ...
    public function getTrainingCompletedProperties()
    {
        if (array_key_exists("trainingCompletedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["trainingCompletedProperties"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserTrainingContentEventInfo") || is_null($this->_propDict["trainingCompletedProperties"])) {
    ...
    public function getTrainingUpdatedProperties()
    {
        if (array_key_exists("trainingUpdatedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["trainingUpdatedProperties"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserTrainingContentEventInfo") || is_null($this->_propDict["trainingUpdatedProperties"])) {
