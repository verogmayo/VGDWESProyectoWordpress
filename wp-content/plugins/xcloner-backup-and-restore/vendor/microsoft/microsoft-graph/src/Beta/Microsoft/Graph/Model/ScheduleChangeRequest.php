...
class ScheduleChangeRequest extends ChangeTrackedEntity
{
    ...
    public function getAssignedTo()
    {
        if (array_key_exists("assignedTo", $this->_propDict)) {
            if (is_a($this->_propDict["assignedTo"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ScheduleChangeRequestActor") || is_null($this->_propDict["assignedTo"])) {
    ...
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ScheduleChangeState") || is_null($this->_propDict["state"])) {
