...
class TargetedManagedAppProtection extends ManagedAppProtection
{
    ...
    public function getAppGroupType()
    {
        if (array_key_exists("appGroupType", $this->_propDict)) {
            if (is_a($this->_propDict["appGroupType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TargetedManagedAppGroupType") || is_null($this->_propDict["appGroupType"])) {
    ...
    public function getTargetedAppManagementLevels()
    {
        if (array_key_exists("targetedAppManagementLevels", $this->_propDict)) {
            if (is_a($this->_propDict["targetedAppManagementLevels"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AppManagementLevel") || is_null($this->_propDict["targetedAppManagementLevels"])) {
