...
class DeviceManagementIntent extends Entity
{
    ...
    public function getDeviceStateSummary()
    {
        if (array_key_exists("deviceStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceStateSummary"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementIntentDeviceStateSummary") || is_null($this->_propDict["deviceStateSummary"])) {
    ...
    public function getUserStateSummary()
    {
        if (array_key_exists("userStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["userStateSummary"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementIntentUserStateSummary") || is_null($this->_propDict["userStateSummary"])) {
