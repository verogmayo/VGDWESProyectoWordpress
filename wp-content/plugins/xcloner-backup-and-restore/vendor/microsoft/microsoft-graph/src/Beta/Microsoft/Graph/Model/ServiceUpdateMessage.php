...
class ServiceUpdateMessage extends ServiceAnnouncementBase
{
    ...
    public function getAttachmentsArchive()
    {
        if (array_key_exists("attachmentsArchive", $this->_propDict)) {
            if (is_a($this->_propDict["attachmentsArchive"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["attachmentsArchive"])) {
                return $this->_propDict["attachmentsArchive"];
            } else {
                $this->_propDict["attachmentsArchive"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["attachmentsArchive"]);
                return $this->_propDict["attachmentsArchive"];
            }
        }
        return null;
    ...
    public function getCategory()
    {
        if (array_key_exists("category", $this->_propDict)) {
            if (is_a($this->_propDict["category"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ServiceUpdateCategory") || is_null($this->_propDict["category"])) {
    ...
    public function getSeverity()
    {
        if (array_key_exists("severity", $this->_propDict)) {
            if (is_a($this->_propDict["severity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ServiceUpdateSeverity") || is_null($this->_propDict["severity"])) {
    ...
    public function getViewPoint()
    {
        if (array_key_exists("viewPoint", $this->_propDict)) {
            if (is_a($this->_propDict["viewPoint"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ServiceUpdateMessageViewpoint") || is_null($this->_propDict["viewPoint"])) {
