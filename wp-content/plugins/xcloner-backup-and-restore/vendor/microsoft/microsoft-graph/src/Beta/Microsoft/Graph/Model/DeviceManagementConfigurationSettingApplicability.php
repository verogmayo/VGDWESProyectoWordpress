...
class DeviceManagementConfigurationSettingApplicability extends Entity
{
    ...
    public function getDeviceMode()
    {
        if (array_key_exists("deviceMode", $this->_propDict)) {
            if (is_a($this->_propDict["deviceMode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementConfigurationDeviceMode") || is_null($this->_propDict["deviceMode"])) {
    ...
    public function getPlatform()
    {
        if (array_key_exists("platform", $this->_propDict)) {
            if (is_a($this->_propDict["platform"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementConfigurationPlatforms") || is_null($this->_propDict["platform"])) {
