...
class PrintJob extends Entity
{
    ...
    public function getConfiguration()
    {
        if (array_key_exists("configuration", $this->_propDict)) {
            if (is_a($this->_propDict["configuration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrintJobConfiguration") || is_null($this->_propDict["configuration"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrintJobStatus") || is_null($this->_propDict["status"])) {
