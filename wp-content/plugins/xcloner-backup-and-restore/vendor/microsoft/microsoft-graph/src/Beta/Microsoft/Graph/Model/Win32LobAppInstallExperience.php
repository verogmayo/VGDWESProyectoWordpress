...
class Win32LobAppInstallExperience extends Entity
{
    ...
    public function getDeviceRestartBehavior()
    {
        if (array_key_exists("deviceRestartBehavior", $this->_propDict)) {
            if (is_a($this->_propDict["deviceRestartBehavior"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Win32LobAppRestartBehavior") || is_null($this->_propDict["deviceRestartBehavior"])) {
