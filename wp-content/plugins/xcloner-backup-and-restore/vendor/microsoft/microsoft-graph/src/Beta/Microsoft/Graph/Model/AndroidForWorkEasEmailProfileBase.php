...
class AndroidForWorkEasEmailProfileBase extends DeviceConfiguration
{
    ...
    public function getIdentityCertificate()
    {
        if (array_key_exists("identityCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidForWorkCertificateProfileBase") || is_null($this->_propDict["identityCertificate"])) {
