...
* @link      https://graph.microsoft.com
*/
class GraphCase extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\CaseStatus") || is_null($this->_propDict["status"])) {
