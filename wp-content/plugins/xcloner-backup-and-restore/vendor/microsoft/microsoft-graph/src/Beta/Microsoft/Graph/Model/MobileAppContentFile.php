...
class MobileAppContentFile extends Entity
{
    ...
    public function getManifest()
    {
        if (array_key_exists("manifest", $this->_propDict)) {
            if (is_a($this->_propDict["manifest"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["manifest"])) {
                return $this->_propDict["manifest"];
            } else {
                $this->_propDict["manifest"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["manifest"]);
                return $this->_propDict["manifest"];
            }
        }
        return null;
    ...
    public function getUploadState()
    {
        if (array_key_exists("uploadState", $this->_propDict)) {
            if (is_a($this->_propDict["uploadState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MobileAppContentFileUploadState") || is_null($this->_propDict["uploadState"])) {
