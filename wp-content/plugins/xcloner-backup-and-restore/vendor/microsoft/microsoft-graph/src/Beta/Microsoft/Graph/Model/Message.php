...
class Message extends OutlookItem
{
    ...
    public function getConversationIndex()
    {
        if (array_key_exists("conversationIndex", $this->_propDict)) {
            if (is_a($this->_propDict["conversationIndex"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["conversationIndex"])) {
                return $this->_propDict["conversationIndex"];
            } else {
                $this->_propDict["conversationIndex"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["conversationIndex"]);
                return $this->_propDict["conversationIndex"];
            }
        }
        return null;
    ...
    public function getFrom()
    {
        if (array_key_exists("from", $this->_propDict)) {
            if (is_a($this->_propDict["from"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["from"])) {
    ...
    public function getInferenceClassification()
    {
        if (array_key_exists("inferenceClassification", $this->_propDict)) {
            if (is_a($this->_propDict["inferenceClassification"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InferenceClassificationType") || is_null($this->_propDict["inferenceClassification"])) {
    ...
    public function getMentionsPreview()
    {
        if (array_key_exists("mentionsPreview", $this->_propDict)) {
            if (is_a($this->_propDict["mentionsPreview"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MentionsPreview") || is_null($this->_propDict["mentionsPreview"])) {
    ...
    public function getSender()
    {
        if (array_key_exists("sender", $this->_propDict)) {
            if (is_a($this->_propDict["sender"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Recipient") || is_null($this->_propDict["sender"])) {
    ...
    public function getUniqueBody()
    {
        if (array_key_exists("uniqueBody", $this->_propDict)) {
            if (is_a($this->_propDict["uniqueBody"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ItemBody") || is_null($this->_propDict["uniqueBody"])) {
