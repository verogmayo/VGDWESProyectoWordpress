...
* @link      https://graph.microsoft.com
*/
class UserFeedback extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the rating
    ...
    public function getRating()
    {
        if (array_key_exists("rating", $this->_propDict)) {
            if (is_a($this->_propDict["rating"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\UserFeedbackRating") || is_null($this->_propDict["rating"])) {
    ...
    public function getTokens()
    {
        if (array_key_exists("tokens", $this->_propDict)) {
            if (is_a($this->_propDict["tokens"], "XCloner\\Beta\\Microsoft\\Graph\\CallRecords\\Model\\FeedbackTokenSet") || is_null($this->_propDict["tokens"])) {
