...
class PrinterBase extends Entity
{
    ...
    public function getCapabilities()
    {
        if (array_key_exists("capabilities", $this->_propDict)) {
            if (is_a($this->_propDict["capabilities"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrinterCapabilities") || is_null($this->_propDict["capabilities"])) {
    ...
    public function getDefaults()
    {
        if (array_key_exists("defaults", $this->_propDict)) {
            if (is_a($this->_propDict["defaults"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrinterDefaults") || is_null($this->_propDict["defaults"])) {
    ...
    public function getLocation()
    {
        if (array_key_exists("location", $this->_propDict)) {
            if (is_a($this->_propDict["location"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrinterLocation") || is_null($this->_propDict["location"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrinterStatus") || is_null($this->_propDict["status"])) {
