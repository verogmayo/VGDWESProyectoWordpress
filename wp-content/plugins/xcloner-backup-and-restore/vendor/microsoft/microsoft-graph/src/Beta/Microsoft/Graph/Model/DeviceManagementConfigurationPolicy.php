...
class DeviceManagementConfigurationPolicy extends Entity
{
    ...
    public function getPriorityMetaData()
    {
        if (array_key_exists("priorityMetaData", $this->_propDict)) {
            if (is_a($this->_propDict["priorityMetaData"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementPriorityMetaData") || is_null($this->_propDict["priorityMetaData"])) {
    ...
    public function getTemplateReference()
    {
        if (array_key_exists("templateReference", $this->_propDict)) {
            if (is_a($this->_propDict["templateReference"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementConfigurationPolicyTemplateReference") || is_null($this->_propDict["templateReference"])) {
