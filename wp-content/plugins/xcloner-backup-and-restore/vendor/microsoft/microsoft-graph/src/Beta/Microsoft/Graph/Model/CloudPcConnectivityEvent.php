...
class CloudPcConnectivityEvent extends Entity
{
    ...
    public function getEventResult()
    {
        if (array_key_exists("eventResult", $this->_propDict)) {
            if (is_a($this->_propDict["eventResult"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcConnectivityEventResult") || is_null($this->_propDict["eventResult"])) {
    ...
    public function getEventType()
    {
        if (array_key_exists("eventType", $this->_propDict)) {
            if (is_a($this->_propDict["eventType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CloudPcConnectivityEventType") || is_null($this->_propDict["eventType"])) {
