...
class AccessPackageSubject extends Entity
{
    ...
    public function getSubjectLifecycle()
    {
        if (array_key_exists("subjectLifecycle", $this->_propDict)) {
            if (is_a($this->_propDict["subjectLifecycle"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageSubjectLifecycle") || is_null($this->_propDict["subjectLifecycle"])) {
    ...
    public function getConnectedOrganization()
    {
        if (array_key_exists("connectedOrganization", $this->_propDict)) {
            if (is_a($this->_propDict["connectedOrganization"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConnectedOrganization") || is_null($this->_propDict["connectedOrganization"])) {
