...
class AuthenticationMethodsRegistrationCampaign extends Entity
{
    ...
    public function getExcludeTargets()
    {
        if (array_key_exists("excludeTargets", $this->_propDict)) {
            if (is_a($this->_propDict["excludeTargets"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ExcludeTarget") || is_null($this->_propDict["excludeTargets"])) {
    ...
    public function getIncludeTargets()
    {
        if (array_key_exists("includeTargets", $this->_propDict)) {
            if (is_a($this->_propDict["includeTargets"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationMethodsRegistrationCampaignIncludeTarget") || is_null($this->_propDict["includeTargets"])) {
