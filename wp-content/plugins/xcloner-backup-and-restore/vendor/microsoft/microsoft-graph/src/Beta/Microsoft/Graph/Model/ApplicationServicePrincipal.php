...
class ApplicationServicePrincipal extends Entity
{
    ...
    public function getApplication()
    {
        if (array_key_exists("application", $this->_propDict)) {
            if (is_a($this->_propDict["application"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Application") || is_null($this->_propDict["application"])) {
    ...
    public function getServicePrincipal()
    {
        if (array_key_exists("servicePrincipal", $this->_propDict)) {
            if (is_a($this->_propDict["servicePrincipal"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ServicePrincipal") || is_null($this->_propDict["servicePrincipal"])) {
