...
class ManagedDeviceOverview extends Entity
{
    ...
    public function getDeviceExchangeAccessStateSummary()
    {
        if (array_key_exists("deviceExchangeAccessStateSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceExchangeAccessStateSummary"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceExchangeAccessStateSummary") || is_null($this->_propDict["deviceExchangeAccessStateSummary"])) {
    ...
    public function getDeviceOperatingSystemSummary()
    {
        if (array_key_exists("deviceOperatingSystemSummary", $this->_propDict)) {
            if (is_a($this->_propDict["deviceOperatingSystemSummary"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceOperatingSystemSummary") || is_null($this->_propDict["deviceOperatingSystemSummary"])) {
    ...
    public function getManagedDeviceModelsAndManufacturers()
    {
        if (array_key_exists("managedDeviceModelsAndManufacturers", $this->_propDict)) {
            if (is_a($this->_propDict["managedDeviceModelsAndManufacturers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ManagedDeviceModelsAndManufacturers") || is_null($this->_propDict["managedDeviceModelsAndManufacturers"])) {
