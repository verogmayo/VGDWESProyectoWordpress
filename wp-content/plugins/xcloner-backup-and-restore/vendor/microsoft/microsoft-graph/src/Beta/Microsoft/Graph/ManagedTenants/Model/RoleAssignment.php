...
* @link      https://graph.microsoft.com
*/
class RoleAssignment extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getAssignmentType()
    {
        if (array_key_exists("assignmentType", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentType"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\DelegatedPrivilegeStatus") || is_null($this->_propDict["assignmentType"])) {
    ...
    public function getRoles()
    {
        if (array_key_exists("roles", $this->_propDict)) {
            if (is_a($this->_propDict["roles"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\RoleDefinition") || is_null($this->_propDict["roles"])) {
