...
class AndroidDeviceOwnerVpnConfiguration extends VpnConfiguration
{
    ...
    public function getConnectionType()
    {
        if (array_key_exists("connectionType", $this->_propDict)) {
            if (is_a($this->_propDict["connectionType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidVpnConnectionType") || is_null($this->_propDict["connectionType"])) {
    ...
    public function getIdentityCertificate()
    {
        if (array_key_exists("identityCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidDeviceOwnerCertificateProfileBase") || is_null($this->_propDict["identityCertificate"])) {
