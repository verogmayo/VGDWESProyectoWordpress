...
class PolicySetItem extends Entity
{
    ...
    public function getErrorCode()
    {
        if (array_key_exists("errorCode", $this->_propDict)) {
            if (is_a($this->_propDict["errorCode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ErrorCode") || is_null($this->_propDict["errorCode"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PolicySetStatus") || is_null($this->_propDict["status"])) {
