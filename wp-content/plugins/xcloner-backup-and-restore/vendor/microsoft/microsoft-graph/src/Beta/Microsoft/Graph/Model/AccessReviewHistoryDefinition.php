...
class AccessReviewHistoryDefinition extends Entity
{
    ...
    public function getCreatedBy()
    {
        if (array_key_exists("createdBy", $this->_propDict)) {
            if (is_a($this->_propDict["createdBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserIdentity") || is_null($this->_propDict["createdBy"])) {
    ...
    public function getScheduleSettings()
    {
        if (array_key_exists("scheduleSettings", $this->_propDict)) {
            if (is_a($this->_propDict["scheduleSettings"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewHistoryScheduleSettings") || is_null($this->_propDict["scheduleSettings"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewHistoryStatus") || is_null($this->_propDict["status"])) {
