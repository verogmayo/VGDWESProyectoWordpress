...
class AccessPackageAssignmentRequest extends Entity
{
    ...
    public function getAccessPackageAssignment()
    {
        if (array_key_exists("accessPackageAssignment", $this->_propDict)) {
            if (is_a($this->_propDict["accessPackageAssignment"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageAssignment") || is_null($this->_propDict["accessPackageAssignment"])) {
    ...
    public function getRequestor()
    {
        if (array_key_exists("requestor", $this->_propDict)) {
            if (is_a($this->_propDict["requestor"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessPackageSubject") || is_null($this->_propDict["requestor"])) {
