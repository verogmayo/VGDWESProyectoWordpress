...
class ConditionalAccessGuestsOrExternalUsers extends Entity
{
    ...
    public function getExternalTenants()
    {
        if (array_key_exists("externalTenants", $this->_propDict)) {
            if (is_a($this->_propDict["externalTenants"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessExternalTenants") || is_null($this->_propDict["externalTenants"])) {
    ...
    public function getGuestOrExternalUserTypes()
    {
        if (array_key_exists("guestOrExternalUserTypes", $this->_propDict)) {
            if (is_a($this->_propDict["guestOrExternalUserTypes"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessGuestOrExternalUserTypes") || is_null($this->_propDict["guestOrExternalUserTypes"])) {
