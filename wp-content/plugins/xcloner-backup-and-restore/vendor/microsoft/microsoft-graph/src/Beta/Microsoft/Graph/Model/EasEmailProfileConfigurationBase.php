...
class EasEmailProfileConfigurationBase extends DeviceConfiguration
{
    ...
    public function getUsernameAADSource()
    {
        if (array_key_exists("usernameAADSource", $this->_propDict)) {
            if (is_a($this->_propDict["usernameAADSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UsernameSource") || is_null($this->_propDict["usernameAADSource"])) {
    ...
    public function getUsernameSource()
    {
        if (array_key_exists("usernameSource", $this->_propDict)) {
            if (is_a($this->_propDict["usernameSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserEmailSource") || is_null($this->_propDict["usernameSource"])) {
