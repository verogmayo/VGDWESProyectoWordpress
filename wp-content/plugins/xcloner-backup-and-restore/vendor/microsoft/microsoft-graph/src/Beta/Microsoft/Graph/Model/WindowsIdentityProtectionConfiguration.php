...
class WindowsIdentityProtectionConfiguration extends DeviceConfiguration
{
    ...
    public function getPinLowercaseCharactersUsage()
    {
        if (array_key_exists("pinLowercaseCharactersUsage", $this->_propDict)) {
            if (is_a($this->_propDict["pinLowercaseCharactersUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["pinLowercaseCharactersUsage"])) {
    ...
    public function getPinSpecialCharactersUsage()
    {
        if (array_key_exists("pinSpecialCharactersUsage", $this->_propDict)) {
            if (is_a($this->_propDict["pinSpecialCharactersUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["pinSpecialCharactersUsage"])) {
    ...
    public function getPinUppercaseCharactersUsage()
    {
        if (array_key_exists("pinUppercaseCharactersUsage", $this->_propDict)) {
            if (is_a($this->_propDict["pinUppercaseCharactersUsage"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfigurationUsage") || is_null($this->_propDict["pinUppercaseCharactersUsage"])) {
