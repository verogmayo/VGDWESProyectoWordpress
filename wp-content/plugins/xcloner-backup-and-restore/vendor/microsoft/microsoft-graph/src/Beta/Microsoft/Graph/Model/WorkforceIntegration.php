...
class WorkforceIntegration extends ChangeTrackedEntity
{
    ...
    public function getEligibilityFilteringEnabledEntities()
    {
        if (array_key_exists("eligibilityFilteringEnabledEntities", $this->_propDict)) {
            if (is_a($this->_propDict["eligibilityFilteringEnabledEntities"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EligibilityFilteringEnabledEntities") || is_null($this->_propDict["eligibilityFilteringEnabledEntities"])) {
    ...
    public function getEncryption()
    {
        if (array_key_exists("encryption", $this->_propDict)) {
            if (is_a($this->_propDict["encryption"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WorkforceIntegrationEncryption") || is_null($this->_propDict["encryption"])) {
    ...
    public function getSupportedEntities()
    {
        if (array_key_exists("supportedEntities", $this->_propDict)) {
            if (is_a($this->_propDict["supportedEntities"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WorkforceIntegrationSupportedEntities") || is_null($this->_propDict["supportedEntities"])) {
    ...
    public function getSupports()
    {
        if (array_key_exists("supports", $this->_propDict)) {
            if (is_a($this->_propDict["supports"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WorkforceIntegrationSupportedEntities") || is_null($this->_propDict["supports"])) {
