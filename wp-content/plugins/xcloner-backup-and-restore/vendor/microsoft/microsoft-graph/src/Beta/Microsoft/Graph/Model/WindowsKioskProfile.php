...
class WindowsKioskProfile extends Entity
{
    ...
    public function getAppConfiguration()
    {
        if (array_key_exists("appConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["appConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsKioskAppConfiguration") || is_null($this->_propDict["appConfiguration"])) {
    ...
    public function getUserAccountsConfiguration()
    {
        if (array_key_exists("userAccountsConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["userAccountsConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsKioskUser") || is_null($this->_propDict["userAccountsConfiguration"])) {
