...
class StandardTimeZoneOffset extends Entity
{
    ...
    public function getDayOfWeek()
    {
        if (array_key_exists("dayOfWeek", $this->_propDict)) {
            if (is_a($this->_propDict["dayOfWeek"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DayOfWeek") || is_null($this->_propDict["dayOfWeek"])) {
    ...
    public function getTime()
    {
        if (array_key_exists("time", $this->_propDict)) {
            if (is_a($this->_propDict["time"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["time"])) {
