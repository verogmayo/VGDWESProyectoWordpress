...
class IosUpdateDeviceStatus extends Entity
{
    ...
    public function getInstallStatus()
    {
        if (array_key_exists("installStatus", $this->_propDict)) {
            if (is_a($this->_propDict["installStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IosUpdatesInstallStatus") || is_null($this->_propDict["installStatus"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ComplianceStatus") || is_null($this->_propDict["status"])) {
