...
class MicrosoftAuthenticatorFeatureSettings extends Entity
{
    ...
    public function getDisplayAppInformationRequiredState()
    {
        if (array_key_exists("displayAppInformationRequiredState", $this->_propDict)) {
            if (is_a($this->_propDict["displayAppInformationRequiredState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationMethodFeatureConfiguration") || is_null($this->_propDict["displayAppInformationRequiredState"])) {
    ...
    public function getDisplayLocationInformationRequiredState()
    {
        if (array_key_exists("displayLocationInformationRequiredState", $this->_propDict)) {
            if (is_a($this->_propDict["displayLocationInformationRequiredState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationMethodFeatureConfiguration") || is_null($this->_propDict["displayLocationInformationRequiredState"])) {
    ...
    public function getNumberMatchingRequiredState()
    {
        if (array_key_exists("numberMatchingRequiredState", $this->_propDict)) {
            if (is_a($this->_propDict["numberMatchingRequiredState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationMethodFeatureConfiguration") || is_null($this->_propDict["numberMatchingRequiredState"])) {
