...
class SimulationReport extends Entity
{
    ...
    public function getOverview()
    {
        if (array_key_exists("overview", $this->_propDict)) {
            if (is_a($this->_propDict["overview"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SimulationReportOverview") || is_null($this->_propDict["overview"])) {
    ...
    public function getSimulationUsers()
    {
        if (array_key_exists("simulationUsers", $this->_propDict)) {
            if (is_a($this->_propDict["simulationUsers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserSimulationDetails") || is_null($this->_propDict["simulationUsers"])) {
