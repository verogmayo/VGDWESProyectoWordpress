...
class PlannerPlanContextDetails extends Entity
{
    ...
    public function getDisplayLinkType()
    {
        if (array_key_exists("displayLinkType", $this->_propDict)) {
            if (is_a($this->_propDict["displayLinkType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PlannerPlanContextType") || is_null($this->_propDict["displayLinkType"])) {
    ...
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PlannerContextState") || is_null($this->_propDict["state"])) {
