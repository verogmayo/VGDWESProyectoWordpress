...
class VpnTrafficRule extends Entity
{
    ...
    public function getAppType()
    {
        if (array_key_exists("appType", $this->_propDict)) {
            if (is_a($this->_propDict["appType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnTrafficRuleAppType") || is_null($this->_propDict["appType"])) {
    ...
    public function getLocalAddressRanges()
    {
        if (array_key_exists("localAddressRanges", $this->_propDict)) {
            if (is_a($this->_propDict["localAddressRanges"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IPv4Range") || is_null($this->_propDict["localAddressRanges"])) {
    ...
    public function getLocalPortRanges()
    {
        if (array_key_exists("localPortRanges", $this->_propDict)) {
            if (is_a($this->_propDict["localPortRanges"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\NumberRange") || is_null($this->_propDict["localPortRanges"])) {
    ...
    public function getRemoteAddressRanges()
    {
        if (array_key_exists("remoteAddressRanges", $this->_propDict)) {
            if (is_a($this->_propDict["remoteAddressRanges"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IPv4Range") || is_null($this->_propDict["remoteAddressRanges"])) {
    ...
    public function getRemotePortRanges()
    {
        if (array_key_exists("remotePortRanges", $this->_propDict)) {
            if (is_a($this->_propDict["remotePortRanges"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\NumberRange") || is_null($this->_propDict["remotePortRanges"])) {
    ...
    public function getRoutingPolicyType()
    {
        if (array_key_exists("routingPolicyType", $this->_propDict)) {
            if (is_a($this->_propDict["routingPolicyType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\VpnTrafficRuleRoutingPolicyType") || is_null($this->_propDict["routingPolicyType"])) {
