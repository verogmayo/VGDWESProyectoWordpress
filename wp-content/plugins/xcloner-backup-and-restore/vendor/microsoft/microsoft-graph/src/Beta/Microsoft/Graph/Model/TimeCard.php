...
class TimeCard extends ChangeTrackedEntity
{
    ...
    public function getClockInEvent()
    {
        if (array_key_exists("clockInEvent", $this->_propDict)) {
            if (is_a($this->_propDict["clockInEvent"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeCardEvent") || is_null($this->_propDict["clockInEvent"])) {
    ...
    public function getClockOutEvent()
    {
        if (array_key_exists("clockOutEvent", $this->_propDict)) {
            if (is_a($this->_propDict["clockOutEvent"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeCardEvent") || is_null($this->_propDict["clockOutEvent"])) {
    ...
    public function getConfirmedBy()
    {
        if (array_key_exists("confirmedBy", $this->_propDict)) {
            if (is_a($this->_propDict["confirmedBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConfirmedBy") || is_null($this->_propDict["confirmedBy"])) {
    ...
    public function getOriginalEntry()
    {
        if (array_key_exists("originalEntry", $this->_propDict)) {
            if (is_a($this->_propDict["originalEntry"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeCardEntry") || is_null($this->_propDict["originalEntry"])) {
    ...
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeCardState") || is_null($this->_propDict["state"])) {
