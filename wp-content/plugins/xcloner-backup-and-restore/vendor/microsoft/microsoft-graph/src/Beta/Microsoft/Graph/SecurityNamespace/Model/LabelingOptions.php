...
* @link      https://graph.microsoft.com
*/
class LabelingOptions extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getAssignmentMethod()
    {
        if (array_key_exists("assignmentMethod", $this->_propDict)) {
            if (is_a($this->_propDict["assignmentMethod"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\AssignmentMethod") || is_null($this->_propDict["assignmentMethod"])) {
    ...
    public function getDowngradeJustification()
    {
        if (array_key_exists("downgradeJustification", $this->_propDict)) {
            if (is_a($this->_propDict["downgradeJustification"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\DowngradeJustification") || is_null($this->_propDict["downgradeJustification"])) {
    ...
    public function getExtendedProperties()
    {
        if (array_key_exists("extendedProperties", $this->_propDict)) {
            if (is_a($this->_propDict["extendedProperties"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\KeyValuePair") || is_null($this->_propDict["extendedProperties"])) {
