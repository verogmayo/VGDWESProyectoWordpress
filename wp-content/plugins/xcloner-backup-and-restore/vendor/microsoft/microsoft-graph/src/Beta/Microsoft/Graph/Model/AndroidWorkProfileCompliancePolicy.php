...
class AndroidWorkProfileCompliancePolicy extends DeviceCompliancePolicy
{
    ...
    public function getAdvancedThreatProtectionRequiredSecurityLevel()
    {
        if (array_key_exists("advancedThreatProtectionRequiredSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["advancedThreatProtectionRequiredSecurityLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceThreatProtectionLevel") || is_null($this->_propDict["advancedThreatProtectionRequiredSecurityLevel"])) {
    ...
    public function getDeviceThreatProtectionRequiredSecurityLevel()
    {
        if (array_key_exists("deviceThreatProtectionRequiredSecurityLevel", $this->_propDict)) {
            if (is_a($this->_propDict["deviceThreatProtectionRequiredSecurityLevel"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceThreatProtectionLevel") || is_null($this->_propDict["deviceThreatProtectionRequiredSecurityLevel"])) {
    ...
    public function getPasswordRequiredType()
    {
        if (array_key_exists("passwordRequiredType", $this->_propDict)) {
            if (is_a($this->_propDict["passwordRequiredType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidRequiredPasswordType") || is_null($this->_propDict["passwordRequiredType"])) {
    ...
    public function getSecurityRequiredAndroidSafetyNetEvaluationType()
    {
        if (array_key_exists("securityRequiredAndroidSafetyNetEvaluationType", $this->_propDict)) {
            if (is_a($this->_propDict["securityRequiredAndroidSafetyNetEvaluationType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AndroidSafetyNetEvaluationType") || is_null($this->_propDict["securityRequiredAndroidSafetyNetEvaluationType"])) {
