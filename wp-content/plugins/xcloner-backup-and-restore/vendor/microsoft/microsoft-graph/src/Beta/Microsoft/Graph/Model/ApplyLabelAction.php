...
class ApplyLabelAction extends InformationProtectionAction
{
    ...
    public function getActions()
    {
        if (array_key_exists("actions", $this->_propDict)) {
            if (is_a($this->_propDict["actions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InformationProtectionAction") || is_null($this->_propDict["actions"])) {
    ...
    public function getActionSource()
    {
        if (array_key_exists("actionSource", $this->_propDict)) {
            if (is_a($this->_propDict["actionSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ActionSource") || is_null($this->_propDict["actionSource"])) {
