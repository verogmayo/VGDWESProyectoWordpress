...
class Alert extends Entity
{
    ...
    public function getFeedback()
    {
        if (array_key_exists("feedback", $this->_propDict)) {
            if (is_a($this->_propDict["feedback"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AlertFeedback") || is_null($this->_propDict["feedback"])) {
    ...
    public function getSeverity()
    {
        if (array_key_exists("severity", $this->_propDict)) {
            if (is_a($this->_propDict["severity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AlertSeverity") || is_null($this->_propDict["severity"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AlertStatus") || is_null($this->_propDict["status"])) {
