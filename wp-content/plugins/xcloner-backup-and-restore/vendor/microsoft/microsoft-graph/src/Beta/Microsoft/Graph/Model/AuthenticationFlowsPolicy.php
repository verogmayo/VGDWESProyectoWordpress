...
class AuthenticationFlowsPolicy extends Entity
{
    ...
    public function getSelfServiceSignUp()
    {
        if (array_key_exists("selfServiceSignUp", $this->_propDict)) {
            if (is_a($this->_propDict["selfServiceSignUp"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SelfServiceSignUpAuthenticationFlowConfiguration") || is_null($this->_propDict["selfServiceSignUp"])) {
