...
class CommunicationsIdentitySet extends IdentitySet
{
    ...
    public function getApplicationInstance()
    {
        if (array_key_exists("applicationInstance", $this->_propDict)) {
            if (is_a($this->_propDict["applicationInstance"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["applicationInstance"])) {
    ...
    public function getAssertedIdentity()
    {
        if (array_key_exists("assertedIdentity", $this->_propDict)) {
            if (is_a($this->_propDict["assertedIdentity"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["assertedIdentity"])) {
    ...
    public function getAzureCommunicationServicesUser()
    {
        if (array_key_exists("azureCommunicationServicesUser", $this->_propDict)) {
            if (is_a($this->_propDict["azureCommunicationServicesUser"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["azureCommunicationServicesUser"])) {
    ...
    public function getEncrypted()
    {
        if (array_key_exists("encrypted", $this->_propDict)) {
            if (is_a($this->_propDict["encrypted"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["encrypted"])) {
    ...
    public function getEndpointType()
    {
        if (array_key_exists("endpointType", $this->_propDict)) {
            if (is_a($this->_propDict["endpointType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EndpointType") || is_null($this->_propDict["endpointType"])) {
    ...
    public function getGuest()
    {
        if (array_key_exists("guest", $this->_propDict)) {
            if (is_a($this->_propDict["guest"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["guest"])) {
    ...
    public function getOnPremises()
    {
        if (array_key_exists("onPremises", $this->_propDict)) {
            if (is_a($this->_propDict["onPremises"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["onPremises"])) {
    ...
    public function getPhone()
    {
        if (array_key_exists("phone", $this->_propDict)) {
            if (is_a($this->_propDict["phone"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Identity") || is_null($this->_propDict["phone"])) {
