...
* @link      https://graph.microsoft.com
*/
class ConnectionOperation extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the error
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\ConnectionOperationStatus") || is_null($this->_propDict["status"])) {
