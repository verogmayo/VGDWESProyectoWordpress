...
class PrinterShare extends PrinterBase
{
    ...
    public function getViewPoint()
    {
        if (array_key_exists("viewPoint", $this->_propDict)) {
            if (is_a($this->_propDict["viewPoint"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PrinterShareViewpoint") || is_null($this->_propDict["viewPoint"])) {
    ...
    public function getPrinter()
    {
        if (array_key_exists("printer", $this->_propDict)) {
            if (is_a($this->_propDict["printer"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Printer") || is_null($this->_propDict["printer"])) {
