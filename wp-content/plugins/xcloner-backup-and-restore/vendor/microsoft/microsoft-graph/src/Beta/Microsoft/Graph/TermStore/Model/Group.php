...
* @link      https://graph.microsoft.com
*/
class Group extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getScope()
    {
        if (array_key_exists("scope", $this->_propDict)) {
            if (is_a($this->_propDict["scope"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\TermGroupScope") || is_null($this->_propDict["scope"])) {
