...
class UpdateWindow extends Entity
{
    ...
    public function getUpdateWindowEndTime()
    {
        if (array_key_exists("updateWindowEndTime", $this->_propDict)) {
            if (is_a($this->_propDict["updateWindowEndTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["updateWindowEndTime"])) {
    ...
    public function getUpdateWindowStartTime()
    {
        if (array_key_exists("updateWindowStartTime", $this->_propDict)) {
            if (is_a($this->_propDict["updateWindowStartTime"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TimeOfDay") || is_null($this->_propDict["updateWindowStartTime"])) {
