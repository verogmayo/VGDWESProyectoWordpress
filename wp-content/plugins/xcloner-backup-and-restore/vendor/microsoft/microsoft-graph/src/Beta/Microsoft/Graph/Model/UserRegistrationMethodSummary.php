...
class UserRegistrationMethodSummary extends Entity
{
    ...
    public function getUserRegistrationMethodCounts()
    {
        if (array_key_exists("userRegistrationMethodCounts", $this->_propDict)) {
            if (is_a($this->_propDict["userRegistrationMethodCounts"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\UserRegistrationMethodCount") || is_null($this->_propDict["userRegistrationMethodCounts"])) {
