...
class WindowsDeliveryOptimizationConfiguration extends DeviceConfiguration
{
    ...
    public function getBandwidthMode()
    {
        if (array_key_exists("bandwidthMode", $this->_propDict)) {
            if (is_a($this->_propDict["bandwidthMode"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeliveryOptimizationBandwidth") || is_null($this->_propDict["bandwidthMode"])) {
    ...
    public function getGroupIdSource()
    {
        if (array_key_exists("groupIdSource", $this->_propDict)) {
            if (is_a($this->_propDict["groupIdSource"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeliveryOptimizationGroupIdSource") || is_null($this->_propDict["groupIdSource"])) {
    ...
    public function getMaximumCacheSize()
    {
        if (array_key_exists("maximumCacheSize", $this->_propDict)) {
            if (is_a($this->_propDict["maximumCacheSize"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeliveryOptimizationMaxCacheSize") || is_null($this->_propDict["maximumCacheSize"])) {
    ...
    public function getRestrictPeerSelectionBy()
    {
        if (array_key_exists("restrictPeerSelectionBy", $this->_propDict)) {
            if (is_a($this->_propDict["restrictPeerSelectionBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeliveryOptimizationRestrictPeerSelectionByOptions") || is_null($this->_propDict["restrictPeerSelectionBy"])) {
    ...
    public function getVpnPeerCaching()
    {
        if (array_key_exists("vpnPeerCaching", $this->_propDict)) {
            if (is_a($this->_propDict["vpnPeerCaching"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Enablement") || is_null($this->_propDict["vpnPeerCaching"])) {
