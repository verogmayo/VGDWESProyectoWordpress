...
class PlannerPlanDetails extends PlannerDelta
{
    ...
    public function getCategoryDescriptions()
    {
        if (array_key_exists("categoryDescriptions", $this->_propDict)) {
            if (is_a($this->_propDict["categoryDescriptions"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PlannerCategoryDescriptions") || is_null($this->_propDict["categoryDescriptions"])) {
    ...
    public function getContextDetails()
    {
        if (array_key_exists("contextDetails", $this->_propDict)) {
            if (is_a($this->_propDict["contextDetails"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PlannerPlanContextDetailsCollection") || is_null($this->_propDict["contextDetails"])) {
    ...
    public function getSharedWith()
    {
        if (array_key_exists("sharedWith", $this->_propDict)) {
            if (is_a($this->_propDict["sharedWith"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\PlannerUserIds") || is_null($this->_propDict["sharedWith"])) {
