...
class Windows10VpnConfiguration extends WindowsVpnConfiguration
{
    ...
    public function getAuthenticationMethod()
    {
        if (array_key_exists("authenticationMethod", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationMethod"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Windows10VpnAuthenticationMethod") || is_null($this->_propDict["authenticationMethod"])) {
    ...
    public function getConnectionType()
    {
        if (array_key_exists("connectionType", $this->_propDict)) {
            if (is_a($this->_propDict["connectionType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Windows10VpnConnectionType") || is_null($this->_propDict["connectionType"])) {
    ...
    public function getCryptographySuite()
    {
        if (array_key_exists("cryptographySuite", $this->_propDict)) {
            if (is_a($this->_propDict["cryptographySuite"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\CryptographySuite") || is_null($this->_propDict["cryptographySuite"])) {
    ...
    public function getEapXml()
    {
        if (array_key_exists("eapXml", $this->_propDict)) {
            if (is_a($this->_propDict["eapXml"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["eapXml"])) {
                return $this->_propDict["eapXml"];
            } else {
                $this->_propDict["eapXml"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["eapXml"]);
                return $this->_propDict["eapXml"];
            }
        }
        return null;
    ...
    public function getProfileTarget()
    {
        if (array_key_exists("profileTarget", $this->_propDict)) {
            if (is_a($this->_propDict["profileTarget"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Windows10VpnProfileTarget") || is_null($this->_propDict["profileTarget"])) {
    ...
    public function getProxyServer()
    {
        if (array_key_exists("proxyServer", $this->_propDict)) {
            if (is_a($this->_propDict["proxyServer"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Windows10VpnProxyServer") || is_null($this->_propDict["proxyServer"])) {
    ...
    public function getSingleSignOnEku()
    {
        if (array_key_exists("singleSignOnEku", $this->_propDict)) {
            if (is_a($this->_propDict["singleSignOnEku"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ExtendedKeyUsage") || is_null($this->_propDict["singleSignOnEku"])) {
    ...
    public function getIdentityCertificate()
    {
        if (array_key_exists("identityCertificate", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificate"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WindowsCertificateProfileBase") || is_null($this->_propDict["identityCertificate"])) {
