...
class EdiscoveryExportOperation extends CaseOperation
{
    ...
    public function getExportOptions()
    {
        if (array_key_exists("exportOptions", $this->_propDict)) {
            if (is_a($this->_propDict["exportOptions"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\ExportOptions") || is_null($this->_propDict["exportOptions"])) {
    ...
    public function getExportStructure()
    {
        if (array_key_exists("exportStructure", $this->_propDict)) {
            if (is_a($this->_propDict["exportStructure"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\ExportFileStructure") || is_null($this->_propDict["exportStructure"])) {
    ...
    public function getReviewSet()
    {
        if (array_key_exists("reviewSet", $this->_propDict)) {
            if (is_a($this->_propDict["reviewSet"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\EdiscoveryReviewSet") || is_null($this->_propDict["reviewSet"])) {
    ...
    public function getReviewSetQuery()
    {
        if (array_key_exists("reviewSetQuery", $this->_propDict)) {
            if (is_a($this->_propDict["reviewSetQuery"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\EdiscoveryReviewSetQuery") || is_null($this->_propDict["reviewSetQuery"])) {
