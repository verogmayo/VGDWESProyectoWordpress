...
class ProcessEvidence extends AlertEvidence
{
    ...
    public function getDetectionStatus()
    {
        if (array_key_exists("detectionStatus", $this->_propDict)) {
            if (is_a($this->_propDict["detectionStatus"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\DetectionStatus") || is_null($this->_propDict["detectionStatus"])) {
    ...
    public function getImageFile()
    {
        if (array_key_exists("imageFile", $this->_propDict)) {
            if (is_a($this->_propDict["imageFile"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\FileDetails") || is_null($this->_propDict["imageFile"])) {
    ...
    public function getParentProcessImageFile()
    {
        if (array_key_exists("parentProcessImageFile", $this->_propDict)) {
            if (is_a($this->_propDict["parentProcessImageFile"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\FileDetails") || is_null($this->_propDict["parentProcessImageFile"])) {
