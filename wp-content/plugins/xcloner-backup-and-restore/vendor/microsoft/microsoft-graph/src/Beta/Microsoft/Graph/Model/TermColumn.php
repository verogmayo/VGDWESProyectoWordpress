...
class TermColumn extends Entity
{
    ...
    public function getParentTerm()
    {
        if (array_key_exists("parentTerm", $this->_propDict)) {
            if (is_a($this->_propDict["parentTerm"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Term") || is_null($this->_propDict["parentTerm"])) {
                return $this->_propDict["parentTerm"];
            } else {
                $this->_propDict["parentTerm"] = new \XCloner\Beta\Microsoft\Graph\TermStore\Model\Term($this->_propDict["parentTerm"]);
                return $this->_propDict["parentTerm"];
            }
        }
        return null;
    ...
    public function getTermSet()
    {
        if (array_key_exists("termSet", $this->_propDict)) {
            if (is_a($this->_propDict["termSet"], "XCloner\\Beta\\Microsoft\\Graph\\TermStore\\Model\\Set") || is_null($this->_propDict["termSet"])) {
                return $this->_propDict["termSet"];
            } else {
                $this->_propDict["termSet"] = new \XCloner\Beta\Microsoft\Graph\TermStore\Model\Set($this->_propDict["termSet"]);
                return $this->_propDict["termSet"];
            }
        }
        return null;
