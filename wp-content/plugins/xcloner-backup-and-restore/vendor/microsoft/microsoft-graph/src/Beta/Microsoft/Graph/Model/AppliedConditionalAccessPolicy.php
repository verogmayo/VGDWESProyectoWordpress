...
class AppliedConditionalAccessPolicy extends Entity
{
    ...
    public function getAuthenticationStrength()
    {
        if (array_key_exists("authenticationStrength", $this->_propDict)) {
            if (is_a($this->_propDict["authenticationStrength"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AuthenticationStrength") || is_null($this->_propDict["authenticationStrength"])) {
    ...
    public function getConditionsNotSatisfied()
    {
        if (array_key_exists("conditionsNotSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["conditionsNotSatisfied"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessConditions") || is_null($this->_propDict["conditionsNotSatisfied"])) {
    ...
    public function getConditionsSatisfied()
    {
        if (array_key_exists("conditionsSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["conditionsSatisfied"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessConditions") || is_null($this->_propDict["conditionsSatisfied"])) {
    ...
    public function getExcludeRulesSatisfied()
    {
        if (array_key_exists("excludeRulesSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["excludeRulesSatisfied"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessRuleSatisfied") || is_null($this->_propDict["excludeRulesSatisfied"])) {
    ...
    public function getIncludeRulesSatisfied()
    {
        if (array_key_exists("includeRulesSatisfied", $this->_propDict)) {
            if (is_a($this->_propDict["includeRulesSatisfied"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ConditionalAccessRuleSatisfied") || is_null($this->_propDict["includeRulesSatisfied"])) {
    ...
    public function getResult()
    {
        if (array_key_exists("result", $this->_propDict)) {
            if (is_a($this->_propDict["result"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AppliedConditionalAccessPolicyResult") || is_null($this->_propDict["result"])) {
