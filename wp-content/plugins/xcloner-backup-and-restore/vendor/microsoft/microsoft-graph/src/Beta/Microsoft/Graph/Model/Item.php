...
class Item extends Entity
{
    ...
    public function getInventory()
    {
        if (array_key_exists("inventory", $this->_propDict)) {
            if (is_a($this->_propDict["inventory"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\Decimal") || is_null($this->_propDict["inventory"])) {
    ...
    public function getItemCategory()
    {
        if (array_key_exists("itemCategory", $this->_propDict)) {
            if (is_a($this->_propDict["itemCategory"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ItemCategory") || is_null($this->_propDict["itemCategory"])) {
