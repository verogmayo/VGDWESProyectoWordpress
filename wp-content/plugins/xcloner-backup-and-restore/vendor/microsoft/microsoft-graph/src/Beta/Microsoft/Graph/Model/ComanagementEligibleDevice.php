...
class ComanagementEligibleDevice extends Entity
{
    ...
    public function getClientRegistrationStatus()
    {
        if (array_key_exists("clientRegistrationStatus", $this->_propDict)) {
            if (is_a($this->_propDict["clientRegistrationStatus"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceRegistrationState") || is_null($this->_propDict["clientRegistrationStatus"])) {
    ...
    public function getManagementAgents()
    {
        if (array_key_exists("managementAgents", $this->_propDict)) {
            if (is_a($this->_propDict["managementAgents"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ManagementAgentType") || is_null($this->_propDict["managementAgents"])) {
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ComanagementEligibleType") || is_null($this->_propDict["status"])) {
