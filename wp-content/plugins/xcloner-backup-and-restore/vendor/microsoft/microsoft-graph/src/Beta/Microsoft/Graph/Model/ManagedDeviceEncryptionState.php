...
class ManagedDeviceEncryptionState extends Entity
{
    ...
    public function getAdvancedBitLockerStates()
    {
        if (array_key_exists("advancedBitLockerStates", $this->_propDict)) {
            if (is_a($this->_propDict["advancedBitLockerStates"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AdvancedBitLockerState") || is_null($this->_propDict["advancedBitLockerStates"])) {
    ...
    public function getDeviceType()
    {
        if (array_key_exists("deviceType", $this->_propDict)) {
            if (is_a($this->_propDict["deviceType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceTypes") || is_null($this->_propDict["deviceType"])) {
    ...
    public function getEncryptionPolicySettingState()
    {
        if (array_key_exists("encryptionPolicySettingState", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionPolicySettingState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ComplianceStatus") || is_null($this->_propDict["encryptionPolicySettingState"])) {
    ...
    public function getEncryptionReadinessState()
    {
        if (array_key_exists("encryptionReadinessState", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionReadinessState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EncryptionReadinessState") || is_null($this->_propDict["encryptionReadinessState"])) {
    ...
    public function getEncryptionState()
    {
        if (array_key_exists("encryptionState", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionState"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EncryptionState") || is_null($this->_propDict["encryptionState"])) {
    ...
    public function getFileVaultStates()
    {
        if (array_key_exists("fileVaultStates", $this->_propDict)) {
            if (is_a($this->_propDict["fileVaultStates"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\FileVaultState") || is_null($this->_propDict["fileVaultStates"])) {
