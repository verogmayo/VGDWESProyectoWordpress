...
class DeviceEnrollmentPlatformRestrictionsConfiguration extends DeviceEnrollmentConfiguration
{
    ...
    public function getAndroidForWorkRestriction()
    {
        if (array_key_exists("androidForWorkRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["androidForWorkRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["androidForWorkRestriction"])) {
    ...
    public function getAndroidRestriction()
    {
        if (array_key_exists("androidRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["androidRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["androidRestriction"])) {
    ...
    public function getIosRestriction()
    {
        if (array_key_exists("iosRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["iosRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["iosRestriction"])) {
    ...
    public function getMacOSRestriction()
    {
        if (array_key_exists("macOSRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["macOSRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["macOSRestriction"])) {
    ...
    public function getMacRestriction()
    {
        if (array_key_exists("macRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["macRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["macRestriction"])) {
    ...
    public function getWindowsHomeSkuRestriction()
    {
        if (array_key_exists("windowsHomeSkuRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsHomeSkuRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["windowsHomeSkuRestriction"])) {
    ...
    public function getWindowsMobileRestriction()
    {
        if (array_key_exists("windowsMobileRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsMobileRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["windowsMobileRestriction"])) {
    ...
    public function getWindowsRestriction()
    {
        if (array_key_exists("windowsRestriction", $this->_propDict)) {
            if (is_a($this->_propDict["windowsRestriction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceEnrollmentPlatformRestriction") || is_null($this->_propDict["windowsRestriction"])) {
