...
class Permission extends Entity
{
    ...
    public function getGrantedTo()
    {
        if (array_key_exists("grantedTo", $this->_propDict)) {
            if (is_a($this->_propDict["grantedTo"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentitySet") || is_null($this->_propDict["grantedTo"])) {
    ...
    public function getGrantedToV2()
    {
        if (array_key_exists("grantedToV2", $this->_propDict)) {
            if (is_a($this->_propDict["grantedToV2"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharePointIdentitySet") || is_null($this->_propDict["grantedToV2"])) {
    ...
    public function getInheritedFrom()
    {
        if (array_key_exists("inheritedFrom", $this->_propDict)) {
            if (is_a($this->_propDict["inheritedFrom"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ItemReference") || is_null($this->_propDict["inheritedFrom"])) {
    ...
    public function getInvitation()
    {
        if (array_key_exists("invitation", $this->_propDict)) {
            if (is_a($this->_propDict["invitation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharingInvitation") || is_null($this->_propDict["invitation"])) {
    ...
    public function getLink()
    {
        if (array_key_exists("link", $this->_propDict)) {
            if (is_a($this->_propDict["link"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\SharingLink") || is_null($this->_propDict["link"])) {
