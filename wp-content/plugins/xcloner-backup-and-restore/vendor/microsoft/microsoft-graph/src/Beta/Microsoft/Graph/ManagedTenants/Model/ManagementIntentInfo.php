...
* @link      https://graph.microsoft.com
*/
class ManagementIntentInfo extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getManagementTemplates()
    {
        if (array_key_exists("managementTemplates", $this->_propDict)) {
            if (is_a($this->_propDict["managementTemplates"], "XCloner\\Beta\\Microsoft\\Graph\\ManagedTenants\\Model\\ManagementTemplateDetailedInfo") || is_null($this->_propDict["managementTemplates"])) {
