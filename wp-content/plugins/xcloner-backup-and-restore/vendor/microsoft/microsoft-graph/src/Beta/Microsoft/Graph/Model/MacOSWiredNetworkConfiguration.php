...
class MacOSWiredNetworkConfiguration extends DeviceConfiguration
{
    ...
    public function getEapFastConfiguration()
    {
        if (array_key_exists("eapFastConfiguration", $this->_propDict)) {
            if (is_a($this->_propDict["eapFastConfiguration"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EapFastConfiguration") || is_null($this->_propDict["eapFastConfiguration"])) {
    ...
    public function getNetworkInterface()
    {
        if (array_key_exists("networkInterface", $this->_propDict)) {
            if (is_a($this->_propDict["networkInterface"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\WiredNetworkInterface") || is_null($this->_propDict["networkInterface"])) {
    ...
    public function getNonEapAuthenticationMethodForEapTtls()
    {
        if (array_key_exists("nonEapAuthenticationMethodForEapTtls", $this->_propDict)) {
            if (is_a($this->_propDict["nonEapAuthenticationMethodForEapTtls"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\NonEapAuthenticationMethodForEapTtlsType") || is_null($this->_propDict["nonEapAuthenticationMethodForEapTtls"])) {
    ...
    public function getIdentityCertificateForClientAuthentication()
    {
        if (array_key_exists("identityCertificateForClientAuthentication", $this->_propDict)) {
            if (is_a($this->_propDict["identityCertificateForClientAuthentication"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSCertificateProfileBase") || is_null($this->_propDict["identityCertificateForClientAuthentication"])) {
    ...
    public function getRootCertificateForServerValidation()
    {
        if (array_key_exists("rootCertificateForServerValidation", $this->_propDict)) {
            if (is_a($this->_propDict["rootCertificateForServerValidation"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\MacOSTrustedRootCertificate") || is_null($this->_propDict["rootCertificateForServerValidation"])) {
