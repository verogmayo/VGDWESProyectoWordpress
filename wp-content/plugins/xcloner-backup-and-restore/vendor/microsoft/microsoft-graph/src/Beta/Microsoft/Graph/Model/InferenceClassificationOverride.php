...
class InferenceClassificationOverride extends Entity
{
    ...
    public function getClassifyAs()
    {
        if (array_key_exists("classifyAs", $this->_propDict)) {
            if (is_a($this->_propDict["classifyAs"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\InferenceClassificationType") || is_null($this->_propDict["classifyAs"])) {
    ...
    public function getSenderEmailAddress()
    {
        if (array_key_exists("senderEmailAddress", $this->_propDict)) {
            if (is_a($this->_propDict["senderEmailAddress"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\EmailAddress") || is_null($this->_propDict["senderEmailAddress"])) {
