...
class ImportedWindowsAutopilotDeviceIdentity extends Entity
{
    ...
    public function getHardwareIdentifier()
    {
        if (array_key_exists("hardwareIdentifier", $this->_propDict)) {
            if (is_a($this->_propDict["hardwareIdentifier"], "XCloner\\GuzzleHttp\\Psr7\\Stream") || is_null($this->_propDict["hardwareIdentifier"])) {
                return $this->_propDict["hardwareIdentifier"];
            } else {
                $this->_propDict["hardwareIdentifier"] = \XCloner\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["hardwareIdentifier"]);
                return $this->_propDict["hardwareIdentifier"];
            }
        }
        return null;
    ...
    public function getState()
    {
        if (array_key_exists("state", $this->_propDict)) {
            if (is_a($this->_propDict["state"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\ImportedWindowsAutopilotDeviceIdentityState") || is_null($this->_propDict["state"])) {
