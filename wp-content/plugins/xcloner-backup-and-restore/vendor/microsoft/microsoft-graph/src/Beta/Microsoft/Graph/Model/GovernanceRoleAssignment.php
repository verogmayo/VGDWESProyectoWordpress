...
class GovernanceRoleAssignment extends Entity
{
    ...
    public function getLinkedEligibleRoleAssignment()
    {
        if (array_key_exists("linkedEligibleRoleAssignment", $this->_propDict)) {
            if (is_a($this->_propDict["linkedEligibleRoleAssignment"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\GovernanceRoleAssignment") || is_null($this->_propDict["linkedEligibleRoleAssignment"])) {
