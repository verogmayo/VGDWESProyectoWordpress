...
* @link      https://graph.microsoft.com
*/
class UserProcessingResult extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getWorkflowExecutionType()
    {
        if (array_key_exists("workflowExecutionType", $this->_propDict)) {
            if (is_a($this->_propDict["workflowExecutionType"], "XCloner\\Beta\\Microsoft\\Graph\\IdentityGovernanceNamespace\\Model\\WorkflowExecutionType") || is_null($this->_propDict["workflowExecutionType"])) {
