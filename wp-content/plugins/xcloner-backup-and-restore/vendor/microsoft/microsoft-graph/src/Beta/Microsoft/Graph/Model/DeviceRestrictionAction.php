...
class DeviceRestrictionAction extends DlpActionInfo
{
    ...
    public function getRestrictionAction()
    {
        if (array_key_exists("restrictionAction", $this->_propDict)) {
            if (is_a($this->_propDict["restrictionAction"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RestrictionAction") || is_null($this->_propDict["restrictionAction"])) {
    ...
    public function getTriggers()
    {
        if (array_key_exists("triggers", $this->_propDict)) {
            if (is_a($this->_propDict["triggers"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\RestrictionTrigger") || is_null($this->_propDict["triggers"])) {
