...
* @link      https://graph.microsoft.com
*/
class RetentionEvent extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the createdBy
    ...
    public function getEventStatus()
    {
        if (array_key_exists("eventStatus", $this->_propDict)) {
            if (is_a($this->_propDict["eventStatus"], "XCloner\\Beta\\Microsoft\\Graph\\SecurityNamespace\\Model\\RetentionEventStatus") || is_null($this->_propDict["eventStatus"])) {
