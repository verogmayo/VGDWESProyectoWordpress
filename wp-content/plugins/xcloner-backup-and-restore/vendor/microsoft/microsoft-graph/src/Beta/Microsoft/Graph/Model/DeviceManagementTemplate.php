...
class DeviceManagementTemplate extends Entity
{
    ...
    public function getTemplateSubtype()
    {
        if (array_key_exists("templateSubtype", $this->_propDict)) {
            if (is_a($this->_propDict["templateSubtype"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementTemplateSubtype") || is_null($this->_propDict["templateSubtype"])) {
    ...
    public function getTemplateType()
    {
        if (array_key_exists("templateType", $this->_propDict)) {
            if (is_a($this->_propDict["templateType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\DeviceManagementTemplateType") || is_null($this->_propDict["templateType"])) {
