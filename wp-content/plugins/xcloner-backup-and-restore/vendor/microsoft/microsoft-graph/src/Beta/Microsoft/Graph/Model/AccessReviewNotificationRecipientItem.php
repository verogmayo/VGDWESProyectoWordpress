...
class AccessReviewNotificationRecipientItem extends Entity
{
    ...
    public function getNotificationRecipientScope()
    {
        if (array_key_exists("notificationRecipientScope", $this->_propDict)) {
            if (is_a($this->_propDict["notificationRecipientScope"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\AccessReviewNotificationRecipientScope") || is_null($this->_propDict["notificationRecipientScope"])) {
