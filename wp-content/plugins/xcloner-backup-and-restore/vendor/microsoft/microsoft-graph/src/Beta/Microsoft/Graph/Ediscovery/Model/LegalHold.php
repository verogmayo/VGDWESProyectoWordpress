...
* @link      https://graph.microsoft.com
*/
class LegalHold extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
    ...
    public function getStatus()
    {
        if (array_key_exists("status", $this->_propDict)) {
            if (is_a($this->_propDict["status"], "XCloner\\Beta\\Microsoft\\Graph\\Ediscovery\\Model\\LegalHoldStatus") || is_null($this->_propDict["status"])) {
