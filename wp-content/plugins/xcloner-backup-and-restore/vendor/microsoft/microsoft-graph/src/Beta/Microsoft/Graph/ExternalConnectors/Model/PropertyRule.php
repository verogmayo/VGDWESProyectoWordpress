...
* @link      https://graph.microsoft.com
*/
class PropertyRule extends \XCloner\Beta\Microsoft\Graph\Model\Entity
{
    /**
     * Gets the operation
    ...
    public function getOperation()
    {
        if (array_key_exists("operation", $this->_propDict)) {
            if (is_a($this->_propDict["operation"], "XCloner\\Beta\\Microsoft\\Graph\\ExternalConnectors\\Model\\RuleOperation") || is_null($this->_propDict["operation"])) {
    ...
    public function getValuesJoinedBy()
    {
        if (array_key_exists("valuesJoinedBy", $this->_propDict)) {
            if (is_a($this->_propDict["valuesJoinedBy"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\BinaryOperator") || is_null($this->_propDict["valuesJoinedBy"])) {
                return $this->_propDict["valuesJoinedBy"];
            } else {
                $this->_propDict["valuesJoinedBy"] = new \XCloner\Beta\Microsoft\Graph\Model\BinaryOperator($this->_propDict["valuesJoinedBy"]);
                return $this->_propDict["valuesJoinedBy"];
            }
        }
        return null;
