...
class IdentityUserFlowAttribute extends Entity
{
    ...
    public function getDataType()
    {
        if (array_key_exists("dataType", $this->_propDict)) {
            if (is_a($this->_propDict["dataType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityUserFlowAttributeDataType") || is_null($this->_propDict["dataType"])) {
    ...
    public function getUserFlowAttributeType()
    {
        if (array_key_exists("userFlowAttributeType", $this->_propDict)) {
            if (is_a($this->_propDict["userFlowAttributeType"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\IdentityUserFlowAttributeType") || is_null($this->_propDict["userFlowAttributeType"])) {
