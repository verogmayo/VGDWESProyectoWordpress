...
class TeamworkHardwareHealth extends Entity
{
    ...
    public function getComputeHealth()
    {
        if (array_key_exists("computeHealth", $this->_propDict)) {
            if (is_a($this->_propDict["computeHealth"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkPeripheralHealth") || is_null($this->_propDict["computeHealth"])) {
    ...
    public function getHdmiIngestHealth()
    {
        if (array_key_exists("hdmiIngestHealth", $this->_propDict)) {
            if (is_a($this->_propDict["hdmiIngestHealth"], "XCloner\\Beta\\Microsoft\\Graph\\Model\\TeamworkPeripheralHealth") || is_null($this->_propDict["hdmiIngestHealth"])) {
