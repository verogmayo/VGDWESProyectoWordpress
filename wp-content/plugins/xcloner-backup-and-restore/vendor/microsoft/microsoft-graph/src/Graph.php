...
*/
namespace XCloner\Microsoft\Graph;
...
class Graph
{
    ...
    {
        return new GraphRequest($requestType, $endpoint, $this->_accessToken, $this->_baseUrl, $this->_apiVersion, $this->_proxyPort, $this->_proxyVerifySSL);
    }
    /**
    ...
    {
        return new GraphCollectionRequest($requestType, $endpoint, $this->_accessToken, $this->_baseUrl, $this->_apiVersion, $this->_proxyPort, $this->_proxyVerifySSL);
    }
}
