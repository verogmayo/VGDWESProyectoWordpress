...
use XCloner\Microsoft\Graph\Http\GraphCollectionRequest;
...
class GraphCollectionRequestTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $mock = new GuzzleHttp\Handler\MockHandler([new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $body), new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $body2), new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $body2)]);
        $handler = GuzzleHttp\HandlerStack::create($mock);
        $this->client = new GuzzleHttp\Client(['handler' => $handler]);
        $this->reflectedRequestUrlHandler = new \ReflectionMethod('XCloner\Microsoft\Graph\Http\GraphRequest', '_getRequestUrl');
        $this->reflectedRequestUrlHandler->setAccessible(\true);
    }
...
\class_alias('XCloner\GraphCollectionRequestTest', 'GraphCollectionRequestTest', \false);
