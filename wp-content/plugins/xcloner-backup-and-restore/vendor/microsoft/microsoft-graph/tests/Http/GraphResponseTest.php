...
use XCloner\Microsoft\Graph\Http\GraphResponse;
...
class GraphResponseTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $mock = new GuzzleHttp\Handler\MockHandler([new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $body), new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $body), new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $multiBody), new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $valueBody), new GuzzleHttp\Psr7\Response(200, ['foo' => 'bar'], $emptyMultiBody)]);
    ...
    public function testDecodeBody()
    {
        ...
        $reflectionMethod = new \ReflectionMethod('XCloner\Microsoft\Graph\Http\GraphResponse', '_decodeBody');
    ...
    public function testGetRawBody()
    {
        ...
        $this->assertInstanceOf(\XCloner\Psr\Http\Message\StreamInterface::class, $body);
...
\class_alias('XCloner\GraphResponseTest', 'GraphResponseTest', \false);
