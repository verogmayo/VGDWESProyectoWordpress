...
use XCloner\Symfony\Component\Yaml\Exception\ParseException;
use XCloner\Symfony\Component\Yaml\Parser as YamlParser;
...
class YamlFileLoader extends FileLoader
{
    ...
    protected function loadResource(string $resource)
    {
        if (null === $this->yamlParser) {
            if (!class_exists(\XCloner\Symfony\Component\Yaml\Parser::class)) {
